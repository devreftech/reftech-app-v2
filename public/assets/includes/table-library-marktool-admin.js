$(function () {
    var dt_table_library_marktool_admin = $(".datatable-library-marktool-admin");
    var Url = "/db/library/marktool";

    if (dt_table_library_marktool_admin.length) {
        $('[data-toggle="tooltip"]').tooltip();
        var dt_library_marktool_admin = dt_table_library_marktool_admin.DataTable({
            ajax: {
                type: "GET",
                url: Url,
                headers: {
    ...
    dt_table_library_marktool_admin.on("draw", function () {
        $('[data-toggle="tooltip"]').tooltip();
    });
});
