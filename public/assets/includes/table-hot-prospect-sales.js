$(function () {
    ...
    if (dt_table_prospect_quote_sales.length) {
        ...
        var dt_prospect_sales = dt_table_prospect_quote_sales.DataTable({
            ...
            order: [[2, "desc"]],
            dom: '<"card-header flex-column flex-md-row"<"head-label hl-hot text-center"><"dt-action-buttons text-end pt-3 pt-md-0"B>><"row"<"col-sm-12 col-md-6"l><"col-sm-12 col-md-6 d-flex justify-content-center justify-content-md-end"f>>t<"row"<"col-sm-12 col-md-6"i><"col-sm-12 col-md-6"p>>',
            displayLength: 7,
        ...
        $("div.hl-hot").html(
            '<h5 class="card-title mb-0">Table Hot Prospect</h5>'
        );
    }
