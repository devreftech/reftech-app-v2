$(function () {
    var dt_table_library_manbook = $(".datatable-library-manbook");
    var Url = "/db/library/manbook";

    if (dt_table_library_manbook.length) {
        $('[data-toggle="tooltip"]').tooltip();
        var dt_library_manbook = dt_table_library_manbook.DataTable({
            ajax: {
                type: "GET",
                url: Url,
                headers: {
    ...
    dt_table_library_manbook.on("draw", function () {
        $('[data-toggle="tooltip"]').tooltip();
    });
});
