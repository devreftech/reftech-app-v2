$(function () {
    var dt_table_bangkrupt_sales = $(".datatable-bangkrupt-sales");
    var Url = "/db/bangkrupt/sales";

    if (dt_table_bangkrupt_sales.length) {
        var dt_bangkrupt = dt_table_bangkrupt_sales.DataTable({
