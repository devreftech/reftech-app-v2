$(function () {
    var dt_table_library_partlist_admin = $(".datatable-library-partlist-admin");
    var Url = "/db/library/partlist";

    if (dt_table_library_partlist_admin.length) {
        $('[data-toggle="tooltip"]').tooltip();
        var dt_library_partlist_admin = dt_table_library_partlist_admin.DataTable({
            ajax: {
                type: "GET",
                url: Url,
                headers: {
    ...
    dt_table_library_partlist_admin.on("draw", function () {
        $('[data-toggle="tooltip"]').tooltip();
    });
});
