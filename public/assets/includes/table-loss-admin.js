$(function () {
    var dt_table_loss_quote_admin = $(".datatable-loss-quote-admin");
    var Url = "db/loss/admin";

    if (dt_table_loss_quote_admin.length) {
        $('[data-toggle="tooltip"]').tooltip();
        var dt_loss_admin = dt_table_loss_quote_admin.DataTable({
            ajax: {
                type: "GET",
                url: Url,
                headers: {
            ...
            order: [[2, "desc"]],
            dom: '<"card-header flex-column flex-md-row"<"head-label hl-3 text-center"><"dt-action-buttons text-end pt-3 pt-md-0"B>><"row"<"col-sm-12 col-md-6"l><"col-sm-12 col-md-6 d-flex justify-content-center justify-content-md-end"f>>t<"row"<"col-sm-12 col-md-6"i><"col-sm-12 col-md-6"p>>',
            displayLength: 7,
        ...
        $("div.hl-3").html(
            '<h5 class="card-title mb-0">Table Quotation Loss Admin</h5>'
        );
    }
    dt_table_loss_quote_admin.on("draw", function () {
        $('[data-toggle="tooltip"]').tooltip();
    });
});
