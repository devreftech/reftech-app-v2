$(function () {
    var dt_table_confirm_order_tax = $(".datatable-confirm-order-tax");
    var Url = "/db/confirm-order/tax";

    if (dt_table_confirm_order_tax.length) {
        $('[data-toggle="tooltip"]').tooltip();
        var dt_confirm_order_tax = dt_table_confirm_order_tax.DataTable({
            ajax: {
                type: "GET",
                url: Url,
                headers: {
        ...
        $("div.hl-2").html(
            '<h5 class="card-title mb-0">Table Confirm Order Tax</h5>'
        );
    }
    dt_table_confirm_order_tax.on("draw", function () {
        $('[data-toggle="tooltip"]').tooltip();
    });
});
