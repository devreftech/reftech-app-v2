$(function () {
    var dt_table_req_visit_accept = $(".datatable-visit-accept");
    var Url = "db/reqVisit/accept";

    if (dt_table_req_visit_accept.length) {
        $('[data-toggle="tooltip"]').tooltip();
        var dt_visit = dt_table_req_visit_accept.DataTable({
            ajax: {
                type: "GET",
                url: Url,
                headers: {
    ...
    dt_table_req_visit_accept.on("draw", function () {
        $('[data-toggle="tooltip"]').tooltip();
    });
});
