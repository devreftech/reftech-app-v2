$(function () {
    var dt_table_noutlen_mention_admin = $(".datatable-notulen-mention-admin");
    var Url = "/db/notulen/mention/admin";

    if (dt_table_noutlen_mention_admin.length) {
        $('[data-toggle="tooltip"]').tooltip();
        var dt_noutlen_mention_admin = dt_table_noutlen_mention_admin.DataTable(
            {
                ajax: {
                    type: "GET",
                    url: Url,
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, full, meta) {
                            var dataId = full["id"];
                            var dataMId = full["mId"];
                            return (
                                '<div class="d-flex align-items-center">' +
                                '<a href="javascript:;" class="btn btn-sm btn-icon btn-text-secondary waves-effect waves-light rounded-pill" data-bs-target="#detailNotulen' +
                                dataId +
                                '" data-bs-toggle="modal">' +
                                '<i class="menu-icon tf-icons mdi mdi-text-box-outline mdi-20px"></i>' +
                                "</a>" +
                                '<a href="javascript:;" class="btn btn-sm btn-icon btn-text-secondary waves-effect waves-light rounded-pill button-clear" data-id ="'+dataMId+'">' +
                                '<i class="menu-icon tf-icons mdi mdi-check-circle-outline mdi-20px"></i>' +
                                "</a>" +
                                "</div>"
                            );
                        },
                ...
                buttons: [
                    ...
                    {
                        text: '<i class="mdi mdi-plus me-sm-1"></i> <span class="d-none d-sm-inline-block">Create Notulen</span>',
                        className: "btn btn-primary",
                        attr: {
                            "data-bs-target": "#formNotulen",
                            "data-bs-toggle": "modal",
                        },
                    },
                ],
