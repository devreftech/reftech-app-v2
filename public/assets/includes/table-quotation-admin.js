$(function () {
    var dt_table_quotation_admin = $(".datatable-quotation-admin");
    var Url = "db/quotation/admin";

    if (dt_table_quotation_admin.length) {
        $('[data-toggle="tooltip"]').tooltip();
        var dt_quotation = dt_table_quotation_admin.DataTable({
            ajax: {
                type: "GET",
                url: Url,
                headers: {
