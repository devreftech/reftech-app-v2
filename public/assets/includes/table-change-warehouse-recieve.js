$(function () {
    ...
    if (dt_change_warehouse_recieve.length) {
        ...
        var dt_change_warehouse = dt_change_warehouse_recieve.DataTable({
            ajax: {
                type: "GET",
                url: Url,
                headers: {
        ...
        $("div.hl-1").html('<h5 class="card-title mb-0">Table Recieve Changed</h5>');
    }
    dt_change_warehouse_recieve.on("draw", function () {
        $('[data-toggle="tooltip"]').tooltip();
    });
});
