$(function () {
    var dt_table_aging_report_kojisha = $(".datatable-aging-report-kojisha");
    var Url = "/db/aging/report/kojisha";

    if (dt_table_aging_report_kojisha.length) {
        const initTooltips = () => {
        ...
        $(".datatable-aging-report-kojisha thead tr")
            .clone(true)
            .appendTo(".datatable-aging-report-kojisha thead");
        $(".datatable-aging-report-kojisha thead tr:eq(1) th").each(function (i) {
        ...
        var dt_filter = dt_table_aging_report_kojisha.DataTable({
            ajax: {
                type: "GET",
                url: Url,
                headers: {
