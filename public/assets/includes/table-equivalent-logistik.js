$(function () {
    var dt_table_product_logistik = $(".datatable-product-equivalent-logistik");
    ...
    if (dt_table_product_logistik.length) {
        $('[data-toggle="tooltip"]').tooltip();
        var dt_product_logistik = dt_table_product_logistik.DataTable({
            ajax: {
                type: "GET",
                url: Url + id,
                headers: {
    ...
    dt_table_product_logistik.on("draw", function () {
        $('[data-toggle="tooltip"]').tooltip();
    });
});
