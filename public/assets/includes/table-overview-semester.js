$(function () {
    var dt_table_semester_overview = $(".datatable-overview-semester");
    var Url = "/db/sales/overview/";
    var path = window.location.pathname;
    var id = path.substring(path.lastIndexOf('/') + 1);

    if (dt_table_semester_overview.length) {
        $('[data-toggle="tooltip"]').tooltip();
        var dt_sales_reports = dt_table_semester_overview.DataTable({
            ajax: {
                type: "GET",
                url: Url + id,
                headers: {
    ...
    dt_table_semester_overview.on("draw", function () {
        $('[data-toggle="tooltip"]').tooltip();
    });
});
