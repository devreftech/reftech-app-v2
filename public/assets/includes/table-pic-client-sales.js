$(function () {
    var dt_table_pic_client_sales = $(".datatable-pic-client-sales");
    var Url = "/db/pic/";
    ...
    if (dt_table_pic_client_sales.length) {
        $('[data-toggle="tooltip"]').tooltip();
        var dt_product = dt_table_pic_client_sales.DataTable({
            ajax: {
                type: "GET",
                url: Url + id,
                headers: {
    ...
    dt_table_pic_client_sales.on("draw", function () {
        $('[data-toggle="tooltip"]').tooltip();
    });
});
