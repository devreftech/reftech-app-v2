{{--
    LEGACY / DISABLED (2026-07-06) — halaman lama /unit yang berbasis data Machine (id_client=5387).
    Tidak lagi dirender dari UnitController@index. Disimpan sebagai referensi/backup kalau perlu
    dikembalikan. Machine, SerialProduct, dan Service Report yang terkait TIDAK dihapus/diubah —
    file ini cuma tidak dipanggil oleh route manapun lagi.
--}}
