...
@section('title', 'SUO - Accounting')
@section('content')
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
        <div>
            <h4 class="fw-bold mb-1">
                <span class="text-muted fw-light">Accounting /</span> Sales Urgent Order (SUO)
            </h4>
            <p class="text-muted mb-0 small">
                Kelola antrean Sales Urgent Order dari sales, cek stok gudang, dan konversi invoice.
            </p>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm">
        ...
        <div class="card-datatable table-responsive pt-3 pb-3">
            <table class="datatable-suo-accounting table table-hover border-top" id="datatable-suo-accounting-table" style="width:100%">
...
@push('page-script')
    <script src="{{ asset('assets') }}/includes/table-suo-accounting.js"></script>
@endpush
