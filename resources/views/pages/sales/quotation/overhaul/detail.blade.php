                ...
                <div class="card mb-3 border-warning shadow-sm">
                    <div class="card-body p-4 text-center">
                        ...
                        <p class="text-muted small mb-3">
                            Penawaran overhaul ini menggunakan model lama (Legacy). Pembuatan dan pengelolaan penawaran baru kini dialihkan ke <strong>Smart Quote</strong>.
                        </p>
                        <div class="row g-2 mb-2">
                            <div class="col-6">
                                <a class="btn btn-outline-secondary d-grid w-100 waves-effect" target="_blank"
                                    href="{{ route('overhaul-print.quotation', $quote->id) }}">
                                    <i class="mdi mdi-printer-outline me-1"></i> Cetak ++
                                </a>
                            </div>
                            <div class="col-6">
                                <a class="btn btn-outline-secondary d-grid w-100 waves-effect" target="_blank"
                                    href="{{ route('overhaul-print-no-image.quotation', $quote->id) }}">
                                    <i class="mdi mdi-file-document-outline me-1"></i> Cetak --
                                </a>
                            </div>
                        </div>
                        @php
