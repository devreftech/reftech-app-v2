...
@section('content')
                    ...
                    <table class="table table-bordered m-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="2" class="text-end"> RP {{ number_format($quote->subtotal, 0, '', '.') }}
                                </td>
                            </tr>
                            @if ($quote->diskon != 0)
                                <tr>
                                    ...
                                    <td colspan="2" class="text-end"> RP
                                        {{ number_format($quote->diskon, 0, '', '.') }}</td>
                                </tr>
                                <tr>
                                    <td colspan="3"></td>
                            ...
                            @if ($quote->shipping != 0)
                                <tr>
                                    ...
                                    <td colspan="2" class="text-end"> RP
                                        {{ number_format($quote->shipping, 0, '', '.') }}</td>
                                </tr>
                            @endif
                            <tr class="border-top">
    ...
    @include('components.modal.quotation.insert-fee-service')
    @include('components.modal.quotation.detail-fee-service')
