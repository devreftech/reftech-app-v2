                        ...
                        <div class="col-md-12 my-3">
                            <div class="border rounded p-3">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createAction{{ $existing->id }}">
                                        + New Action
                                    </button>
                                </div>
                                <div class="table-responsive text-nowrap">
                                        ...
                                        <tbody class="table-border-bottom-0">
                                            @forelse ($visit as $visits)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-label-{{ $visits->status == 'Responded' ? 'success' : 'secondary' }}">{{ $visits->status }}</span>
                                                    </td>
                                                    <td>
                                                        {{ $visits->note }}
                                                    </td>
