    ...
    <div class="tab-content p-0 border-0 bg-transparent" id="orderDetailTabsContent">
        ...
        <div class="tab-pane fade" id="logistic-pane" role="tabpanel" aria-labelledby="logistic-tab">
            @if ($pending->type == 'Project')
                ...
                @endif
                @if ((isset($purchases) ? $purchases->isEmpty() : !$purchase) && $detQuotation->where('status', 3)->count() > 0)
                                ...
                                @forelse ($allPrDetails as $row)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button data-id="{{ $det->id }}" data-pending="{{ $pending->id }}"
                                                data-qty="{{ $det->qty }}" data-note="{{ $det->note }}"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.btn-add-manual-pr-row', function (e) {
                e.preventDefault();
                var $container = $(this).closest('.card').find('#manualPrItemsContainer');
                var newRowHtml = `
            ...
            $(document).on('click', '.btn-remove-manual-pr-row', function (e) {
                e.preventDefault();
                var $container = $(this).closest('#manualPrItemsContainer');
