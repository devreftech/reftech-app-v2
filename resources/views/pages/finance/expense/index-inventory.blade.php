    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center py-3 mb-3 gap-3">
        <div>
            <h4 class="fw-bold mb-1">
                <span class="text-muted fw-light">Finance / Expense /</span> Inventory Adjustment
            </h4>
    ...
    <div class="card mb-3 border-0 shadow-sm">
        <div class="card-header bg-transparent border-bottom py-3 d-flex align-items-center">
            <h6 class="card-title mb-0 fw-bold text-dark">
                <i class="mdi mdi-clipboard-text-outline me-2 text-primary fs-5"></i> Daftar Inventory Adjustment
            </h6>
        </div>
        <div class="card-datatable table-responsive pt-0">
            <table class="datatable-expense-inventory table table-bordered">
                <thead>
                    <tr>
                        <th>Date</th>
                        <th>No Adj.</th>
...
@push('page-script')
    ...
    <script src="{{ asset('assets') }}/includes/table-expense-inventory.js"></script>
@endpush
