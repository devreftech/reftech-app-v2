@php
    ...
    $detailUrl = @$month
        ? route('expense-cashflow.detail-bulan', [$periodYear, str_pad($month, 2, '0', STR_PAD_LEFT)])
        : route('expense-cashflow.detail-tahun', [$periodYear]);
@endphp
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Laporan Arus Kas - PT REFTECH JAYA OPTIMA ({{ $startString }} s/d {{ $endString }})</title>
    ...
    <style>
        body, .print-container, table, th, td, h3, h4, h5, h6, span, div, p, input, button {
    ...
    <div class="container-fluid" style="max-width: 960px;">
        ...
        <div class="print-toolbar d-flex flex-wrap align-items-center justify-content-between gap-2 no-print">
            <div class="d-flex align-items-center gap-2">
                ...
                <span class="badge bg-label-primary fw-bold">Arus Kas (Cash Flow)</span>
            </div>
        ...
        <div class="print-container">
            @include('pages.finance.cashflow._report', ['isPrintMode' => true])
