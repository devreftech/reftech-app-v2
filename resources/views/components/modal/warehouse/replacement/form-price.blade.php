        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel5-{{ $detail->id }}"> Edit Price Replacement {{ $detail->replacement }}
                    </h4>
                    ...
                    <div class="row g-2 mb-3">
                        <div class="col">
                            <div class="form-floating form-floating-outline">
                                <input type="text" id="replacement-{{ $detail->id }}" class="form-control" name="replacement"
                                    placeholder="......" value="{{ $detail->replacement }}">
                                <label for="replacement-{{ $detail->id }}">Replacement</label>
                            </div>
                        </div>
