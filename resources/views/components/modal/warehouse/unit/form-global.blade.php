<style>
/* ══════════════════════════════════════════════════════════════
   SMOOTH MODAL IN & OUT ANIMATIONS
   ══════════════════════════════════════════════════════════════ */
.modal.modal-smooth-premium.fade {
    opacity: 0 !important;
    transition: opacity 0.28s cubic-bezier(0.16, 1, 0.3, 1) !important;
}
.modal.modal-smooth-premium.fade .modal-dialog {
    opacity: 0 !important;
    transform: scale(0.93) translateY(-22px) !important;
    transition: transform 0.32s cubic-bezier(0.16, 1, 0.3, 1), opacity 0.28s ease-out !important;
}
.modal.modal-smooth-premium.show {
    opacity: 1 !important;
}
.modal.modal-smooth-premium.show .modal-dialog {
    opacity: 1 !important;
...
.modal.modal-smooth-premium .modal-content {
    border: none !important;
    border-radius: 18px !important;
    box-shadow: 0 24px 60px rgba(15, 23, 42, 0.2), 0 8px 24px rgba(15, 23, 42, 0.08) !important;
    overflow: hidden;
    background: #ffffff;
}
.modal.modal-smooth-premium .modal-header {
    background: linear-gradient(135deg, #fbfcfe 0%, #f4f6fa 100%);
    border-bottom: 1px solid rgba(0, 0, 0, 0.07);
    padding: 18px 24px;
}
.modal.modal-smooth-premium .modal-footer {
    background: #fbfcfe;
    border-top: 1px solid rgba(0, 0, 0, 0.07);
    padding: 16px 24px;
}
.modal.modal-smooth-premium .modal-body {
    background: #f8f9fb;
    padding: 22px 24px;
...
.modal.modal-smooth-premium .modal-body::-webkit-scrollbar {
    width: 6px;
}
.modal.modal-smooth-premium .modal-body::-webkit-scrollbar-thumb {
    background: #cbd5e1;
    border-radius: 4px;
}
.modal.modal-smooth-premium .modal-body::-webkit-scrollbar-thumb:hover {
    background: #94a3b8;
}
...
<form action="{{ @$product ? route('unit.update', @$product->id) : route('unit-global.store') }}" method="post"
    ...
    @if (@$product)
        @method('patch')
    @endif
    <div class="modal fade modal-smooth-premium"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center gap-3">
                        <div class="avatar avatar-md bg-label-primary rounded-3 d-flex align-items-center justify-content-center shadow-sm">
                            <i class="mdi {{ @$product ? 'mdi-pencil-box-multiple-outline' : 'mdi-plus-box-multiple-outline' }} fs-3 text-primary"></i>
                        </div>
                        <div>
                            <h5 class="modal-title fw-bold text-dark mb-0">
                                {{ @$product ? 'Update Unit Global' : 'Create Unit Global' }}
                            </h5>
                            <div class="d-flex align-items-center gap-2 mt-1">
                                @if (@$product)
                                    <span class="badge bg-primary px-2 py-0.5 rounded-pill font-monospace small">{{ @$product->sku }}</span>
                                    @if (@$product->brand)
                                        <span class="text-muted small fw-semibold">{{ @$product->brand }}</span>
                                    @endif
                                    @if (@$product->unit)
                                        <span class="badge bg-label-secondary px-2 py-0.5 rounded-pill small">{{ @$product->unit }}</span>
                                    @endif
                                @else
                                    <small class="text-muted">Lengkapi data spesifikasi unit catalog global</small>
                                @endif
                            </div>
                        </div>
                    </div>
                ...
                {{-- Modal Body with Grouped Section Cards --}}
                <div class="modal-body">
                    ...
                    <div class="form-section-card">
                        <div class="form-section-header">
                            ...
                            <h6 class="section-title">Identitas Unit & Kategori</h6>
                        </div>
                        <div class="row g-2">
                            <div class="col-12 col-md-5">
                                ...
                                <div id="sku-check-result" class="mt-1" style="min-height:22px;font-size:0.82rem;"></div>
                            </div>
                            <div class="col-12 col-md-7">
                                <div class="form-floating form-floating-outline">
                                    <select class="form-select" id="unit-category" name="unit">
                                        <option value="" disabled {{ !@$product ? 'selected' : '' }}>-- Pilih Kategori Unit --</option>
                                    ...
                                    <label for="unit-category">Kategori Master</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="fields-compressor" style="display:none;">
                        ...
                        <div class="form-section-card">
                            <div class="form-section-header">
                                ...
                                <h6 class="section-title">Spesifikasi Model & Tipe</h6>
                            </div>
                            ...
                            <div class="row g-2 mb-3" id="field-screw-specs" style="display:none;">
                                <div class="col-12 col-md-6" id="wrapper-speed-type" style="display:none;">
                                    <div class="form-floating form-floating-outline">
                                ...
                                <div class="col-12 col-md-6" id="wrapper-generation" style="display:none;">
                                    <div class="form-floating form-floating-outline">
                        ...
                        <div class="form-section-card">
                            <div class="form-section-header">
                                ...
                                <h6 class="section-title">Parameter Kinerja & Kelistrikan</h6>
                            </div>
                            <div class="row g-2 mb-3">
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-floating form-floating-outline">
                                        <select class="form-select" name="connect">
                                            <option value="" disabled {{ !@$product->connect ? 'selected' : '' }}>-- Drive Connection --</option>
                        ...
                        <div class="form-section-card">
                            <div class="form-section-header">
                                ...
                                <h6 class="section-title">Dimensi & Fisik Unit</h6>
                            </div>
                            <div class="row g-2 mb-3">
                                <div class="col-12 col-md-6">
                                    <div class="form-floating form-floating-outline">
                            ...
                            <div class="row g-2">
                                <div class="col-12">
                                    <label class="form-label text-muted small mb-1 fw-semibold">Dimensi Unit (mm) — Panjang × Lebar × Tinggi</label>
                                </div>
                                <div class="col-4">
                                    <div class="form-floating form-floating-outline">
                    ...
                    <div class="fields-booster" style="display:none;">
                        <div class="form-section-card">
                            <div class="form-section-header">
                                ...
                                <h6 class="section-title">Spesifikasi Booster Compressor</h6>
                            </div>
                            <div class="row g-2 mb-3">
                                <div class="col-6">
                                    <div class="form-floating form-floating-outline">
                            ...
                            <div class="row g-2 mb-3">
                                <div class="col-12">
                                    <label class="form-label text-muted small mb-1 fw-semibold">Dimension (mm) — L × W × H</label>
                                </div>
                                <div class="col-4">
                                    <div class="form-floating form-floating-outline">
                    ...
                    <div class="fields-ref-dryer" style="display:none;">
                        <div class="form-section-card">
                            <div class="form-section-header">
                                ...
                                <h6 class="section-title">Spesifikasi Refrigerant Air Dryer</h6>
                            </div>
                            <div class="row g-2 mb-3">
                                <div class="col-6">
                                    <div class="form-floating form-floating-outline">
                    ...
                    <div class="fields-desiccant" style="display:none;">
                        <div class="form-section-card">
                            <div class="form-section-header">
                                ...
                                <h6 class="section-title">Spesifikasi Desiccant Dryer</h6>
                            </div>
                            <div class="row g-2 mb-3">
                                <div class="col-6">
                                    <div class="form-floating form-floating-outline">
                    ...
                    <div class="fields-filtration" style="display:none;">
                        <div class="form-section-card">
                            <div class="form-section-header">
                                ...
                                <h6 class="section-title">Spesifikasi Filtration System</h6>
                            </div>
                            <div class="row g-2 mb-3">
                                <div class="col-6">
                                    <div class="form-floating form-floating-outline">
                    ...
                    <div class="fields-tank" style="display:none;">
                        <div class="form-section-card">
                            <div class="form-section-header">
                                ...
                                <h6 class="section-title">Spesifikasi Air Receiver Tank</h6>
                            </div>
                            <div class="row g-2 mb-3">
                                <div class="col-6">
                                    <div class="form-floating form-floating-outline input-group">
                    ...
                    <div class="fields-chiller" style="display:none;">
                        <div class="form-section-card">
                            <div class="form-section-header">
                                ...
                                <h6 class="section-title">Spesifikasi Water Chiller</h6>
                            </div>
                            <div class="row g-2 mb-3">
                                <div class="col-6">
                                    <div class="form-floating form-floating-outline">
                    ...
                    {{-- ==================== NOTE (SEMUA KATEGORI) ==================== --}}
                    <div class="fields-all" style="display:none;">
                        <div class="form-section-card mb-0">
                            ...
                            <div class="form-floating form-floating-outline">
                                <textarea class="form-control" name="note" style="min-height: 85px;"
                                    placeholder="Note">{{ old('note', @$product->note ?? '') }}</textarea>
                                <label>Catatan / Keterangan Khusus</label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-footer d-flex align-items-center justify-content-between">
                    <span class="text-muted small">
                        <i class="mdi mdi-shield-check-outline text-success me-1"></i>Data unit tersinkron dengan catalog global.
                    </span>
                    <div class="d-flex gap-2">
                        <button type="button" class="btn btn-label-secondary px-3.5 waves-effect"
                            data-bs-dismiss="modal">
                            <i class="mdi mdi-close me-1"></i>Batal
                        </button>
                        <button type="submit" class="btn btn-primary px-4 shadow-sm waves-effect waves-light">
                            <i class="mdi mdi-content-save-outline me-1"></i>{{ @$product ? 'Simpan Perubahan' : 'Simpan Unit' }}
                        </button>
                    </div>
                </div>
            </div>
