<div class="modal fade" id="detailOutstanding" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content border-0 shadow-lg" style="border-radius: 14px;">
            <div class="modal-header border-bottom py-3 px-4 bg-light d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center gap-2">
                    <div class="avatar avatar-xs bg-label-primary rounded p-1 d-flex align-items-center justify-content-center" style="width: 34px; height: 34px;">
                        <i class="mdi mdi-receipt-text fs-5"></i>
                    </div>
                    <div>
                        <h5 class="modal-title fw-bold text-dark mb-0">Detail of Outstanding Invoices</h5>
                        <small class="text-muted" style="font-size: 11.5px;">Daftar seluruh invoice yang memiliki sisa saldo piutang (Outstanding)</small>
                    </div>
                </div>
            ...
            <div class="modal-body p-4">
                <div class="table-responsive">
                    <table class="table table-hover align-middle border-top modal-datatable-outstanding w-100" style="font-size: 13px;">
                        ...
                        <tbody>
                            ...
                            @foreach ($invoice as $item)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ $invoiceRoute }}" class="fw-bold text-primary text-decoration-none" target="_blank">
                                    ...
                                    <td class="text-center">
                                        @if($invoiceRoute !== '#')
                                            <a href="{{ $invoiceRoute }}" class="btn btn-xs btn-label-primary px-2" target="_blank" title="Buka Invoice">
            ...
            <div class="modal-footer border-top py-2 px-4 bg-light d-flex justify-content-between align-items-center">
                <span class="text-muted small">Total: <strong class="text-primary">{{ count($invoice) }}</strong> Invoice Outstanding</span>
