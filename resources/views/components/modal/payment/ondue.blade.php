<div class="modal fade" id="detailOnDue" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content border-0 shadow-lg" style="border-radius: 14px;">
            <div class="modal-header border-bottom py-3 px-4 bg-light d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center gap-2">
                    <div class="avatar avatar-xs bg-label-success rounded p-1 d-flex align-items-center justify-content-center" style="width: 34px; height: 34px;">
                        <i class="mdi mdi-calendar-check-outline fs-5"></i>
                    </div>
                    <div>
                        <h5 class="modal-title fw-bold text-dark mb-0">Detail of Current Invoices (Belum Jatuh Tempo)</h5>
                        <small class="text-muted" style="font-size: 11.5px;">Daftar invoice berjalan yang belum melewati tanggal jatuh tempo kredit tempo</small>
                    </div>
                </div>
            ...
            <div class="modal-body p-4">
                <div class="table-responsive">
                    <table class="table table-hover align-middle border-top modal-datatable-ondue w-100" style="font-size: 13px;">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th>Tanggal</th>
                                <th>Customer</th>
                                <th class="text-center">Sisa Waktu Tempo</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($ondue as $item)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ $invoiceRoute }}" class="fw-bold text-success text-decoration-none" target="_blank">
                                    ...
                                    <td class="text-center">
                                        <span class="badge bg-label-success px-2 py-1">
                                            <i class="mdi mdi-timer-outline me-1"></i>{{ abs($days) }} Hari Lagi
                                        </span>
                                    </td>
                                    <td class="text-end fw-bold text-dark">Rp {{ number_format($total, 0, ',', '.') }}</td>
                                    <td class="text-center">
                                        @if($invoiceRoute !== '#')
                                            <a href="{{ $invoiceRoute }}" class="btn btn-xs btn-label-success px-2" target="_blank" title="Buka Invoice">
            ...
            <div class="modal-footer border-top py-2 px-4 bg-light d-flex justify-content-between align-items-center">
                <span class="text-muted small">Total: <strong class="text-success">{{ count($ondue) }}</strong> Invoice Current</span>
