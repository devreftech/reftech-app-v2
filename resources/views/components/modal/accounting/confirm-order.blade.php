            ...
            <div class="modal-content text-center">
                ...
                <div class="modal-body p-0">
                    ...
                    <div class="onboarding-content mb-0">
                        <h4 class="onboarding-title text-body mb-1"> Create Confirm Order</h4>
                            ...
                            <div class="col-12 mb-3 text-start">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="form-control" id="no_contract" name="no_contract"
                                        placeholder="No Confirm Order" value="{{$quote->tax == '11' ? $formattedNumberCP : $formattedNumberCNP}}/{{$quote->tax == '11' ? 'P' : 'NP'}}/CO/KII/{{$thisYear}}" required>
