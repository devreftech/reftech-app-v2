<form action="{{ route('upload-po.quotation', $quote->id) }}" method="post" enctype="multipart/form-data">
    @csrf
            ...
            <div class="modal-content text-center">
                ...
                <div class="modal-body p-0">
                    <div class="onboarding-content mb-0">
                        <h4 class="onboarding-title text-body"> Upload File PO {{ $quote->no_quote }}</h4>
