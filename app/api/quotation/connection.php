...
if (Auth::check()) {
	...
	$pdo->exec("SET SESSION sql_mode = ''");
        ...
        WHERE uq.id_sales = $userId AND uq.status NOT IN ('hot_prospect','po_received','loss','cancel') AND (uq.is_latest = 1 OR uq.is_latest IS NULL) AND (uq.is_draft = 0 OR uq.is_draft IS NULL)$yearFilterU
