...
class AccountingDashboardService
{
    ...
    public function getDashboardData($notulens)
    {
        ...
        // Rekap Piutang & Faktur Semester 1 & 2 di-cache per tahun selama 5 menit
        $semesterInvoices = Cache::remember("acct_dash_invoices_{$yearNow}", 300, function () use ($yearNow) {
            $start1 = Carbon::createFromDate($yearNow, 1, 1);
            $end1 = Carbon::createFromDate($yearNow, 6, 30);
            $start2 = Carbon::createFromDate($yearNow, 7, 1);
            $end2 = Carbon::createFromDate($yearNow, 12, 31);
        ...
        return array_merge(compact(
            ...
            'unreadCommentAdmin',
            'reminder'
        ), $semesterInvoices, $accountingWidgets);
    }
    ...
    public function getAccountingDashboardData(?int $requestInvoice = null): array
    {
        ...
        return Cache::remember("acct_dash_widgets_{$yearNow}_{$monthNow}", 300, function () use ($yearNow, $monthNow, $requestInvoice) {
