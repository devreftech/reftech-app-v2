...
class UnitController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $unit->cooling_capacity = $request->cooling_capacity ?: null;
        $unit->power_input      = $request->power_input ?: null;
        $unit->air_cap          = $request->air_cap ?: null;
        $unit->connect          = $request->connect ?? '';
        $unit->type_unit        = $request->type_unit ?? '';
        $unit->speed_type       = $request->speed_type ?: null;
        ...
        $unit->evaporator       = $request->evaporator ?? '';
