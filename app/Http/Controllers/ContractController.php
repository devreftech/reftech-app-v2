...
class ContractController extends Controller
{
    ...
    public function show($id)
    {
        ...
        if ($contract->id_unit_quotation) {
            $unitQuote = UnitQuotation::with(['client', 'pic', 'details.unit', 'details.equivalent.product', 'sales'])->find($contract->id_unit_quotation);
    ...
    public function contract_print($id)
    {
        ...
        if ($sellcon->id_unit_quotation) {
            $unitQuote = UnitQuotation::with(['client', 'pic', 'details.unit', 'details.equivalent.product', 'sales'])->find($sellcon->id_unit_quotation);
