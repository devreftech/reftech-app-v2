...
@section('title', 'Create Manual DO')
@section('content')
    @if ($errors->any())
    ...
    <form id="formAuthentication" class="mb-3 fv-plugins-bootstrap5 fv-plugins-framework"
        action="{{route('delivery.store_manual', $invoice->id)}}"
        ...
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="col-8">
                        <div class="form-floating form-floating-outline">
                            <select class="select2 form-select" id="selectAddress" aria-label="Default select example"
                                ...
                                <option value="1" {{ old('address', @$invoice->invoiceTo) == '1' ? 'selected' : '' }}>
                                    {{ @$invoice->quote->pic->client->address }}
                                </option>
                                <option value="2" {{ old('address', @$invoice->invoiceTo) == '2' ? 'selected' : '' }}>
                                    {{ @$invoice->quote->pic->client->subAddress }}</option>
                            </select>
                ...
                <div class="float-end">
                    <a href="{{ route('invoice.index') }}" type="button" class="btn btn-lg btn-outline-secondary">
                        Back
                    </a>
