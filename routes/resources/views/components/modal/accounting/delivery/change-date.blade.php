<form action="{{ route('change_date.delivery', $delivery->id) }}" method="post" enctype="multipart/form-data">
    @csrf
                                    ...
                                    <div class="col-12 mb-3">
                                        <div class="form-floating form-floating-outline">
                                            <select class="select2 form-select" id="selectAddress"
                                                ...
                                                <option value="1"
                                                    {{ old('address', $delivery->destination) == '1' ? 'selected' : '' }}>
                                                    {{ $quote->pic->client->address }}
                                                </option>
                                                <option value="2"
                                                    {{ old('address', $delivery->destination) == '2' ? 'selected' : '' }}>
