<form action="<?php echo e(@$rating ? route('update.salon', @$rating->id) : route('store.salon')); ?>" method="post"
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-8 mb-3">
                                    <input class="form-control form-control-lg" type="text" placeholder="Target"
                                        ...
                                        maxlength="4"
                                        value="<?php echo e(@$rating->airend ? str_replace('.', ',', $rating->airend) : '0'); ?>">
                                </div>
                                <?php if($salesID == 16): ?>
                                    <div class="col-4 mb-3">
                                    ...
                                    <div class="col-8 mb-3">
                                        <input class="form-control form-control-lg" type="text" placeholder="Target"
                                            ...
                                            maxlength="4"
                                            value="<?php echo e(@$rating->kojisha ? str_replace('.', ',', $rating->kojisha) : '0'); ?>">
                                    </div>
                                    <div class="col-12 mb-3">
                                        <div class="card text-center bg-label-secondary">
                                            <div class="card-body">
                                                <input type="text" name="average" id="averageRating"
                                                    value="<?php echo e(@$rating->average ? str_replace('.', ',', $rating->average) : '0'); ?>"
                                                    hidden>
                                                <h5>Average</h5>
                                                <p id="averageRatingText">
                                                    <?php echo e(@$rating->average ? str_replace('.', ',', $rating->average) : '0'); ?>
...
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/onlineSales/rating.blade.php ENDPATH**/ ?>