    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('monitoring.fajarPaper-updateStatus', $monitoring->id)); ?>" method="post"
...
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/monitoring/client/status.blade.php ENDPATH**/ ?>