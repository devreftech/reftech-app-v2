        ...
        <?php if($quote->pic->client->info == 'Reftech'): ?>
            <div class="d-flex justify-content-between flex-xl-row flex-md-column flex-sm-row flex-column">
                ...
                <div class="text-end">
                    ...
                    <br>
                    <div class="mt-1">
                        <span class=" fw-medium fs-6 badge bg-label-primary text-black"><?php echo e($quote->title); ?></span>
                    </div>
                </div>
            </div>
        <?php else: ?>
                            ...
                            <tr style="font-size: 10px; border-bottom:none !important; border-top:none !important;">
                                ...
                                <td class="text-nowrap align-top py-1" style="border-bottom:none !important;">
                                    ...
                                    <?php if($product->detail != '-'): ?>
                                        <pre class="mb-0"
                                            style="font-size: 10px; font-family: inter; max-width: 100%; overflow-x: auto; white-space: pre-wrap;"><?php echo e($product->detail); ?></pre>
                                    <?php endif; ?>
                                </td>
                                <td class="align-top py-1" style="border-bottom:none !important;">
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/sales/quotation/overhaul/detail-print-no-image.blade.php ENDPATH**/ ?>