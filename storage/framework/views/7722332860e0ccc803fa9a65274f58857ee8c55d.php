<?php $__env->startSection('title', 'Purchase Request'); ?>
        ...
        <div class="col-xl-9 col-md-8 col-12 mb-md-0 mb-4">
            ...
            <div class="card modern-card mb-4 overflow-hidden border-0">
                <div class="gradient-header-blue p-4 d-flex justify-content-between align-items-center">
                    ...
                    <div class="text-end">
                        ...
                        <span class="fs-4 fw-bold text-white"><i class="mdi mdi-receipt-text-outline me-1"></i><?php echo e($pending->no_pending); ?></span>
                    </div>
                </div>
                            ...
                            <div class="p-3 glass-meta h-100">
                                ...
                                <div class="row g-2">
                                    <div class="col-6">
                                        ...
                                        <div class="meta-value"><?php echo e($quotation->sales->name); ?></div>
                                    </div>
                                    <div class="col-6">
                                        <span class="meta-label">Flag / Info</span>
                                        <div class="meta-value"><?php echo e($quotation->pic->client->info ?: '-'); ?></div>
                                    </div>
                                    <div class="col-12 mt-2">
                                        <span class="meta-label">Perusahaan / Client</span>
                                        <div class="meta-value fw-bold text-primary"><?php echo e($quotation->pic->client->company); ?></div>
                                    </div>
                                    <div class="col-6 mt-2">
                                        <span class="meta-label">PIC Client</span>
                                        <div class="meta-value"><?php echo e($quotation->pic->name_pic); ?></div>
                                    </div>
                                    <div class="col-6 mt-2">
                                        <span class="meta-label">Alamat Kirim</span>
                                        <div class="meta-value text-wrap" style="max-height: 60px; overflow-y: auto;"><?php echo e($quotation->pic->client->address); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row g-2">
                                    <div class="col-6">
                                        ...
                                        <div class="meta-value">
                                            ...
                                            ?>
                                            <a class="text-primary fw-semibold" href="<?php echo e(route($link, $quotation->id)); ?>">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="meta-value">
                                            <?php if(@$invoice->no_invoice): ?>
                                                <a class="text-primary fw-semibold" href="<?php echo e(route('invoice.show', $invoice->id)); ?>">
                                    ...
                                    <div class="col-6 mt-2">
                                        ...
                                        <div class="meta-value">
                                            <a class="text-primary fw-semibold" href="<?php echo e(route('pending-po.show', $pending->id)); ?>">
                                                <?php echo e($pending->no_pending); ?>
                                    ...
                                    <div class="col-12 mt-2">
                                        ...
                                        <div class="meta-value"><i class="mdi mdi-calendar me-1 text-muted"></i><?php echo e(\Carbon\Carbon::parse($quotation->po_date)->format('d-m-Y')); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card modern-card mb-4 border-0">
                <div class="card-header bg-transparent border-bottom py-3 d-flex justify-content-between align-items-center">
                    ...
                    <div class="actions">
                        <?php if($purchase->where('status', 0)->count() > 0): ?>
                            <a href="#" class="btn btn-primary btn-sm btn-premium acc-all-purchase"
                                data-id="<?php echo e($pending->id); ?>"><i class="mdi mdi-check-all me-1"></i> ACC All</a>
                        <?php elseif($purchase->where('status', 1)->count() > 0): ?>
                            <a href="#" class="btn btn-twitter btn-sm btn-premium delivery-all-purchase"
                                data-id="<?php echo e($pending->id); ?>"><i class="mdi mdi-truck-delivery me-1"></i> On Delivery All</a>
                        <?php endif; ?>
                    </div>
                </div>
                        ...
                        <table class="table custom-table mb-0">
                            ...
                            <tbody>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $purchase; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td><?php echo e($no); ?></td>
                                        <td class="fw-bold text-dark"><?php echo e($pr->no_pr ?? '-'); ?></td>
                                        <td>
                                            ...
                                            <?php else: ?>
                                                ...
                                                ?>
                                                <span class="fw-semibold text-dark"><?php echo e($pr->equivalent->brand); ?> <?php echo e($pr->equivalent->pn); ?></span>
                                                <?php if($pr->equivalent->product): ?>
                                                    <span class="badge <?php echo e($pr->equivalent->product->go == 'Genuine' ? 'bg-label-success' : 'bg-label-warning'); ?> ms-1" style="font-size: 10px;">
                                                        <?php echo e($pr->equivalent->product->go); ?>

                                                    </span>
                                                <?php endif; ?>
                                                <div class="mt-1">
                                                    <span class="badge bg-label-success" style="font-size: 11px;">
                                                        <i class="mdi mdi-cash-multiple me-1"></i><?php echo e($detPrice ? 'Rp ' . number_format($detPrice->price, 0, '', '.') : '-'); ?>

                                                    </span>
                                                </div>
                                            <?php endif; ?>
                                        </td>
                                        <td><span class="fw-bold text-dark"><?php echo e($pr->qty); ?></span> <span class="text-muted small"><?php echo e($pr->equivalent->product->unit ?? ''); ?></span></td>
                                        <td style="max-width: 220px; white-space: normal;">
                                            <?php if($pr->note && $pr->note != '-'): ?>
                                                <div class="p-2 rounded bg-light border-start border-primary border-3" style="font-size: 12px; color: #475569;">
                                                    <i class="mdi mdi-comment-text-outline me-1 text-muted"></i><?php echo e($pr->note); ?>
                                        ...
                                        <td>
                                            <?php if($pr->status >= 2 && $pr->purchase_type): ?>
                                                <div class="d-flex align-items-center gap-2">
                                                    <div class="p-2 rounded bg-label-facebook d-flex flex-column gap-1" style="font-size: 0.8rem; min-width: 160px; line-height: 1.3;">
                                                        <span class="badge <?php echo e($pr->purchase_type == 'Lokal' ? 'bg-label-info' : 'bg-label-primary'); ?> align-self-start mb-1" style="font-size: 9px;">
                                                            <?php echo e($pr->purchase_type); ?>

                                                        </span>
                                                        <span class="text-dark"><i class="mdi mdi-truck-delivery-outline text-muted me-1"></i><?php echo e($pr->cargo); ?></span>
                                                        <span class="text-dark"><i class="mdi mdi-barcode text-muted me-1"></i><?php echo e($pr->no_resi ?: 'Belum ada resi'); ?></span>
                                                        <span class="text-muted" style="font-size: 10px;"><i class="mdi mdi-calendar-outline me-1"></i><?php echo e(\Carbon\Carbon::parse($pr->purchase_date)->format('d-m-Y')); ?></span>
                                                    </div>
                                                    <a href="#" data-bs-toggle="tooltip" title="Edit Info Pengiriman"
                                                        ...
                                                        data-id="<?php echo e($pr->id); ?>"
                                                        data-purchase-type="<?php echo e($pr->purchase_type); ?>"
                                                        data-cargo="<?php echo e($pr->cargo); ?>"
                                                        data-no-resi="<?php echo e($pr->no_resi); ?>"
                                                        data-purchase-date="<?php echo e($pr->purchase_date); ?>">
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center gap-1 flex-wrap">
                                                <a href="#" data-bs-toggle="tooltip" title="Edit Item"
                                                    ...
                                                    data-id="<?php echo e($pr->id); ?>"
                                                    data-qty="<?php echo e($pr->qty); ?>"
                                                    data-note="<?php echo e($pr->note ?? ''); ?>">
                                                    <i class="mdi mdi-pencil-outline"></i>
                                                </a>
                                                ...
                                                <?php if(Auth::user()->role != 'Logistic'): ?>
                                                    <?php if($pr->status == 0): ?>
                                                        <a href="#" data-bs-toggle="tooltip" title="ACC Purchase Request"
                                                            ...
                                                            data-id="<?php echo e($pr->id); ?>"
                                                            data-pending="<?php echo e($pending->id); ?>">
                                                    ...
                                                    <?php elseif($pr->status == 1): ?>
                                                        <a href="#" data-bs-toggle="tooltip" title="On Delivery"
                                                            ...
                                                            data-id="<?php echo e($pr->id); ?>" data-pending="<?php echo e($pending->id); ?>">
            ...
            <div class="card modern-card mb-4 border-0 overflow-hidden" id="diskusi">
                ...
                <div class="card-body p-4 bg-light">
                    ...
                    <div class="discussion-list mb-4 p-3 rounded bg-white border" style="max-height: 450px; overflow-y: auto; box-shadow: inset 0 2px 8px rgba(0,0,0,0.02);">
                        <?php $__empty_1 = true; $__currentLoopData = $discussions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $disc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php
                                $isMe = $disc->id_user == Auth::id();
                            ?>
                            <div class="d-flex gap-3 mb-4 <?php echo e($isMe ? 'flex-row-reverse' : ''); ?>">
                                <div class="flex-shrink-0">
                                    <img src="<?php echo e(url('') . '/' . $disc->user->image); ?>"
                                        class="rounded-circle border border-2 border-white shadow-sm"
                                        style="width:40px;height:40px;object-fit:cover;"
                                        alt="<?php echo e($disc->user->name); ?>">
                                </div>
                                <div style="max-width: 75%">
                                    <div class="d-flex align-items-center gap-2 mb-1 <?php echo e($isMe ? 'flex-row-reverse' : ''); ?>">
                                        <span class="fw-semibold text-dark" style="font-size: 13px;"><?php echo e($disc->user->name); ?></span>
                                        <span class="text-muted" style="font-size:10px;">
                                            <?php echo e(\Carbon\Carbon::parse($disc->created_at)->diffForHumans()); ?>

                                        </span>
                                    </div>
                                    <div class="p-3 rounded-3 discussion-bubble <?php echo e($isMe ? 'chat-bubble-me' : 'chat-bubble-other'); ?>"
                    ...
                    <form action="<?php echo e(route('purchase-request.add-discussion', $pending->id)); ?>" method="POST" id="discussionForm">
                        <?php echo csrf_field(); ?>
        ...
        <div class="col-xl-3 col-md-4 col-12 invoice-actions">
            <div class="card modern-card border-0 mb-3 overflow-hidden">
                ...
                <div class="card-body p-3">
                    ...
                    <?php if(Auth::user()->role == 'Logistic'): ?>
                        <a class="btn btn-primary btn-premium d-flex align-items-center justify-content-center w-100 mb-3 waves-effect <?php echo e($stat == 1 ? '' : 'disabled'); ?>"
                            href="<?php echo e($stat == 1 ? route('purchase-request.goods-receipt', $pending->id) : '#'); ?>"
                            tabindex="<?php echo e($stat == 1 ? '0' : '-1'); ?>" aria-disabled="<?php echo e($stat == 1 ? 'false' : 'true'); ?>">
                            <i class="mdi mdi-checkbox-marked-circle-outline me-2 fs-5"></i> Verifikasi Penerimaan (GR)
                        </a>
                    <?php else: ?>
                        <a class="btn btn-primary btn-premium d-flex align-items-center justify-content-center w-100 mb-3 waves-effect <?php echo e($stat == 1 ? '' : 'disabled'); ?>"
                            href="<?php echo e($stat == 1 ? route('purchase-request.done-all', $pending->id) : '#'); ?>"
                            tabindex="<?php echo e($stat == 1 ? '0' : '-1'); ?>" aria-disabled="<?php echo e($stat == 1 ? 'false' : 'true'); ?>">
                ...
                <form id="deliveryInfoForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" name="purchase_date" value="<?php echo e(date('Y-m-d')); ?>" required>
                        </div>
                        <div class="mb-3">
...
<?php $__env->startPush('script'); ?>
    <script>
        ...
        // @mention logic
        var allUsers = <?php echo json_encode($allUsers, 15, 512) ?>;
        ...
        $(document).on('click', '.edit-purchase-item', function() {
            var id = $(this).data('id');
            $('#editPurchaseItemForm').attr('action', '<?php echo e(url('purchase-request')); ?>/update/' + id);
        ...
        $(document).on('click', '.acc-purchase', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        'url': '<?php echo e(url('purchase-request')); ?>/acc/' + id,
                        'type': 'POST',
                        'data': {
                            '_method': 'PATCH',
                            '_token': '<?php echo e(csrf_token()); ?>'
        ...
        $(document).on('click', '.acc-all-purchase', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        'url': '<?php echo e(url(path: 'purchase-request')); ?>/acc-all/' + id,
                        'type': 'POST',
                        'data': {
                            '_method': 'PATCH',
                            '_token': '<?php echo e(csrf_token()); ?>'
        ...
        $('#deliveryInfoForm').on('submit', function(e) {
            ...
            var urlMap = {
                all: '<?php echo e(url('purchase-request')); ?>/delivery-all/' + deliveryContext.id,
                edit: '<?php echo e(url('purchase-request')); ?>/delivery-info/' + deliveryContext.id,
                single: '<?php echo e(url('purchase-request')); ?>/delivery/' + deliveryContext.id,
            };
            var url = urlMap[deliveryContext.mode] || urlMap.single;
            var redirectId = deliveryContext.mode === 'all' ? deliveryContext.id :
                (deliveryContext.mode === 'edit' ? '<?php echo e($pending->id); ?>' : deliveryContext.pending);
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/warehouse/purchase/detail.blade.php ENDPATH**/ ?>