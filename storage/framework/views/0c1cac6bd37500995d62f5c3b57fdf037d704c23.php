<form action="<?php echo e(@$video ? route('update.salon',@$video->id) : route('store.salon')); ?>" method="post" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
...
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/onlineSales/video.blade.php ENDPATH**/ ?>