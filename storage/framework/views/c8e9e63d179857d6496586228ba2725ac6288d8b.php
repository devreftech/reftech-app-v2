                            ...
                            <select id="select2Basic" class="select2 form-select form-select-lg invoice-item-client"
                                ...
                                <?php $__currentLoopData = $pic; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $charge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($charge->id); ?>"
                                        <?php echo e(@$quotation->id_pic == $charge->id ? 'selected' : ''); ?>>
                                        <?php echo e($charge->name_pic); ?> | <?php echo e($charge->client->company); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                                    ...
                                    <div class="row w-100 p-3">
                                                ...
                                                <select id="product-<?php echo e($id); ?>"
                                                    ...
                                                    <?php $__currentLoopData = $product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $products): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($products->id); ?>"
                                                            data-replacement="<?php echo e($products->id); ?>"
                                                            <?php echo e($quote->id_equivalent == "{$products->id}" ? 'selected' : ''); ?>>
                                                            <?php echo e($products->brand); ?> <?php echo e($products->pn); ?>

                                                            (<?php echo e($products->detail_desc); ?>)
                                                            ||
                                                            <?php echo e($products->go); ?>
                                        ...
                                        <div class="col-md-3 col-12 mb-md-0 mb-3">
                                            ...
                                            <div class="input-group" data-price="1">
                                                ...
                                                <input type="text" class="form-control invoice-item-price-label"
                                                    id="priceLabel-<?php echo e($id); ?>" data-id="<?php echo e($id); ?>"
                                        ...
                                        <div class="col-md-1 col-12 mb-md-0 mb-3">
                                            ...
                                            <div class="form-floating form-floating-outline mb-4">
                                                <select class="form-select invoice-item-info" id="info-qty-1"
                                                    ...
                                                    <option>---Info---</option>
                                                    <option value="Pcs"
                                                        <?php echo e($quote->info_qty == 'Pcs' ? 'selected' : ''); ?>>Pcs
                                                    </option>
                                                    <option value="Set"
                                                        <?php echo e($quote->info_qty == 'Set' ? 'selected' : ''); ?>>Set
                                                    </option>
                                                    <option value="Pail"
                                                        <?php echo e($quote->info_qty == 'Pail' ? 'selected' : ''); ?>>Pail
                                                    </option>
                                                    <option value="Unit"
                                                        <?php echo e($quote->info_qty == 'Unit' ? 'selected' : ''); ?>>Unit
                                                    </option>
                                                    <option value="Lot"
                                                        <?php echo e($quote->info_qty == 'Lot' ? 'selected' : ''); ?>>Lot
                                                    </option>
                                                    <option value="Meter"
                                                        <?php echo e($quote->info_qty == 'Meter' ? 'selected' : ''); ?>>Meter
                                                    </option>
                                                    <option value="Hari"
                                                        <?php echo e($quote->info_qty == 'Hari' ? 'selected' : ''); ?>>Hari
                                                    </option>
                                                    <option value="Bulan"
                                                        <?php echo e($quote->info_qty == 'Bulan' ? 'selected' : ''); ?>>Bulan
                                                    </option>
                                                    <option value="Kg"
                                                        <?php echo e($quote->info_qty == 'Kg' ? 'selected' : ''); ?>>Kg
                                                    </option>
                                                    <option value="Tube"
                                                        <?php echo e($quote->info_qty == 'Tube' ? 'selected' : ''); ?>>Tube
                                                    </option>
                                                    <option value="Titik"
                                                        <?php echo e($quote->info_qty == 'Titik' ? 'selected' : ''); ?>>Titik
                                                    </option>
                                                    <option value="Batang"
                                                        <?php echo e($quote->info_qty == 'Batang' ? 'selected' : ''); ?>>Batang
                                                    </option>
                                                </select>
                                        ...
                                        <div class="col-md-1 col-12 mb-md-0 mb-3">
                                            ...
                                            <input type="number" class="form-control invoice-item-disc" placeholder="%"
                                                name="disc[]" id="disc-<?php echo e($dataDetail); ?>"
                                            ...
                                            <div class="row w-100 p-3 pb-0">
                                                ...
                                                <div class="col-md-1 col-12 mb-md-0 mb-3">
                                                    ...
                                                    <input type="number" class="form-control mb-4 invoice-item-qty"
                                                        ...
                                                        data-id="1" min="1" value="<?php echo e(old('qty[1][]')); ?>">
                                                    <div class="form-floating form-floating-outline">
                                                ...
                                                <div class="col-md-1 col-12 mb-md-0 mb-3">
                                                    ...
                                                    <input type="number" class="form-control invoice-item-disc"
                                                        ...
                                                        min="0" value="<?php echo e(old('disc[1][]', '0')); ?>">
                                                </div>
                                                <div class="col-md-1 col-12 pe-0">
                                                    <p class="mb-2 repeater-title">Amount</p>
                                            ...
                                            <div class="row w-100 p-3 pb-0">
                                                    ...
                                                    <div class="form-floating form-floating-outline mb-2">
                                                        <select id="product-1-1"
                                                            ...
                                                            <?php $__currentLoopData = $product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $products): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($products->id); ?>"
                                                                    data-replacement="<?php echo e($products->id); ?>"
                                                                    data-commodity="<?php echo e($products->comId); ?>">
                                                                    <?php echo e($products->brand); ?> <?php echo e($products->pn); ?>
                                                ...
                                                <div class="col-md-3 col-12 mb-md-0 mb-3">
                                                    ...
                                                    <div class="input-group mb-3" data-price="1">
                                                        ...
                                                        <input class="form-control invoice-item-price" type="number"
                                                            name="price[]" id="price-1-1" value="<?php echo e(old('price[]')); ?>"
                                                            hidden>
                                                    </div>
                                                    <div class="d-flex justify-content-between mb-3">
                                                        <p>Stock : <span class="info-stock-label"
                                                ...
                                                <div class="col-md-1 col-12 mb-md-0 mb-3">
                                                    ...
                                                    <input type="number" class="form-control invoice-item-disc"
                                                        ...
                                                        min="0" value="<?php echo e(old('disc[]', '0')); ?>">
                                                </div>
                                                <div class="col-md-1 col-12 pe-0">
                                                    <p class="mb-2 repeater-title">Amount</p>
                                                    <p class="mb-0 amount-label" id="amount-label-1-1" data-id="1">
...
<?php $__env->startPush('page-script'); ?>
    <script src="<?php echo e(asset('assets')); ?>/includes/repeater/repeater-service.js"></script>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/sales/quotation/form-service.blade.php ENDPATH**/ ?>