<?php $__env->startSection('title', 'Sales Forecast Dashboard'); ?>
...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center forecast-header">
        ...
        <div class="mt-3 mt-md-0 d-flex gap-2 align-self-stretch align-self-md-auto">
            <a href="<?php echo e(route('forecast.setup')); ?>" class="btn btn-outline-primary d-flex align-items-center gap-2" style="border-radius: 12px; font-weight: 600;">
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm" style="border-radius: 16px; background: #ffffff;">
                <div class="card-body p-3">
                    <form action="<?php echo e(route('forecast.index')); ?>" method="GET" class="row g-3 align-items-center">
                        ...
                        <div class="col-md-3">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <select class="form-select filter-select" id="yearSelect" name="year" onchange="this.form.submit()">
                                    <?php for($i = Carbon\Carbon::now()->year + 1; $i >= 2024; $i--): ?>
                                        <option value="<?php echo e($i); ?>" <?php echo e($year == $i ? 'selected' : ''); ?>>Year <?php echo e($i); ?></option>
                                    <?php endfor; ?>
                                </select>
                            </div>
                        </div>
                        <?php if(Auth::user()->role == 'Admin' || Auth::user()->role == 'Sales Manager'): ?>
                        <div class="col-md-4">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <select class="form-select filter-select" id="salesSelect" name="id_sales" onchange="this.form.submit()">
                                    ...
                                    <?php $__currentLoopData = $salesUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($user->id); ?>" <?php echo e($salesId == $user->id ? 'selected' : ''); ?>><?php echo e($user->name); ?></option>
                        ...
                        <div class="col-md-3">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <select class="form-select filter-select" id="semesterSelect" name="semester" onchange="this.form.submit()">
                                    <option value="all" <?php echo e($semester == 'all' ? 'selected' : ''); ?>>Full Fiscal Year</option>
                                    <option value="1" <?php echo e($semester == '1' ? 'selected' : ''); ?>>H1 (Jan - Jun)</option>
                                    <option value="2" <?php echo e($semester == '2' ? 'selected' : ''); ?>>H2 (Jul - Dec)</option>
                                </select>
                            </div>
                        </div>
                    </form>
        ...
        <div class="col-lg-4">
            <div class="card metric-card card-target border-0 shadow-sm" style="border-radius: 20px; overflow: hidden; border-top: 4px solid #6c757d !important;">
                <div class="card-body p-4">
                    ...
                    <h3 class="metric-value mb-1" style="font-size: 1.85rem; font-weight: 800; color: #374151;">Rp <?php echo e(number_format($totalTarget, 0, ',', '.')); ?></h3>
        ...
        <div class="col-lg-4">
            <div class="card metric-card card-projection border-0 shadow-sm" style="border-radius: 20px; overflow: hidden; border-top: 4px solid #6366f1 !important;">
                <div class="card-body p-4">
                    ...
                    <h3 class="metric-value mb-1" style="font-size: 1.85rem; font-weight: 800; color: #6366f1;">Rp <?php echo e(number_format($totalProjection, 0, ',', '.')); ?></h3>
            ...
            <div class="card metric-card card-actual border-0 shadow-sm" style="border-radius: 20px; overflow: hidden; border-top: 4px solid #10b981 !important;">
                <div class="card-body p-4">
                    ...
                    <div class="d-flex align-items-baseline justify-content-between">
                        <h3 class="metric-value mb-1" style="font-size: 1.85rem; font-weight: 800; color: #10b981;">Rp <?php echo e(number_format($totalActual, 0, ',', '.')); ?></h3>
                        <span class="badge bg-success text-white px-3 py-1 fw-bold" style="font-size: 0.85rem; border-radius: 20px; box-shadow: 0 2px 6px rgba(16, 185, 129, 0.3);"><?php echo e($realizationRate); ?>%</span>
                    </div>
    ...
    <div class="card custom-table-card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <span class="badge bg-label-primary font-semibold">Calendar Year <?php echo e($year); ?></span>
        </div>
        <div class="card-body p-4">
            ...
            <div class="card border-0 shadow-sm" style="border-radius: 20px; overflow: hidden; background: #ffffff;">
                ...
                <div class="table-responsive p-3">
                    <table class="table table-bordered custom-table align-middle">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $months; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <span><?php echo e(number_format($data['target'], 0, ',', '.')); ?></span>
                                    </div>
                                </td>
                                <td class="text-end text-primary fw-semibold">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span class="text-primary text-opacity-75" style="font-size: 0.8rem; font-weight: 500;">Rp</span>
                                        <span><?php echo e(number_format($data['projection'], 0, ',', '.')); ?></span>
                                    </div>
                                </td>
                                <td class="text-end text-success fw-bold">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span class="text-success text-opacity-75" style="font-size: 0.8rem; font-weight: 500;">Rp</span>
                                        <span><?php echo e(number_format($data['actual'], 0, ',', '.')); ?></span>
                                    </div>
                                </td>
                                <td class="text-center">
                                    <span class="badge <?php echo e($rateBadgeClass); ?> px-2 py-1 fw-bold" style="font-size: 0.78rem; border-radius: 12px;">
                                        <?php echo e($monthRate); ?>%
                                    </span>
                                </td>
                                <td class="text-end">
                                    <span class="badge badge-pill-custom <?php echo e($badgeClass); ?>">
                                        <?php echo e($sign); ?> Rp <?php echo e(number_format(abs($deviation), 0, ',', '.')); ?>

                                    </span>
                                </td>
                                <td class="text-center">
                                    <button type="button" class="btn btn-sm btn-label-primary waves-effect" data-bs-toggle="modal" data-bs-target="#modalMonthlyDetail_<?php echo e($monthId); ?>">
    ...
    <?php
        $monthId = str_replace('-', '_', $key);
    ?>
    <div class="modal fade" id="modalMonthlyDetail_<?php echo e($monthId); ?>" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content border-0 shadow" style="border-radius: 16px;">
                <div class="modal-header bg-lighter py-3">
                    <div>
                        <h5 class="modal-title fw-bold text-primary mb-0">
                            <i class="mdi mdi-calendar-text me-1"></i>Detail Performance Month: <?php echo e($data['name']); ?> <?php echo e($year); ?>

                        </h5>
                        <small class="text-muted">Rincian breakdown target forecast & pencapaian PO pada bulan <?php echo e($data['name']); ?></small>
                    </div>
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-4">
                            <div class="p-3 border rounded bg-light">
                                ...
                                <span class="fw-bold text-secondary fs-5">Rp <?php echo e(number_format($data['target'], 0, ',', '.')); ?></span>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="p-3 border rounded bg-light">
                                <span class="text-muted small d-block">Proyeksi Berjalan</span>
                                <span class="fw-bold text-primary fs-5">Rp <?php echo e(number_format($data['projection'], 0, ',', '.')); ?></span>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="p-3 border rounded bg-light">
                                <span class="text-muted small d-block">Realisasi PO (Won)</span>
                                <span class="fw-bold text-success fs-5">Rp <?php echo e(number_format($data['actual'], 0, ',', '.')); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <ul class="nav nav-pills nav-fill mb-3 border-bottom pb-2" role="tablist">
                        <li class="nav-item">
                            <button class="nav-link active fw-semibold" data-bs-toggle="pill" data-bs-target="#tab-modal-forecast-<?php echo e($monthId); ?>" type="button" role="tab">
                                <i class="mdi mdi-chart-timeline-variant me-1"></i>Rencana Forecast Unit (<?php echo e(count($data['forecast_details'] ?? [])); ?>)
                            </button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link fw-semibold" data-bs-toggle="pill" data-bs-target="#tab-modal-actual-<?php echo e($monthId); ?>" type="button" role="tab">
                                <i class="mdi mdi-file-check-outline me-1"></i>Realisasi PO Masuk (<?php echo e(count($data['actual_details'] ?? [])); ?>)
                            </button>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content p-0">
                        ...
                        <div class="tab-pane fade show active" id="tab-modal-forecast-<?php echo e($monthId); ?>" role="tabpanel">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped align-middle m-0" style="font-size: 0.85rem;">
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $data['forecast_details'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fIndex => $fDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <?php
                                        ...
                                        ?>
                                        <tr>
                                            <td class="text-center"><?php echo e($fIndex + 1); ?></td>
                                            <td class="fw-bold"><?php echo e($fDetail['company']); ?></td>
                                            <td>
                                                <span><?php echo e($fDetail['brand']); ?> <?php echo e($fDetail['model']); ?></span>
                                                <small class="text-muted d-block">S/N: <?php echo e($fDetail['serial']); ?></small>
                                            </td>
                                            <td>
                                                <span class="badge <?php echo e($badgePm); ?>"><?php echo e($fDetail['visit_name']); ?> (<?php echo e($fDetail['type']); ?>)</span>
                                            </td>
                                            <td><span class="fw-semibold text-secondary"><?php echo e($fDetail['date']); ?></span></td>
                                            <td class="text-end">Rp <?php echo e(number_format($fDetail['parts_cost'], 0, ',', '.')); ?></td>
                                            <td class="text-end">Rp <?php echo e(number_format($fDetail['service_fee'], 0, ',', '.')); ?></td>
                                            <td class="text-end text-primary fw-bold">Rp <?php echo e(number_format($fDetail['total_revenue'], 0, ',', '.')); ?></td>
                                        </tr>
                        ...
                        <div class="tab-pane fade" id="tab-modal-actual-<?php echo e($monthId); ?>" role="tabpanel">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped align-middle m-0" style="font-size: 0.85rem;">
                                    <thead class="table-light">
                                        <tr>
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $data['actual_details'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aIndex => $aDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="text-center"><?php echo e($aIndex + 1); ?></td>
                                            <td><span class="fw-semibold text-primary"><?php echo e($aDetail['no_quotation']); ?></span></td>
                                            <td><span class="fw-semibold text-dark"><?php echo e($aDetail['no_po']); ?></span></td>
                                            <td class="fw-bold"><?php echo e($aDetail['company']); ?></td>
                                            <td><span class="fw-semibold text-secondary"><?php echo e($aDetail['date']); ?></span></td>
                                            <td class="text-end text-success fw-bold">Rp <?php echo e(number_format($aDetail['total'], 0, ',', '.')); ?></td>
                                        </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <tr>
...
<script>
    $(document).ready(function() {
        var targetData = [
            <?php $__currentLoopData = $months; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        var projectionData = [
            <?php $__currentLoopData = $months; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo e($data['projection']); ?>,
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ];

        var actualData = [
            <?php $__currentLoopData = $months; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo e($data['actual']); ?>,
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ];
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/sales/forecast/dashboard.blade.php ENDPATH**/ ?>