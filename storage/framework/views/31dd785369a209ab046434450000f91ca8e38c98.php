                                            ...
                                            <div class="col-md-1 col-12 mb-md-0 mb-3">
                                                ...
                                                <div class="form-floating form-floating-outline mb-4">
                                                    <select class="form-select invoice-item-info" id="info-qty-1"
                                                        ...
                                                        <option value="Days"
                                                            <?php echo e($quote->info_qty == 'Days' ? 'selected' : ''); ?>>Days
                                                        </option>
                                                    </select>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/sales/quotation/unit/form.blade.php ENDPATH**/ ?>