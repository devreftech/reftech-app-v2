<form action="<?php echo e(route('payment.addCost', $payment->id)); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="form-control invoice-item-cost-label" id="costLabel"
                                        ...
                                        @blur="focused = false" value="<?php echo e(old('cost', number_format($payment->cost, 0, '', '.'))); ?>">
                                    <input class="form-control invoice-item-cost" type="number" name="cost"
                                        id="cost" value="<?php echo e(old('cost', $payment->cost)); ?>" hidden>
...
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/payment/cost.blade.php ENDPATH**/ ?>