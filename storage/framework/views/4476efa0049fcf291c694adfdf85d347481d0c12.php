    ...
    <div class="card card-minimalist mb-4">
        <div class="card-header card-minimalist-header py-2">
            <ul class="nav nav-pills card-header-pills border-0 m-0 flex-nowrap overflow-auto" id="cbs-sales-tab-nav"
                data-default-sales-id="<?php echo e($sales->first()->id ?? ''); ?>" role="tablist">
                <?php $__currentLoopData = $sales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="nav-item" role="presentation">
                        <button type="button"
                            class="nav-link fw-semibold waves-effect waves-light select-sales <?php echo e($loop->first ? 'active' : ''); ?>"
                            aria-selected="true" data-id="<?php echo e($sale->id); ?>">
                            <?php echo e($sale->name); ?>

                            <span class="badge rounded-pill bg-label-success ms-1"><?php echo e($customersCountBySales[$sale->id] ?? 0); ?></span>
                        </button>
                    </li>
...
<?php $__env->startPush('page-script'); ?>
    ...
    <script src="<?php echo e(asset('assets')); ?>/includes/table-customer-by-sales.js"></script>
<?php $__env->stopPush(); ?>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/sales/existing/indexBySales.blade.php ENDPATH**/ ?>