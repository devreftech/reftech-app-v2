...
<?php $__env->startSection('title', 'Part Inquiry - Add New'); ?>
<?php $__env->startSection('content'); ?>
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light"><a href="<?php echo e(route('part-inquiry.index')); ?>">Part Inquiry</a> /</span> Add New
    </h4>
    ...
    <form action="<?php echo e(route('part-inquiry.store')); ?>" method="POST" id="formPartInquiry">
        <?php echo csrf_field(); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-floating form-floating-outline">
                                <input type="text" class="form-control" id="commodity" name="commodity"
                                    placeholder="W001" value="<?php echo e(old('commodity')); ?>">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating form-floating-outline">
                                <select class="form-select" name="go" id="go">
                                    ...
                                    <option value="Genuine" <?php echo e(old('go') == 'Genuine' ? 'selected' : ''); ?>>Genuine</option>
                                    <option value="Replacement" <?php echo e(old('go') == 'Replacement' ? 'selected' : ''); ?>>Replacement</option>
                                </select>
                        ...
                        <div class="col-12">
                            <div class="form-floating form-floating-outline">
                                <select class="form-select" name="category" id="category">
                                    <option value="Non Consumable Part" <?php echo e(old('category') == 'Non Consumable Part' ? 'selected' : ''); ?>>Non Consumable Part</option>
                                    <option value="Consumable Part" <?php echo e(old('category', 'Consumable Part') == 'Consumable Part' ? 'selected' : ''); ?>>Consumable Part</option>
                                </select>
                        ...
                        <div class="col-12">
                            <div class="form-floating form-floating-outline">
                                <textarea class="form-control" id="description" name="description"
                                    placeholder="Description" style="height: 80px"><?php echo e(old('description')); ?></textarea>
                ...
                <div id="existingProductFields" style="display:none;">
                    <select class="select2-product w-100" name="id_product" id="id_product" style="width:100%">
                        ...
                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($product->id); ?>" <?php echo e(old('id_product') == $product->id ? 'selected' : ''); ?>>
                                <?php echo e($product->commodity); ?> — <?php echo e($product->description); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-floating form-floating-outline">
                            <input type="text" class="form-control" id="brand" name="brand"
                                placeholder="Mann" value="<?php echo e(old('brand')); ?>">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating form-floating-outline">
                            <input type="text" class="form-control" id="pn" name="pn"
                                placeholder="HU718/5x" value="<?php echo e(old('pn')); ?>">
                    ...
                    <div class="col-12">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="selling_price_display"
                                ...
                                value="<?php echo e(old('selling_price') ? number_format(old('selling_price'), 0, ',', '.') : ''); ?>">
                            <input type="hidden" name="selling_price" id="selling_price" value="<?php echo e(old('selling_price')); ?>">
                        </div>
        ...
        <div class="d-flex gap-2">
            ...
            <a href="<?php echo e(route('part-inquiry.index')); ?>" class="btn btn-label-secondary">Batal</a>
        </div>
    </form>
...
<script>
    ...
    $('#addVendorRow').on('click', function () {
        ...
        $row.append($modalTd);
        $row.append('<td><input type="date" class="form-control" name="vendors[' + vendorIndex + '][date]" value="<?php echo e(now()->toDateString()); ?>"></td>');
    ...
    $('#saveQuickAddSupplier').on('click', function () {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: { _token: '<?php echo e(csrf_token()); ?>', code: code, supplier: name, info: info },
    ...
    $('#id_product').on('change', function () {
        ...
        $.get('<?php echo e(route("part-inquiry.product.equivalents", ":id")); ?>'.replace(':id', id), function (data) {
            if (data.length === 0) {
    ...
    $('#applyBulkPrice').on('click', function () {
        ...
        $.ajax({
            url: '<?php echo e(route("part-inquiry.product.equivalents.bulk-price", ":id")); ?>'.replace(':id', idProduct),
            type: 'PATCH',
            data: { _token: '<?php echo e(csrf_token()); ?>', selling_price: price },
            success: function (res) {
                if (res.success) {
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/warehouse/part-inquiry/form.blade.php ENDPATH**/ ?>