...
<?php $__env->startSection('content'); ?>
                    ...
                    <table class="table table-bordered m-0">
                        ...
                        <tbody>
                                ...
                                <?php $__currentLoopData = $subJudul->detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr style="font-size: 13px; border-bottom:none !important; border-top:none !important;">
                                        ...
                                        <td class="align-top py-1 text-end" style="border-bottom:none !important;">
                                            <p class="mb-0">
                                                <?php echo e($product->amount == 0 ? 'SBO' : 'RP ' . number_format($product->price, 0, '', '.')); ?>

                                            </p>
                                        </td>
                                        <td class="align-top py-1" style="border-bottom:none !important;">
                                            <p class="mb-0"><?php echo e($product->amount == 0 ? '-' : $product->disc . ' %'); ?>

                                            </p>
                                        </td>
                                        <td class="align-top py-1 text-end" style="border-bottom:none !important;">
                                            <p class="mb-0">
                                                <?php echo e($product->amount == 0 ? 'SBO' : 'RP ' . number_format($product->amount, 0, '', '.')); ?>
                            ...
                            <tr>
                                ...
                                <td colspan="2" class="text-end"> RP <?php echo e(number_format($quote->subtotal, 0, '', '.')); ?>
                            ...
                            <?php if($quote->diskon != 0): ?>
                                <tr>
                                    ...
                                    <td colspan="2" class="text-end"> RP
                                        <?php echo e(number_format($quote->diskon, 0, '', '.')); ?></td>
                                </tr>
                                <tr>
                                    <td colspan="3"></td>
                                    <td class="text-end"> Total After Discount :</td>
                                    <td colspan="2" class="text-end"> RP
                                        <?php echo e(number_format($quote->subtotal - $quote->diskon, 0, '', '.')); ?></td>
                                </tr>
                            <?php endif; ?>
                            <?php if($quote->tax != 0): ?>
                                <tr>
                            ...
                            <?php if($quote->shipping != 0): ?>
                                <tr>
                                    ...
                                    <td colspan="2" class="text-end"> RP
                                        <?php echo e(number_format($quote->shipping, 0, '', '.')); ?></td>
                                </tr>
                            <?php endif; ?>
                            <tr class="border-top">
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <a class="btn btn-outline-primary d-grid w-100 mb-3 waves-effect"
                                href="<?php echo e(route('revisi-overhaul.quotation', @$primQuote->id ?? $lastQuote->id)); ?>">
                                + Revisi Quotation
                            </a>
                            <a class="btn btn-outline-info d-grid w-100 mb-3 waves-effect"
                                href="<?php echo e(route('edit-service.quotation', @$primQuote->id ?? $lastQuote->id)); ?>">
                                + Edit Quotation
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <a class="btn btn-primary btn-outline-secondary d-grid w-100 mb-3 waves-effect"
                                    target="_blank" href="<?php echo e(route('service-print.quotation', $quote->id)); ?>">
                                    Download ++
                                </a>
                            </div>
                            <div class="col-6">
                                <a class="btn btn-warning btn-outline-secondary d-grid w-100 mb-3 waves-effect"
                                    target="_blank" href="<?php echo e(route('service-print-no-image.quotation', $quote->id)); ?>">
                                    Download --
                                </a>
                            </div>
                        </div>
    ...
    <?php echo $__env->make('components.modal.quotation.insert-fee-service', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('components.modal.quotation.detail-fee-service', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/sales/quotation/service/detail.blade.php ENDPATH**/ ?>