        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="fw-bold mb-1 text-dark" style="font-family: 'Inter', sans-serif;">
                    <?php echo e(Auth::user()->role == 'Logistic' ? 'Good Receipt (Penerimaan Barang)' : 'Penerimaan Barang Masuk (Product In)'); ?>

                </h4>
                <p class="text-muted mb-0 small">
                    <?php echo e(Auth::user()->role == 'Logistic' ? 'Kelola dan verifikasi penerimaan fisik barang berdasarkan Purchase Request.' : 'Kelola dan verifikasi surat jalan (DO) serta invoice barang masuk.'); ?>
...
<?php $__env->startPush('page-script'); ?>
    ...
    <script src="<?php echo e(asset('assets')); ?>/includes/table-product-in-lokal.js"></script>
    <script src="<?php echo e(asset('assets')); ?>/includes/table-product-in-import.js"></script>
    <script src="<?php echo e(asset('assets')); ?>/includes/table-product-in-req-lokal.js"></script>
    <script src="<?php echo e(asset('assets')); ?>/includes/table-product-in-req-import.js"></script>
    <script src="<?php echo e(asset('assets')); ?>/includes/table-product-in-req-logistic.js"></script>
    <script src="<?php echo e(asset('assets')); ?>/includes/table-product-in-logistic.js"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/warehouse/product-in/index.blade.php ENDPATH**/ ?>