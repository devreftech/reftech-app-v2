...
<?php $__env->startSection('title', 'Unit Acquisition Detail'); ?>
<?php $__env->startSection('content'); ?>
    <div class="row invoice-preview">
        <div class="col-xl-9 col-md-8 col-12 mb-md-0 mb-4">
            <div class="card invoice-preview-card">
                <div class="card-body">
                    <div class="d-flex justify-content-between flex-xl-row flex-md-column flex-sm-row flex-column">
                        ...
                        <div class="text-end">
                            ...
                            <div class="mt-1">
                                <span class="text-muted"><?php echo e(\Carbon\Carbon::parse($fixed->beli)->format('d-m-Y')); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body mb-3">
                    <h4>
                        <?php echo e($fixed->code); ?>

                        <?php if($fixed->kondisi): ?>
                            <span class="badge bg-label-secondary"><?php echo e($fixed->kondisi === 'Baru' ? 'Unit Baru' : 'Unit Second'); ?></span>
                        <?php endif; ?>
                    ...
                    <?php endif; ?>
                    <p class="text-muted mb-2">Serial Number: <?php echo e($fixed->serial_number ?: '-'); ?></p>
                    <p class="text-muted mb-2">
                        Harga Jual:
                        <span class="fw-semibold">
                            <?php echo e($fixed->harga_jual ? 'Rp ' . number_format($fixed->harga_jual, 0, ',', '.') : 'Belum diset'); ?>
        ...
        <div class="col-xl-3 col-md-4 col-12 invoice-actions">
            <div class="card">
                <div class="card-body">
                    <?php if($fixed->qc_status === 'checking' || $fixed->kondisi === 'Baru'): ?>
                        <a href="<?php echo e(route('unit-acquisition.service.create', $fixed->id)); ?>"
                    ...
                    <?php if($fixed->qc_status === 'checking'): ?>
                        <?php if(auth()->user()->role === 'Admin'): ?>
                            <form action="<?php echo e(route('unit-acquisition.confirm', $fixed->id)); ?>" method="post" class="mb-2">
                                <?php echo csrf_field(); ?>
                            ...
                            <form action="<?php echo e(route('unit-acquisition.confirm', $fixed->id)); ?>" method="post" class="mb-3">
                                <?php echo csrf_field(); ?>
                        ...
                        <?php endif; ?>
                    <?php endif; ?>
                    <?php if($fixed->qc_status === 'ok' && auth()->user()->role === 'Admin'): ?>
                        <form action="<?php echo e(route('unit-acquisition.status', $fixed->id)); ?>" method="post" class="mb-3">
                            <?php echo csrf_field(); ?>
                            <div class="form-floating form-floating-outline mb-2">
                                <select class="form-select" name="status_unit">
                                    <option value="OK" <?php echo e($fixed->status_unit === 'OK' ? 'selected' : ''); ?>>OK</option>
                                    <option value="Service" <?php echo e($fixed->status_unit === 'Service' ? 'selected' : ''); ?>>Sedang Service</option>
                                    <option value="Rental" <?php echo e($fixed->status_unit === 'Rental' ? 'selected' : ''); ?>>Sedang Rental</option>
                                    <option value="Breakdown" <?php echo e($fixed->status_unit === 'Breakdown' ? 'selected' : ''); ?>>Breakdown</option>
                                    <option value="Reserved" <?php echo e($fixed->status_unit === 'Reserved' ? 'selected' : ''); ?>>Reserved</option>
                                    <option value="Sold" <?php echo e($fixed->status_unit === 'Sold' ? 'selected' : ''); ?>>Sold</option>
                                </select>
                        ...
                        <form action="<?php echo e(route('unit-acquisition.harga-jual', $fixed->id)); ?>" method="post" class="mb-3">
                            <?php echo csrf_field(); ?>
                            <div class="input-group mb-2">
                                <span class="input-group-text">Rp</span>
                                <input type="text" class="form-control rupiah-input" id="hargaJualDisplay"
                                    placeholder="0" autocomplete="off"
                                    value="<?php echo e($fixed->harga_jual ? number_format(old('harga_jual', $fixed->harga_jual), 0, ',', '.') : ''); ?>">
                                <input type="hidden" name="harga_jual" id="hargaJualRaw"
                                    value="<?php echo e(old('harga_jual', $fixed->harga_jual)); ?>">
                            </div>
                            <button type="submit" class="btn btn-outline-primary d-grid w-100 waves-effect">
                                Simpan Harga Jual
                            </button>
                    ...
                    <?php endif; ?>
                    <?php if($fixed->machine): ?>
                        <a href="<?php echo e(route('service-reports.unit.machine', [$fixed->machine->id_unit, $fixed->id_machine])); ?>"
                            class="btn <?php echo e($fixed->status_unit === 'Rental' ? 'btn-warning' : 'btn-outline-secondary'); ?> d-grid w-100 mb-3 waves-effect">
                            <?php echo e($fixed->status_unit === 'Rental' ? 'Buat Service Report (Wajib Sebelum Sewa)' : 'Service Report'); ?>
                    ...
                    <a href="<?php echo e(route('fixed.show', $fixed->id)); ?>"
                        class="btn btn-outline-secondary d-grid w-100 mb-3 waves-effect">
                        Lihat di Finance
                    </a>
        ...
        <?php if($fixed->machine): ?>
            $(function() {
                $('.datatable-service-report-history').DataTable({
                    ajax: {
                        type: 'GET',
                        url: '/db/service-reports/machine/<?php echo e($fixed->id_machine); ?>'
                    },
                    columns: [
                        { data: 'no_service' },
                        { data: 'type' },
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/warehouse/unit-acquisition/show.blade.php ENDPATH**/ ?>