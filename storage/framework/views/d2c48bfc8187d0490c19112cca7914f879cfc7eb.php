        ...
        <div class="col-md-12">
            <ul class="nav nav-pills flex-column flex-sm-row mb-4">
                ...
                <?php if(Auth::user()->role == 'Admin'): ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('audit-tools.index')); ?>"><i
                                class="mdi mdi-tools me-1 mdi-20px"></i>Tools</a>
                    </li>
                <?php endif; ?>
            </ul>
            <div class="card mb-4">
                <form action="<?php echo e(route('profile.update', Auth::user()->id)); ?>" id="" method="POST"
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            <img src="<?php echo e(url('') . '/' . Auth::user()->image); ?>" alt="user-avatar"
                            ...
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input class="form-control" type="text" id="name" name="name"
                                        value="<?php echo e(old('name', Auth::user()->name ?? '')); ?>" placeholder="john doe" />
                            ...
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input class="form-control" type="date" id="Date" name="birthday"
                                        value="<?php echo e(old('birthday', Auth::user()->birthday ?? now()->format('Y-m-d'))); ?>">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <div class="form-floating form-floating-outline">
                                            <input type="text" class="form-control" pattern="[0-9]*"
                                                ...
                                                value="<?php echo e(old('phone', Auth::user()->phone ? substr(Auth::user()->phone, 3) : '')); ?>">
                            ...
                            <div class="col-12">
                                <div class="form-floating form-floating-outline">
                                    <textarea class="form-control h-px-100" rows="2" placeholder="Write your note here...." name="address"
                                        id="address"><?php echo e(Auth::user()->address); ?></textarea>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/sales/user/setting.blade.php ENDPATH**/ ?>