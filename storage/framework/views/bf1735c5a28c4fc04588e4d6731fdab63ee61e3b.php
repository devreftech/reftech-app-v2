<form action="<?php echo e(route('add_payment.quotation', $quote->id)); ?>" method="post" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
            ...
            <div class="modal-content text-center">
                ...
                <div class="modal-body p-0">
                    <div class="onboarding-content mb-0">
                        <h4 class="onboarding-title text-body"> Add Payment <?php echo e($quote->no_quote); ?></h4>
                                    ...
                                    <div class="form-floating form-floating-outline">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control invoice-item-amount" type="number"
                                                name="amount" id="amount" value="<?php echo e(old('amount')); ?>" hidden>
                                        </div>
                                    </div>
                                </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/quotation/add-payment.blade.php ENDPATH**/ ?>