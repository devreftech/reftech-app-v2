...
<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route(Auth::user()->role == 'Logistic' ? 'product-in.logistic-store' : 'product-in.store')); ?>"
        method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="form-floating mb-3">
            <input type="text" class="form-control form-control-lg fw-bold fs-3 text-primary"
                id="noProductInPreview" value="<?php echo e($nextNoProductIn); ?>" disabled>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal"
                                data-bs-target="#createSupplier" <?php echo e(Auth::user()->role == 'Logistic' ? 'disabled' : ''); ?>>
                                + Supplier
                            </button>
                        </div>
                    </div>
                        ...
                        <div class="repeater-wrapper pt-0 pt-md-4" data-repeater-item="">
                            <div class="d-flex border rounded position-relative pe-0">
                                <div class="row w-100 p-3">
                                    <div
                                        class="<?php echo e(Auth::user()->role == 'Admin' || Auth::user()->role == 'Accounting' ? 'col-md-4' : 'col-md-6'); ?> col-12 mb-md-0 mb-3">
                                        ...
                                        <div class="col-md-2 col-12 mb-md-0 mb-3">
                                            ...
                                            <div class="input-group" data-disc="1">
                                                ...
                                                <input class="form-control invoice-item-disc" type="number"
                                                    name="disc[]" id="disc-1" value="<?php echo e(old('disc[]')); ?>" hidden>
                                            </div>
                                        </div>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/warehouse/product-in/form.blade.php ENDPATH**/ ?>