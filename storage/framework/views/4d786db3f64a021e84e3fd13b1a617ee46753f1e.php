<form action="<?php echo e(route('machine.update', $machine->id)); ?>" method="post" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <?php if($machine): ?>
        <?php echo method_field('patch'); ?>
    <?php endif; ?>
    <div class="modal animate__animated animate__fadeIn" id="editMachine-<?php echo e($machine->id); ?>" tabindex="-1"
                            ...
                            <div class="form-floating form-floating-outline mb-2">
                                ...
                                <select class="select2 form-select" data-allow-clear="true" name="unit"
                                    ...
                                    <?php $__currentLoopData = $unit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($item->id); ?>" <?php echo e($machine->id_unit == $item->id ? 'selected' : ''); ?>>
                                            <?php echo e($item->brand); ?> - <?php echo e($item->unit->sku ?? '-'); ?> ||
                                            <?php echo e($item->bar ?? '-'); ?> - <?php echo e($item->air_cap ?? '-'); ?>
                        ...
                        <div class="col-12 col-md-6 mb-2">
                            <div class="form-floating form-floating-outline">
                                <input type="text" id="descAnimation" class="form-control" name="desc"
                                    placeholder="Example: CEO" value="<?php echo e(old('desc', @$machine->desc ?? '')); ?>">
                        ...
                        <div class="col-12 col-md-6 mb-2">
                            <div class="form-floating form-floating-outline">
                                <input type="text" id="serialAnimation" class="form-control" name="serial"
                                    placeholder="Example: CEO" value="<?php echo e(old('serial', @$machine->serial ?? '')); ?>">
                        ...
                        <div class="col-12 col-md-6 mb-2">
                            <div class="form-floating form-floating-outline">
                                <input type="text" id="tagAnimation" class="form-control" name="tag"
                                    placeholder="Example: CEO" value="<?php echo e(old('tag', @$machine->tag ?? '')); ?>">
                        ...
                        <div class="col-12 col-md-6 mb-2">
                            <div class="form-floating form-floating-outline">
                                <input type="text" id="loactionAnimation" class="form-control" name="location"
                                    ...
                                    value="<?php echo e(old('location', @$machine->location ?? '')); ?>">
...
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/machine/form-edit.blade.php ENDPATH**/ ?>