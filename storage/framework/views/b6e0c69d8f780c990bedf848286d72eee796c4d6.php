<?php $__env->startSection('title', 'Surat Jalan ' . ($invoice->no_invoice ?? $unitQuote->no_quote)); ?>
                    ...
                    <div class="card-body pb-0">
                        <div class="d-flex justify-content-between flex-xl-row flex-md-column flex-sm-row flex-column gap-3">
                            ...
                            <div class="text-end">
                                ...
                                <p class="mb-1 fw-bold text-dark" style="font-size:14px;">#<?php echo e($doNumber); ?></p>
                                <p class="mb-0 text-muted small"><?php echo e(\Carbon\Carbon::parse($delivery->date)->format('d F Y')); ?></p>
                            </div>
                        </div>
                        ...
                        <div style="display:flex; align-items:stretch; gap:12px; margin-bottom:20px; font-size:12px;">
                            <div style="flex:1; display:flex; flex-direction:column; border:1px solid #dcdcdc; border-radius:6px; padding:10px 14px; background:#fafafa;">
                                ...
                                <p class="mb-1 fw-bold" style="font-size:13.5px; color:#111;"><?php echo e($client->company ?? '-'); ?></p>
                                <p class="mb-0" style="font-size:11.5px; color:#222; line-height:1.4;">
                                    <i class="mdi mdi-map-marker-outline me-1" style="font-size:11px; color:#444;"></i><span style="font-weight:500;"><?php echo e($address); ?></span>
                                </p>
                            </div>
                            <div style="min-width:240px; display:flex; flex-direction:column; border:1px solid #dcdcdc; border-radius:6px; padding:10px 14px; background:#fafafa;">
                                ...
                                <p class="mb-1 fw-semibold" style="font-size:12px; color:#222;">
                                    <i class="mdi mdi-clipboard-text-outline me-1 text-primary"></i>PO / Quote No: <span class="fw-bold"><?php echo e($unitQuote->po_number ?: $unitQuote->no_quote); ?></span>
                                </p>
                                <p class="mb-0 fw-semibold" style="font-size:12px; color:#222;">
                                    <i class="mdi mdi-truck-outline me-1 text-primary"></i>Jenis: <span class="fw-bold"><?php echo e(ucfirst($delivery->type)); ?></span>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="card-body pt-0">
                        <div class="table-responsive mb-4">
                            <table class="table table-bordered m-0" style="border:1px solid rgb(60,60,60);">
                                ...
                                <tbody>
                                    <?php $itemNo = 1; ?>
                                    <?php $__currentLoopData = $dDelivery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(($item->type ?? 'item') === 'header'): ?>
                                            <tr style="background:#f0f0ff; border-top:1.5px solid #d0d0ff; border-bottom:1.5px solid #d0d0ff;">
                                                <td colspan="4" class="fw-bold text-uppercase py-2 px-3 text-primary" style="font-size:12px; letter-spacing:0.5px;">
                                                    <i class="mdi mdi-bookmark-outline me-1"></i> <?php echo e($item->desc); ?>

                                                </td>
                                            </tr>
                                        <?php else: ?>
                                            <tr style="font-size: 13px" class="item-view-row" data-item-id="<?php echo e($item->id); ?>">
                                                <td class="align-top text-center"><?php echo e($itemNo++); ?></td>
                                                <td class="align-top">
                                                    <p class="mb-0 fw-medium item-desc" style="font-size:12px; <?php echo e($item->view == '1' ? 'opacity:.45; text-decoration:line-through;' : ''); ?>"><?php echo e($item->desc); ?></p>
                                                </td>
                                                <td class="align-top text-center" style="white-space:nowrap;"><?php echo e((float) $item->qty); ?> <?php echo e($item->info_qty); ?></td>
                                                <td class="align-top text-center">
                                                    <div class="form-check form-switch d-flex justify-content-center m-0">
                                                        <input class="form-check-input item-view-toggle" type="checkbox" role="switch"
                                                            data-id="<?php echo e($item->id); ?>" <?php echo e($item->view == '0' ? 'checked' : ''); ?>>
                                                    </div>
                                                </td>
                                            </tr>
                                        <?php endif; ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 mt-4 text-center">
                                <div style="height:56px;"></div>
                                <p class="fw-bold mx-3 mb-0" style="border-top:1px solid #999; padding-top:4px;"><?php echo e($client->company ?? '-'); ?></p>
                                                ...
                                                <div class="col-6">
                                                    <div class="row mt-3" style="font-size: 13px">
                                                        ...
                                                        <div class="col-8">
                                                            ...
                                                            <p class="mb-1">: <?php echo e($unitQuote->po_number ?: $unitQuote->no_quote); ?></p>
                                                            <p class="mb-1">: <?php echo e($client->company ?? '-'); ?></p>
                                    ...
                                    <?php $__currentLoopData = $dDelivery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(($item->type ?? 'item') === 'header'): ?>
                                            <tr style="background:#f0f0ff;">
                                                <td colspan="4" class="fw-bold text-uppercase py-1" style="font-size:12px;"><?php echo e($item->desc); ?></td>
                                            </tr>
                                        <?php else: ?>
                                            <tr style="font-size: 13px;" class="item-view-row" data-item-id="<?php echo e($item->id); ?>">
                                                <td class="align-top py-1"><?php echo e($itemNo++); ?></td>
                                                <td class="align-top py-1"><?php echo e($item->qty); ?> <?php echo e($item->info_qty); ?></td>
                                                <td class="align-top py-1 item-desc" style="<?php echo e($item->view == '1' ? 'opacity:.45; text-decoration:line-through;' : ''); ?>"><?php echo e($item->desc); ?></td>
        ...
        <div class="col-xl-3 col-md-4 col-12 invoice-actions">
            <div class="card">
                <div class="card-body d-grid gap-2">
                    <a href="<?php echo e(route('print.delivery', $delivery->id)); ?>"
                        class="btn btn-primary waves-effect" target="_blank">
                        <i class="mdi mdi-printer-outline me-1"></i> Cetak
                    </a>
                    <a href="<?php echo e(route('unit-quotation.show', $unitQuote->id)); ?>" class="btn btn-outline-secondary waves-effect">
                    ...
                    <?php if(Auth::user()->role == 'Admin' || Auth::user()->role == 'Accounting'): ?>
                        <a href="#" class="btn btn-outline-danger waves-effect delete-delivery"
                            ...
                            data-redirect="<?php echo e($invoice ? route('invoice.show_unit', $invoice->id) : route('unit-quotation.show', $unitQuote->id)); ?>">
            ...
            <div class="card mt-3">
                <div class="card-body">
                    ...
                    <p class="mb-2 fw-bold"><?php echo e($invoice->no_invoice ?? '-'); ?></p>
                    <p class="mb-1 fw-semibold" style="font-size:11px;color:#888;">NO. QUOTATION</p>
                    <p class="mb-2 fw-bold"><?php echo e($unitQuote->no_quote); ?></p>
                    <p class="mb-1 fw-semibold" style="font-size:11px;color:#888;">JENIS PENGIRIMAN</p>
                    <p class="mb-2"><?php echo e(ucfirst($delivery->type)); ?></p>
...
<?php $__env->startPush('script'); ?>
    <script>
        $(document).on('change', '.item-view-toggle', function() {
            ...
            $.ajax({
                url: '<?php echo e(url('/delivery/item')); ?>/' + id + '/toggle-view',
                type: 'PATCH',
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/unit-quotation/sj-detail.blade.php ENDPATH**/ ?>