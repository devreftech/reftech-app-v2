<form action="<?php echo e(@$response ? route('update.salon', @$response->id) : route('store.salon')); ?>" method="post"
            ...
            <div class="modal-content text-center">
                ...
                <div class="modal-body p-0">
                    <div class="onboarding-content mb-0">
                        ...
                        <form>
                            <div class="row mb-3">
                                <div class="col-md-<?php echo e($salesID == 16 ? '8' : '12'); ?> col-12">
                                    <div class="row align-items-center">
                                        <div class="col-4 mb-3">
                                            <h5 class="text-start m-0">
                                                <?php echo e($salesID == 16 ? 'Airend Center' : 'Part Compressor'); ?></h5>
                                        </div>
                                            ...
                                            <div class="input-group input-group-merge">
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" class="form-control" id="airendResponse"
                                                        ...
                                                        value="<?php echo e(@$response->airend ? str_replace('.', ',', $response->airend) : '0'); ?>">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    <div class="form-floating form-floating-outline">
                                                        <input type="text" class="form-control" id="kojishaResponse"
                                                            ...
                                                            aria-describedby="basic-addon11"
                                                            oninput="validateFloatInputResponse(this)"
                                                            value="<?php echo e(@$response->kojisha ? str_replace('.', ',', $response->kojisha) : '0'); ?>">
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="card text-center bg-label-secondary h-100">
                                            <input type="text" name="average" id="averageResponse"
                                                value="<?php echo e(@$response->average ? str_replace('.', ',', $response->average) : '0'); ?>"
                                                hidden>
                                            <div class="card-body">
                                                <h5>Average</h5>
                                                <p id="averageResponseText">
                                                    <?php echo e(@$response->average ? str_replace('.', ',', $response->average) : '0'); ?>
...
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/onlineSales/response.blade.php ENDPATH**/ ?>