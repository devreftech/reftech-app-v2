...
<div class="invoice-print p-2">
    <div class="container-fluid flex-grow-1 container-p-y">
        ...
        <div class="mb-2">
            <table class="table table-bordered m-0" style="width: 100%;text-align: middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-end"> <?php echo e(number_format($quote->subtotal, 0, '', '.')); ?></td>
                    </tr>
                    <?php if($quote->diskon != 0): ?>
                        <tr>
                            <td colspan="5" class="text-end"> Discount :</td>
                            <td class="text-end"> <?php echo e(number_format($quote->diskon, 0, '', '.')); ?></td>
                        </tr>
                        <tr>
                            <td colspan="5" class="text-end"> Total After Discount :</td>
                            <td class="text-end"><?php echo e(number_format($quote->subtotal - $quote->diskon, 0, '', '.')); ?></td>
                        </tr>
                    <?php endif; ?>
                    
                            <?php if($quote->tax != 0): ?>
                                <tr>
                                    <td class="text-end" colspan="5"> Total Tax :</td>
                                    <td class="text-end"><?php echo e(number_format($tax, 0, '', '.')); ?></td>
                                </tr>
                            <?php endif; ?>
                            <?php if($quote->shipping != 0): ?>
                                <tr>
                                    ...
                                    <td class="text-end"><?php echo e(number_format($quote->shipping, 0, '', '.')); ?></td>
                                </tr>
                            <?php endif; ?>
                    <tr class="border-top">
                        <td colspan="5" class="px-4 border-right" style="background-color: #E7FF00">
                            <p class="fw-semibold mb-0 text-black text-end">TOTAL PRICE (IDR) </p>
                        </td>
        ...
        <div class="mt-2">
            <h6>Note :</h6>
            <pre class="mb-0"
                style="font-size: 14px; font-family: inter; max-width: 100%; overflow-x: auto; white-space: pre-wrap; text-align: justify; background-color: #f8f8f8; padding: 10px;"><?php echo e($quote->termncon[0]->note); ?></pre>
        </div>
        <div class="termncon">
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/sales/quotation/service/detail-print-no-image.blade.php ENDPATH**/ ?>