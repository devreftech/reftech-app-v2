...
<div class="invoice-print contract-print p-4 text-black">
    <div class="container-fluid flex-grow-1 container-p-y">
        ...
        <?php if($sellcon->type == 'Selling'): ?>
            <div class="doc-header <?php echo e($quote->tax == 0 ? 'justify-content-end' : ''); ?>">
                <?php if($quote->tax != '0'): ?>
                    <div class="brand">
                        <div class="brand-logo mb-2">
                            <img src="<?php echo e(asset('/asset')); ?>/logo/Reftech-Log.png" alt="Reftech" width="150">
                        </div>
                        ...
                        <div class="brand-address">
                            ...
                            <p class="mb-0">
                                ...
                                <?php echo e('   '); ?><i class="mdi mdi-email-outline scaleX-n1-rtl me-1 mdi-13px"></i>info@reftech.id
                            </p>
                        </div>
                    </div>
                <?php endif; ?>
                <div class="doc-meta">
                    ...
                    <div class="doc-number">#<?php echo e($sellcon->no_contract); ?></div>
                    <div class="doc-date"><?php echo e(Carbon\Carbon::parse($sellcon->date)->format('d-m-Y')); ?></div>
                </div>
            </div>
        <?php else: ?>
            <div class="doc-header <?php echo e($quote->tax == 0 ? 'justify-content-end' : ''); ?>">
                <?php if($quote->tax != '0'): ?>
                    <div class="brand">
                        <div class="brand-logo mb-2">
                            <img src="<?php echo e(asset('/asset')); ?>/logo/Logo-update-size.png" alt="Kojisha" width="150">
                        </div>
                        ...
                        <div class="brand-address">
                            ...
                            <p class="mb-0">
                                ...
                                <?php echo e(' | '); ?><i class="mdi mdi-email-outline scaleX-n1-rtl me-1 mdi-13px"></i>admin@kojisha.com
                            </p>
                        </div>
                    </div>
                <?php endif; ?>
                <div class="doc-meta">
                    ...
                    <div class="doc-number">#<?php echo e($sellcon->no_contract); ?></div>
                    <div class="doc-date"><?php echo e(Carbon\Carbon::parse($quote->estimated_date)->format('d-m-Y')); ?></div>
                </div>
            </div>
        <?php endif; ?>
        ...
        <div class="panel mb-3">
            ...
            <div class="d-flex justify-content-between flex-wrap">
                <div class="info-grid">
                    ...
                    <span class="value">: <?php echo e($quote->pic->client->company); ?></span>
                    <span class="label">Name PIC</span>
                    <span class="value">: <?php echo e($quote->pic->name_pic); ?></span>
                    <span class="label">Phone</span>
                    <span class="value">: <?php echo e($quote->pic->client->phone); ?></span>
                </div>
                <div class="info-grid">
                    <span class="label">Seller</span>
                    <span class="value">:
                        <?php if($quote->tax != '0'): ?>
                            <?php echo e($sellcon->type == 'Selling' ? 'PT Reftech Jaya Optima' : 'PT Kojisha Innotiv Indonesia'); ?>

                        <?php else: ?>
                            <?php echo e($quote->sales_name); ?>

                        <?php endif; ?>
                    </span>
                    <span class="label">Email</span>
                    <span class="value">: <?php echo e($quote->pic->client->email); ?></span>
                </div>
            </div>
        </div>
        ...
        <?php if($quote->type == 'Sparepart'): ?>
                ...
                <table class="table table-borderless items-table m-0" style="width: 100%">
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $dquote; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $no++; ?>
                            <tr>
                                <td class="align-middle"><?php echo e($no); ?></td>
                                <td class="text-nowrap align-top">
                                    ...
                                    <pre class="mb-0 item-detail"><?php echo e($product->detail_product); ?></pre>
                                </td>
                                ...
                                <td class="align-top text-end">RP <?php echo e(number_format($product->amount, 0, '', '.')); ?></td>
                            </tr>
                        ...
                        <tr class="totals-row">
                            ...
                            <td colspan="2" class="text-end pt-4 pb-0">
                                ...
                                <?php endif; ?>
                                <p class="mb-2"><?php echo e($quote->tax == '11' ? 'Vat (11%)' : 'Vat'); ?>:</p>
                            ...
                            ?>
                            <td colspan="2" class="text-end pt-4 pb-0">
                                <p class="fw-semibold mb-2">RP <?php echo e(number_format($quote->subtotal, 0, '', '.')); ?></p>
                                <?php if($quote->diskon != 0): ?>
                                    <p class="fw-semibold mb-2">RP <?php echo e(number_format($quote->diskon, 0, '', '.')); ?></p>
                                    <p class="fw-semibold mb-2">RP <?php echo e(number_format($quote->subtotal - $quote->diskon, 0, '', '.')); ?></p>
                                <?php endif; ?>
                                <p class="fw-semibold mb-2"><?php echo e($tax == '0' ? '0' : 'RP ' . number_format($vat, 0, '', '.')); ?></p>
                                <p class="fw-semibold mb-2">RP <?php echo e(number_format($quote->shipping, 0, '', '.')); ?></p>
                            </td>
                        </tr>
                        <tr class="grand-total">
                            ...
                            <td colspan="2">
                                <p class="fw-semibold mb-0 text-end">Rp <?php echo e(number_format($quote->harga_total, 0, '', '.')); ?></p>
                            </td>
                        </tr>
                        <tr class="spacer-row">
                            <td colspan="5"></td>
                        ...
                        <tr class="note-row">
                            ...
                            <td colspan="2" class="note">
                                <pre class="fw-semibold mb-0"><?php echo e($quote->termncon[0]->note); ?></pre>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="panel mb-3">
                ...
                <div class="info-grid info-grid-wide">
                    ...
                    <span class="value">: <?php echo e($quote->termncon[0]->validity); ?></span>
                    <span class="label">Price</span>
                    <span class="value">: <?php echo e($quote->termncon[0]->pricing); ?></span>
                    <span class="label">Delivery Process</span>
                    <span class="value">: <?php echo e($quote->termncon[0]->delivery_process); ?></span>
                    <span class="label">Payment</span>
                    <span class="value">: <?php echo e($quote->termncon[0]->payment); ?></span>
                </div>
            </div>
        <?php else: ?>
            <div class="mb-3">
                                ...
                                <tr class="detail-row">
                                    ...
                                    <td class="align-top">
                                        ...
                                        <?php if($product->detail != '-'): ?>
                                            <pre class="mb-0 item-detail"><?php echo e($product->detail); ?></pre>
                                        <?php endif; ?>
                                    </td>
                                    <td class="align-top py-1 text-end">
                                        <p class="mb-0"><?php echo e(number_format($product->price, 0, '', '.')); ?></p>
                                    </td>
                                    <td class="align-top py-1">
                                        <p class="mb-0"><?php echo e($product->qty); ?> <?php echo e($product->info_qty); ?></p>
                                    </td>
                                    <td class="align-top py-1 text-end">
                                        <p class="mb-0"><?php echo e(number_format($product->disc, 0, '', '.')); ?>%</p>
                                    </td>
                                    <td class="align-top py-1 text-end">
                                        <p class="mb-0"><?php echo e(number_format($product->amount, 0, '', '.')); ?></p>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <tr class="grand-total">
                            <td colspan="4" class="border-right">
                                <p class="fw-bold mb-0 text-black text-end">
                                    TOTAL PRICE, <?php echo e($quote->tax != 0 ? 'INCLUDE' : 'EXCLUDE'); ?> VAT 11%
                                </p>
                            </td>
                            <td colspan="2" class="text-end border-left">
                                <p class="fw-bold mb-0 text-end text-black">RP <?php echo e(number_format($quote->harga_total, 0, '', '.')); ?></p>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="panel mb-3">
                ...
                <div class="info-grid info-grid-wide">
                    ...
                    <span class="value">: <?php echo e($quote->termncon[0]->warranty); ?></span>
                </div>
            </div>
        <?php endif; ?>
        ...
        <?php if($sellcon->type == 'Selling'): ?>
            <div class="signature-row">
                <div class="signature-col">
                    ...
                    <?php if($quote->tax != '0'): ?>
                        <img src="<?php echo e(asset('/asset')); ?>/contract/sign-irene.jpeg" alt="Signature">
                    <?php else: ?>
                        <img src="<?php echo e(asset('/asset')); ?>/sign/ttdirene.jpg" alt="Signature">
                    <?php endif; ?>
                ...
                <div class="signature-col">
                    ...
                    <p class="signature-name"><?php echo e($quote->pic->name_pic); ?></p>
                    <p class="signature-role"><?php echo e($quote->pic->client->company); ?></p>
                </div>
            </div>
        <?php else: ?>
            <div class="signature-row">
                <div class="signature-col">
                    <p class="signature-label">Authorized By,</p>
                    <img src="<?php echo e(asset('/asset')); ?>/contract/sign-dedeh.png" alt="Signature">
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/accounting/contract/detail-print.blade.php ENDPATH**/ ?>