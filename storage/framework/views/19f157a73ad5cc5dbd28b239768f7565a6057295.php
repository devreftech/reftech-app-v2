                ...
                <ul class="dropdown-menu dropdown-menu-end py-0">
                    <li class="dropdown-menu-header border-bottom">
                        <div class="dropdown-header d-flex align-items-center py-3">
                            ...
                            <?php if(in_array(Auth::user()?->role, ['Admin', 'Accounting', 'Finance']) && @$pendingCancelQuotes && $pendingCancelQuotes->count() > 0): ?>
                                <span class="badge rounded-pill bg-danger me-1"><?php echo e($pendingCancelQuotes->count()); ?> Cancel PO</span>
                            <?php endif; ?>
                            <?php if(Auth::user()?->role == 'Admin'): ?>
                                <?php if(@$unreadCommentAdmin): ?>
                                    <?php if($unreadCommentAdmin->count() > 1): ?>
                                        <span
                                            class="badge rounded-pill bg-label-primary"><?php echo e($unreadCommentAdmin->count()); ?>

                                            New</span>
                                    <?php endif; ?>
                                <?php endif; ?>
                            <?php else: ?>
                                <?php if(@$unreadComment): ?>
                                    <?php if($unreadComment->count() > 1): ?>
                                        <span class="badge rounded-pill bg-label-primary"><?php echo e($unreadComment->count()); ?>
                    ...
                    <li class="dropdown-notifications-list scrollable-container">
                        <ul class="list-group list-group-flush">
                            ...
                            <?php if(in_array(Auth::user()?->role, ['Admin', 'Accounting', 'Finance']) && @$pendingCancelQuotes && $pendingCancelQuotes->count() > 0): ?>
                                <?php $__currentLoopData = $pendingCancelQuotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cancelQ): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e(route('unit-quotation.show', $cancelQ->id)); ?>"
                                        ...
                                        <div class="d-flex gap-2">
                                            ...
                                            <div class="d-flex flex-column flex-grow-1 overflow-hidden w-px-200">
                                                <h6 class="mb-1 text-truncate text-danger fw-bold"><?php echo e($cancelQ->no_quote); ?></h6>
                                                <small class="text-truncate text-body">
                                                    <strong class="text-dark"><?php echo e($cancelQ->sales?->name); ?></strong> mengajukan pembatalan PO (<?php echo e($cancelQ->client?->company ?? '-'); ?>)
                                                </small>
                                            </div>
                                            <div class="flex-shrink-0 dropdown-notifications-actions">
                                                <small class="text-muted"><?php echo e(\Carbon\Carbon::parse($cancelQ->updated_at)->diffForHumans()); ?></small>
                                            </div>
                                        </div>
                                    </a>
                            ...
                            <?php if(Auth::user()?->role == 'Admin'): ?>
                                <?php if(@$commentAdmin): ?>
                                    <?php $__currentLoopData = $commentAdmin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <div
                                                        ...
                                                        <h6 class="mb-1 text-truncate"><?php echo e($item->no_quote); ?></h6>
                            ...
                            <?php if(@$prMentions && $prMentions->count() > 0): ?>
                                <?php $__currentLoopData = $prMentions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e(route('purchase-request.show', $pm->discussion->id_pending)); ?>#diskusi"
                                        class="view-pr-mention <?php echo e($pm->level == '0' ? 'bg-label-secondary' : ''); ?>"
                                        data-mention-id="<?php echo e($pm->id); ?>">
                                        <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                            <div class="d-flex gap-2">
                                                ...
                                                <div class="d-flex flex-column flex-grow-1 overflow-hidden w-px-200">
                                                    <h6 class="mb-1 text-truncate">PR #<?php echo e($pm->discussion->pending->no_pending ?? $pm->discussion->id_pending); ?></h6>
                                                    <small class="text-truncate text-body">Kamu di-mention dalam diskusi</small>
                                                </div>
                                                <div class="flex-shrink-0 dropdown-notifications-actions">
                                                    <small class="text-muted"><?php echo e(\Carbon\Carbon::parse($pm->created_at)->diffForHumans()); ?></small>
                                                </div>
                                            </div>
                                        </li>
                                    </a>
                    ...
                    <li class="dropdown-menu-footer border-top p-2">
                        <a href="<?php echo e(route('index.notif')); ?>" class="btn btn-primary d-flex justify-content-center">
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                        <img src="<?php echo e(url('') . '/' . Auth::user()?->image); ?>" alt
                            class="w-px-40 h-auto rounded-circle" />
                    </div>
                </a>
                <?php if(Auth::user()): ?>
...
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/layouts/sales/navbar.blade.php ENDPATH**/ ?>