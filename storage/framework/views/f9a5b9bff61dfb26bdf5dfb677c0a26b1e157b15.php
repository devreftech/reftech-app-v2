    ...
    <?php $__env->startSection('content'); ?>
        ...
        <form id="formAuthentication" class="mb-3 fv-plugins-bootstrap5 fv-plugins-framework"
            action="<?php echo e(route('update-sparepart.quotation', $quotation->id)); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                                    ...
                                    <div class="d-flex border rounded position-relative pe-0">
                                        <div class="row w-100 p-3">
                                            <div class="col-md-6 col-12 mb-md-0 mb-3">
                                                ...
                                                <div class="form-floating form-floating-outline mb-2">
                                                    ...
                                                    <label for="product-<?php echo e($id); ?>">Product Part
                                                        Number</label>
                                                </div>
                                            ...
                                            <div class="col-md-1 col-12 mb-md-0 mb-3">
                                                ...
                                                <input type="number" class="form-control invoice-item-qty mb-3"
                                                    placeholder="Min 1" name="qty[]" id="qty-<?php echo e($dataDetail); ?>"
                                                    data-id="<?php echo e($dataDetail); ?>" min="1"
                                                    value="<?php echo e(old('qty[]', $quote->qty)); ?>">
                                                <div class="form-floating form-floating-outline mb-4">
                                                    <input type="text" class="form-control invoice-item-info" id="info-qty-<?php echo e($id); ?>"
                                                         data-id="<?php echo e($id); ?>" name="info_qty[]" readonly
                                                         value="<?php echo e(old('info_qty[]', $quote->info_qty)); ?>">
                                                     <label for="info-qty-<?php echo e($id); ?>">Satuan</label>
                                                 </div>
                                            </div>
                                            <div class="col-md-1 col-12 mb-md-0 mb-3">
                                                <p class="mb-2 repeater-title">Discount</p>
                                                <input type="number" class="form-control invoice-item-disc"
                                                    placeholder="%" name="disc[]" id="disc-<?php echo e($dataDetail); ?>"
                                                    data-id="<?php echo e($dataDetail); ?>" min="0"
                                                    value="<?php echo e(old('disc[]', $quote->disc ?? '0')); ?>">
                                            </div>
                                            <div class="col-md-1 col-12 pe-0">
                                                <p class="mb-2 repeater-title">Amount</p>
                                                <p class="mb-0 amount-label" id="amount-label-<?php echo e($id); ?>"
                                                    data-id="<?php echo e($id); ?>">
                                        ...
                                        <div
                                            ...
                                            <i class="mdi mdi-close cursor-pointer bg-danger text-white btn-del"
                                                data-id="<?php echo e($id); ?>" data-repeater-delete=""></i>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/sales/quotation/edit.blade.php ENDPATH**/ ?>