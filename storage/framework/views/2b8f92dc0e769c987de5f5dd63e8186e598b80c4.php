    ...
    <?php $__env->startSection('content'); ?>
        ...
        <form id="formAuthentication" class="mb-3 fv-plugins-bootstrap5 fv-plugins-framework"
            action="<?php echo e(@$quotation ? route('quotation.update', $quotation->id) : route('quotation.store')); ?>" method="post"
                ...
                <div class="card-body">
                    <div class="form-invoice-repeater source-item">
                        <div class="row mb-2">
                                    ...
                                    <select id="select2Basic" class="select2 form-select form-select-lg invoice-item-client"
                                        ...
                                        <?php $__currentLoopData = $pic; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $charge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($charge->id); ?>"
                                                data-role="<?php echo e($charge->role); ?>"
                            ...
                            <?php if(@$quotation): ?>
                                <input type="text" name="pic" id="destination" value="<?php echo e($quotation->id_pic); ?>"
                                    hidden>
                            <?php endif; ?>
                            <div class="col-12 col-lg-2">
                                <div class="form-floating form-floating-outline">
                            ...
                            <?php if(@$quotation): ?>
                                <input type="text" name="destination" id="destination"
                                    value="<?php echo e($quotation->destination); ?>" hidden>
                            <?php endif; ?>
                            ...
                            <div class="col-md-2 col-4">
                                <div class="form-floating form-floating-outline">
                                    <select class="form-select" id="selectWeek" aria-label="Default select example"
                                        ...
                                        <option value="1" <?php echo e(@$quote->week == '1' ? 'selected' : ''); ?>>Week 1
                                        </option>
                                        <option value="2" <?php echo e(@$quote->week == '2' ? 'selected' : ''); ?>>Week 2
                                        </option>
                                        <option value="3" <?php echo e(@$quote->week == '3' ? 'selected' : ''); ?>>Week 3
                                        </option>
                                        <option value="4" <?php echo e(@$quote->week == '4' ? 'selected' : ''); ?>>Week 4
                                        </option>
                                        <option value="5" <?php echo e(@$quote->week == '5' ? 'selected' : ''); ?>>Week 5
                                        </option>
                                    </select>
                        ...
                        <?php if(@$dquotation): ?>
                            <div class="mb-3" data-repeater-list="group-a">
                                <?php $__currentLoopData = $dquotation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        $id++;
                                        $dataDetail++;
                                    ?>
                                        ...
                                        <div class="d-flex border border-secondary-subtle rounded-3 position-relative pe-0 mb-3 shadow-xs item-row-card" style="transition: all 0.25s ease; background-color: #fdfefe;">
                                            <div class="row w-100 p-3 align-items-start">
                                                ...
                                                <div class="col-md-5 col-12 mb-md-0 mb-3">
                                                    ...
                                                    <div class="form-floating form-floating-outline mb-2">
                                                        <select id="product-<?php echo e($id); ?>"
                                                            ...
                                                            <?php if(!empty($quote->id_equivalent) && !empty($quote->equivalent)): ?>
                                                                <option value="<?php echo e($quote->id_equivalent); ?>"
                                                                    data-replacement="<?php echo e($quote->id_equivalent); ?>"
                                                                    data-commodity="<?php echo e($quote->equivalent->id_product); ?>"
                                                                    data-unit="<?php echo e($quote->equivalent->product->unit ?? 'Pcs'); ?>"
                                                                    selected>
                                                                    <?php echo e($quote->equivalent->brand); ?> <?php echo e($quote->equivalent->pn); ?>

                                                                    (<?php echo e($quote->equivalent->product->detail_desc ?? ''); ?>)
                                                                    ||
                                                                    <?php echo e($quote->equivalent->product->go ?? ''); ?>
                                                    ...
                                                    <textarea class="form-control invoice-item-detail-product" rows="2" id="detailProduct-<?php echo e($id); ?>"
                                                        placeholder="Detail Product. Example: Kaeser ASD" name="detail_product[]"><?php echo e(old('detail_product[]', $quote->detail_product)); ?></textarea>
                                                </div>
                                                ...
                                                <div class="col-md-3 col-12 mb-md-0 mb-3">
                                                    ...
                                                    <div class="input-group" data-price="1">
                                                        ...
                                                        <input type="text" class="form-control invoice-item-price-label"
                                                            id="priceLabel-<?php echo e($id); ?>"
                                                            data-id="<?php echo e($id); ?>" min="0"
                                                            placeholder="Put Price Here" data-type="currency"
                                                            pattern="^[0-9]\d{0,2}(\.\d{3})*$"
                                                            value="<?php echo e(old('price[]', @$quote->price ? number_format(@$quote->price, 0, '', '.') : '')); ?>">
                                                        <input class="form-control invoice-item-price" type="number"
                                                            name="price[]" id="price-<?php echo e($id); ?>"
                                                            value="<?php echo e(old('price[]', @$quote->price ?? '')); ?>" hidden>
                                                    </div>
                                                    <div class="d-flex justify-content-between mt-2 flex-wrap gap-1">
                                                        <span class="badge bg-label-info d-flex align-items-center py-1.5 px-2.5 rounded-pill">
                                                            ...
                                                            Stock: <strong class="info-stock-label ms-1" id="info-stock-<?php echo e($id); ?>">-</strong>
                                                        </span>
                                                        <span class="badge bg-label-warning d-flex align-items-center py-1.5 px-2.5 rounded-pill">
                                                            <i class="mdi mdi-scale me-1 fs-6"></i>
                                                            Weight: <strong class="info-weight-label mx-1" id="info-weight-<?php echo e($id); ?>">-</strong> g
                                                        </span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-2 col-12 mb-md-0 mb-3">
                                                    ...
                                                    <div class="input-group input-group-merge">
                                                        <input type="number" class="form-control invoice-item-qty"
                                                            placeholder="Qty" name="qty[]" id="qty-<?php echo e($dataDetail); ?>"
                                                            data-id="<?php echo e($dataDetail); ?>" min="1"
                                                            value="<?php echo e(old('qty[]', $quote->qty)); ?>">
                                                        <input type="text" class="input-group-text px-2 bg-light text-secondary invoice-item-info text-center"
                                                            id="info-qty-<?php echo e($dataDetail); ?>" data-id="<?php echo e($dataDetail); ?>" name="info_qty[]" readonly
                                                            value="<?php echo e(old('info_qty[]', $quote->info_qty ?? 'Pcs')); ?>" style="max-width: 65px; border-left: 0; font-size: 0.85rem; font-weight: 600;">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-1 col-12 mb-md-0 mb-3">
                                                    ...
                                                    <div class="input-group input-group-merge">
                                                        <input type="number" class="form-control invoice-item-disc text-center"
                                                            placeholder="0" name="disc[]" id="disc-<?php echo e($dataDetail); ?>"
                                                            data-id="<?php echo e($dataDetail); ?>" min="0"
                                                            value="<?php echo e(old('disc[]', $quote->disc ?? '0')); ?>" style="padding-left: 5px; padding-right: 5px;">
                                                ...
                                                <div class="col-md-1 col-12 text-md-end pe-0 mb-md-0 mb-3">
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-md-end h-px-40 mt-1">
                                                        <span class="fw-bold text-primary amount-label" id="amount-label-<?php echo e($id); ?>" data-id="<?php echo e($id); ?>" style="font-size: 1rem;">
                                                            <?php echo e(old('amount[]', 'Rp ' . number_format($quote->amount, 0, '', '.'))); ?>

                                                        </span>
                                                    </div>
                                                    <input type="number" class="form-control invoice-item-amount"
                                                        name="amount[]" id="amount-<?php echo e($id); ?>" data-id="1"
                                                        value="<?php echo e(old('amount[]', $quote->amount)); ?>" hidden>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex align-items-center justify-content-center border-start px-2 bg-light" style="background-color: rgba(255, 76, 81, 0.03) !important;">
                                                <button type="button" class="btn btn-icon btn-outline-danger btn-sm border-0 rounded-circle waves-effect btn-del"
                                                    data-id="<?php echo e($id); ?>" data-repeater-delete="" style="transition: all 0.2s ease;">
                                        ...
                                        <div class="row w-100 p-3 align-items-start">
                                            ...
                                            <div class="col-md-3 col-12 mb-md-0 mb-3">
                                                ...
                                                <div class="input-group" data-price="1">
                                                    ...
                                                    <input class="form-control invoice-item-price" type="number"
                                                        name="price[]" id="price-1" value="<?php echo e(old('price[]')); ?>"
                                                        hidden>
                                                </div>
                                                <div class="d-flex justify-content-between mt-2 flex-wrap gap-1">
                                                    <span class="badge bg-label-info d-flex align-items-center py-1.5 px-2.5 rounded-pill">
                                            ...
                                            <div class="col-md-2 col-12 mb-md-0 mb-3">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input type="text" class="input-group-text px-2 bg-light text-secondary invoice-item-info text-center"
                                                        ...
                                                        value="<?php echo e(old('info_qty[]', 'Pcs')); ?>" style="max-width: 65px; border-left: 0; font-size: 0.85rem; font-weight: 600;">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-1 col-12 mb-md-0 mb-3">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    <input type="number" class="form-control invoice-item-disc text-center"
                                                        ...
                                                        min="0" value="<?php echo e(old('disc[]', '0')); ?>" style="padding-left: 5px; padding-right: 5px;">
                                                    <span class="input-group-text px-1 bg-light text-secondary font-semibold" style="font-size: 0.85rem;">%</span>
                                                </div>
                                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <input type="number" name="weight" class="info-weight-total-label" value="<?php echo e(old('weight', @$quotation->weight ?? '0')); ?>" hidden>
                        ...
                        <?php else: ?>
                                                    <span class="fs-5 fw-bold text-dark subtotal-label" id="subtotal-label">
                                                        <?php echo e(old('subtotal', @$quotation->subtotal ? 'Rp ' . number_format(@$quotation->subtotal, 0, '', '.') : 'Rp 0')); ?>
                                                    </span>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between p-3 border-bottom">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <div class="form-check form-switch mb-0">
                                                    <input class="form-check-input" type="checkbox" id="tax-toggle" <?php echo e(@$quotation->tax == '11' ? 'checked' : ''); ?>>
                                                    <input type="number" name="tax" id="tax" value="<?php echo e(old('tax', @$quotation->tax ?? '0')); ?>" hidden>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <?php else: ?>
                                                    <span class="fs-4 fw-bold text-primary harga-total-label" id="hargaTotalLabel">
                                                        <?php echo e(old('harga_total', @$quotation->harga_total ? 'Rp ' . number_format(@$quotation->harga_total, 0, '', '.') : 'Rp 0')); ?>
                                                    </span>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/sales/quotation/form.blade.php ENDPATH**/ ?>