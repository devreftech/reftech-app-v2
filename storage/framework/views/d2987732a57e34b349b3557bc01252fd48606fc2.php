...
<?php $__env->startSection('title', 'Edit Unit Quotation'); ?>
<?php $__env->startSection('content'); ?>
    
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center py-3 mb-3 gap-3">
        <div>
            <h4 class="fw-bold mb-1">
                <span class="text-muted fw-light">Sales / <a href="<?php echo e(route('unit-quotation.show', $quote->id)); ?>" class="text-muted">Unit Quotation</a> /</span> Edit
            </h4>
            <p class="text-muted mb-0 small"><i class="mdi mdi-file-document-edit-outline me-1"></i> Edit quotation document <?php echo e($quote->no_quote); ?></p>
        </div>
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('unit-quotation.show', $quote->id)); ?>" class="btn btn-label-secondary">
    ...
    <form action="<?php echo e(route('unit-quotation.update', $quote->id)); ?>" method="POST" id="form-unit-quotation">
        <?php echo csrf_field(); ?>
                ...
                <div class="row align-items-center g-3">
                    <div class="col-md-8 col-12">
                        ...
                        <input type="text" class="form-control form-control-lg fw-bold bg-white text-primary border-primary-subtle shadow-sm"
                            name="no_quote" placeholder="Quotation Number" value="<?php echo e(old('no_quote', $quote->no_quote)); ?>" style="font-size: 1.35rem;">
                    </div>
            ...
            <div class="card-body pt-4">
                <div class="row g-3">
                            ...
                            <select class="select2 form-select" name="id_client" id="client-select">
                                ...
                                <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($c->id); ?>"
                                        data-role="<?php echo e($c->role); ?>"
                                        <?php echo e($quote->id_client == $c->id ? 'selected' : ''); ?>>
                    ...
                    <div class="col-md-4">
                        <div class="form-floating form-floating-outline">
                            <select class="form-select" name="id_pic" id="pic-select">
                                ...
                                <?php if($quote->pic): ?>
                                    <option value="<?php echo e($quote->pic->id); ?>" selected>
                                        <?php echo e($quote->pic->name_pic); ?><?php echo e($quote->pic->position ? ' (' . $quote->pic->position . ')' : ''); ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="hidden" name="id_plant" id="input-id-plant" value="<?php echo e($quote->id_plant); ?>">
                        <input type="hidden" name="address" id="input-address-hidden" value="<?php echo e($quote->address); ?>">
                    </div>
                    <div class="col-md-12" id="manual-address-wrapper" style="display: none;">
                        <div class="form-floating form-floating-outline">
                            <textarea class="form-control" id="input-address-manual" rows="2" style="height: 60px;" placeholder="Enter custom address..."><?php echo e($quote->address); ?></textarea>
                    ...
                    <div class="col-md-2">
                        <div class="form-floating form-floating-outline">
                            <input type="date" class="form-control" id="input-date" name="date"
                                value="<?php echo e(old('date', $quote->date?->format('Y-m-d'))); ?>">
                            <label>Date</label>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-floating form-floating-outline">
                            <input type="date" class="form-control bg-light-subtle" id="input-expired-date" name="expired_date"
                                value="<?php echo e(old('expired_date', $quote->expired_date ? \Carbon\Carbon::parse($quote->expired_date)->format('Y-m-d') : \Carbon\Carbon::parse($quote->date)->addMonth()->format('Y-m-d'))); ?>"
                    ...
                    <div class="col-md-2">
                        <div class="form-floating form-floating-outline">
                            <input type="text" class="form-control" name="no_pr" placeholder="No PR (optional)"
                                value="<?php echo e(old('no_pr', $quote->no_pr)); ?>">
                    ...
                    <div class="col-md-4">
                        <div class="form-floating form-floating-outline">
                            <input type="text" class="form-control" name="title" placeholder="Title"
                                value="<?php echo e(old('title', $quote->title)); ?>">
                    ...
                    <div class="col-md-2">
                        <div class="form-floating form-floating-outline">
                            <select class="form-select" id="select-type" name="type">
                                ...
                                <?php $__currentLoopData = ['Unit', 'Rental', 'Project', 'Parts', 'Service', 'Piping', 'Air Audit']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($t); ?>" <?php echo e($quote->type === $t ? 'selected' : ''); ?>><?php echo e($t); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <label>Type</label>
                        </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-floating form-floating-outline">
                            <select class="form-select" id="select-week" name="week">
                                ...
                                <?php $__currentLoopData = [1,2,3,4,5]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($w); ?>" <?php echo e($quote->week == $w ? 'selected' : ''); ?>>Week <?php echo e($w); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <label>Week</label>
                        </div>
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="mb-4 pb-3 border-bottom">
                            ...
                            <textarea class="form-control" name="note" id="note"
                                ...
                                style="overflow-y: hidden; resize: none;"><?php echo e(old('note', $quote->note)); ?></textarea>
                        ...
                        <div>
                            ...
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="validity" class="form-control form-control-sm" name="validity"
                                        value="<?php echo e(old('validity', $quote->validity)); ?>">
                                </div>
                            </div>
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="pricing" class="form-control form-control-sm" name="pricing"
                                        value="<?php echo e(old('pricing', $quote->pricing)); ?>">
                                </div>
                            </div>
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input type="hidden" name="payment" id="input-payment-hidden" value="<?php echo e(old('payment', $quote->payment)); ?>">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 align-items-center" id="warranty-wrapper" style="<?php echo e(empty(old('warranty', $quote->warranty)) ? 'display: none;' : ''); ?>">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="warranty" class="form-control form-control-sm" name="warranty"
                                        value="<?php echo e(old('warranty', $quote->warranty)); ?>">
                                </div>
                            </div>
                            <div class="row mb-3 align-items-center">
                                <label class="col-sm-4 col-form-label text-muted small fw-semibold" for="delivery">Delivery Process</label>
                                <div class="col-sm-8">
                                    <textarea id="delivery" class="form-control form-control-sm" name="delivery_process" rows="1" style="resize: vertical;"><?php echo e(old('delivery_process', $quote->delivery_process)); ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div style="width: 160px;">
                                        <div class="input-group input-group-sm">
                                            <select class="form-select flex-grow-0" id="select-diskon-type" name="diskon_type" style="max-width:65px; font-size:11px;">
                                                <option value="percent" <?php echo e($quote->diskon_type === 'percent' ? 'selected' : ''); ?>>%</option>
                                                <option value="amount" <?php echo e($quote->diskon_type === 'amount' ? 'selected' : ''); ?>>Rp</option>
                                            </select>
                                            <input type="text" class="form-control text-end fw-semibold" name="diskon" id="input-diskon" value="<?php echo e(old('diskon', $quote->diskon)); ?>" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-3 pb-3 border-bottom">
                                    ...
                                    <div style="width: 160px;">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control text-end fw-semibold rupiah-input" name="shipping" id="input-shipping" value="<?php echo e(old('shipping', $quote->shipping > 0 ? number_format($quote->shipping, 0, '', '.') : '0')); ?>" placeholder="0" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="d-flex justify-content-end gap-2 mb-4">
            <a href="<?php echo e(route('unit-quotation.show', $quote->id)); ?>" class="btn btn-label-secondary">Cancel</a>
...
<?php $__env->startPush('page-script'); ?>
    <script>
        window.EDIT_ITEMS = <?php echo json_encode($editItems, 15, 512) ?>;
        window.EDIT_CLIENT_ID = <?php echo e($quote->id_client ?? 'null'); ?>;
        window.EDIT_PIC_ID = <?php echo e($quote->id_pic ?? 'null'); ?>;
        window.EDIT_PLANT_ID = <?php echo e($quote->id_plant ?? 'null'); ?>;
        window.EDIT_ADDRESS = <?php echo json_encode($quote->address ?? '', 15, 512) ?>;
        window.EDIT_PAYMENT = <?php echo json_encode($quote->payment ?? '', 15, 512) ?>;
    </script>
    <script src="<?php echo e(asset('assets')); ?>/includes/form-unit-quotation.js"></script>
    <script>
        (function () {
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/unit-quotation/edit.blade.php ENDPATH**/ ?>