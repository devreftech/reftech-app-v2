<form action="<?php echo e(@$delivery ? route('update.salon', @$delivery->id) : route('store.salon')); ?>" method="post"
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-8 mb-3">
                                    <input class="form-control form-control-lg" type="text" placeholder="Target"
                                        ...
                                        maxlength="4"
                                        value="<?php echo e(@$delivery->airend ? str_replace('.', ',', $delivery->airend) : '0'); ?>">
                                </div>
                                <?php if($salesID == 16): ?>
                                    <div class="col-4 mb-3">
                                    ...
                                    <div class="col-8 mb-3">
                                        <input class="form-control form-control-lg" type="text" placeholder="Target"
                                            ...
                                            value="<?php echo e(@$delivery->kojisha ? str_replace('.', ',', $delivery->kojisha) : '0'); ?>">
                                    </div>
                                    <div class="col-12 mb-3">
                                        <div class="card text-center bg-label-secondary">
                                            <div class="card-body">
                                                <input type="text" name="average" id="averageDelivery"
                                                    value="<?php echo e(@$delivery->average ? str_replace('.', ',', $delivery->average) : '0'); ?>"
                                                    hidden>
                                                <h5>Average</h5>
                                                <p id="averageDeliveryText">
                                                    <?php echo e(@$delivery->average ? str_replace('.', ',', $delivery->average) : '0'); ?>
...
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/onlineSales/delivery.blade.php ENDPATH**/ ?>