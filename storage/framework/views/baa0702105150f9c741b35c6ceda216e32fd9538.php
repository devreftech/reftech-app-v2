...
<?php $__env->startSection('title', $quote->no_quote); ?>
<?php
    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        <?php if($quote->pic->client->info == 'Reftech'): ?>
            <div class="d-flex justify-content-between flex-xl-row flex-md-column flex-sm-row flex-column">
                <div class="mb-xl-0 pb-1">
                    ...
                    <div style="font-size: 13px">
                        ...
                        <p class="mb-1">
                            ...
                            <?php echo e('   '); ?><i class="mdi mdi-email-outline scaleX-n1-rtl me-1 mdi-12px"></i>info@reftech.id
                ...
                <div class="text-end">
                    ...
                    <div class="mt-1">
                        <span class=" fw-medium fs-6 badge bg-info text-black"><?php echo e($quote->title); ?></span>
                    </div>
                </div>
            </div>
        <?php else: ?>
                            ...
                            <tr style="font-size: 10px; border-bottom:none !important; border-top:none !important;">
                                <td class="align-top py-1" style="border-bottom:none !important;">
                                    <?php
                                        $no++;
                                    ?>
                                    <p class="fw-bold mb-0"><?php echo e($no); ?></p>
                                </td>
                                <td class="text-wrap align-top py-1" style="border-bottom:none !important;">
                                    <p class="fw-bold mb-0" ><?php echo e($product->product); ?></p>
                                    <?php if($product->detail != '-'): ?>
                                        <pre class="fw-bold mb-0"
                                            style="font-size: 11px; font-family: Inter, sans-serif; max-width: 100%; overflow-x: auto; white-space: pre-wrap;"><?php echo e($product->detail); ?></pre>
                                    <?php endif; ?>
                                </td>
                                <td class="align-top py-1" style="border-bottom:none !important;">
                                ...
                                <td class="align-top py-1 text-end" style="border-bottom:none !important;">
                                    <p class="mb-0">
                                        <?php echo e($product->amount == 0 ? 'FOC' : number_format($product->price, 0, '', '.')); ?>

                                    </p>
                                </td>
                                <td class="align-top py-1 text-center" style="border-bottom:none !important;">
                                    <p class="mb-0"><?php echo e($product->amount == 0 ? '-' : $product->disc . ' %'); ?></p>
                                </td>
                                <td class="align-top py-1 text-end" style="border-bottom:none !important;">
                                    <p class="mb-0">
                                        <?php echo e($product->amount == 0 ? 'FOC' : number_format($product->amount, 0, '', '.')); ?>
        ...
        <div class="d-flex justify-content-between align-items-start mt-3 mb-4" style="gap:16px;">
            <div style="flex:1; font-size:12px;">
                <?php if($quote->termncon[0]->note): ?>
                    <p class="mb-1 fw-semibold" style="font-size:11px; color:#888; text-transform:uppercase; letter-spacing:.4px;">Note</p>
                    <p class="mb-0" style="white-space:pre-wrap; color:#333;"><?php echo e($quote->termncon[0]->note); ?></p>
                <?php endif; ?>
            </div>
            <div style="min-width:240px; font-size:12px;">
                <table style="width:100%; border-collapse:collapse;">
                    <tr>
                        ...
                        <td style="padding:3px 0; text-align:right; font-weight:500;">Rp <?php echo e(number_format($quote->subtotal, 0, '', '.')); ?></td>
                    </tr>
                    <?php if($quote->diskon != 0): ?>
                        <tr>
                            <td style="padding:3px 8px 3px 0; color:#555;">Discount</td>
                            <td style="padding:3px 0; text-align:right; font-weight:500;">- Rp <?php echo e(number_format($quote->diskon, 0, '', '.')); ?></td>
                        </tr>
                        <tr>
                            <td style="padding:3px 8px 3px 0; color:#555;">After Discount</td>
                            <td style="padding:3px 0; text-align:right; font-weight:500;">Rp <?php echo e(number_format($afterDisc, 0, '', '.')); ?></td>
                        </tr>
                    <?php endif; ?>
                    <?php if($quote->tax != 0): ?>
                        <tr>
                            <td style="padding:3px 8px 3px 0; color:#555;">Tax</td>
                            <td style="padding:3px 0; text-align:right; font-weight:500;">Rp <?php echo e(number_format($tax, 0, '', '.')); ?></td>
                        </tr>
                    <?php endif; ?>
                    <?php if($quote->shipping != 0): ?>
                        <tr>
                            <td style="padding:3px 8px 3px 0; color:#555;">Shipping Cost</td>
                            <td style="padding:3px 0; text-align:right; font-weight:500;">Rp <?php echo e(number_format($quote->shipping, 0, '', '.')); ?></td>
                        </tr>
                    <?php endif; ?>
                    <tr>
                    ...
                    <tr style="background:#FFF9C4;">
                        ...
                        <td style="padding:6px 6px 6px 0; text-align:right; font-weight:700; font-size:13px; color:#333;">Rp <?php echo e(number_format($quote->harga_total, 0, '', '.')); ?></td>
                    </tr>
                </table>
            </div>
        </div>
        <div class="termncon">
            <div class="mb-4" style="font-size:12px;">
                ...
                <table style="width:100%; border-collapse:collapse;">
                    <tr>
                        ...
                        <td style="padding:2px 0; vertical-align:top;">: <?php echo e($quote->termncon[0]->validity); ?></td>
                    </tr>
                    <tr>
                        <td style="padding:2px 0; color:#555; vertical-align:top;">Price</td>
                        <td style="padding:2px 0; vertical-align:top;">: <?php echo e($quote->termncon[0]->pricing); ?></td>
                    </tr>
                    <tr>
                        <td style="padding:2px 0; color:#555; vertical-align:top;">Delivery Process</td>
                        <td style="padding:2px 0; vertical-align:top;">: <?php echo e($quote->termncon[0]->delivery_process); ?></td>
                    </tr>
                    <tr>
                        <td style="padding:2px 0; color:#555; vertical-align:top;">Payment</td>
                        <td style="padding:2px 0; vertical-align:top;">: <?php echo e($quote->termncon[0]->payment); ?></td>
                    </tr>
                    <tr>
                        <td style="padding:2px 0; color:#555; vertical-align:top;">Warranty</td>
                        <td style="padding:2px 0; vertical-align:top;">: <?php echo e($quote->termncon[0]->warranty); ?></td>
                    </tr>
                </table>
            </div>
            <hr class="my-3">
            <div class="d-flex justify-content-between align-items-center" style="font-size:12px; color:#555;">
                <div>
                    ...
                    <p class="mb-0 fw-semibold" style="color:#333;"><?php echo e($quote->sales->name); ?></p>
                    <?php if($quote->sales->phone): ?>
                        <p class="mb-0"><?php echo e($quote->sales->phone); ?></p>
                    <?php endif; ?>
                </div>
                <div class="text-end" style="font-size:11px; color:#aaa;">
                    <p class="mb-0"><?php echo e($quote->pic->client->info == 'Reftech' ? 'PT Reftech Jaya Optima' : 'PT Kojisha Innotiv Indonesia'); ?></p>
                    <p class="mb-0"><?php echo e(Carbon\Carbon::parse($quote->estimated_date)->format('d F Y')); ?></p>
                </div>
            </div>
        </div>
        <div class="facilities">
            ...
            <img src="<?php echo e(asset('asset')); ?>/facilities/1.jpg" alt="heater" class="m-0 d-block w-100 h-100"
                id="uploadedAvatar">
            <img src="<?php echo e(asset('asset')); ?>/facilities/2.jpg" alt="heater" class="m-0 d-block w-100 h-100"
                id="uploadedAvatar">
            <img src="<?php echo e(asset('asset')); ?>/facilities/3.jpg" alt="heater" class="m-0 d-block w-100 h-100"
                id="uploadedAvatar">
            <img src="<?php echo e(asset('asset')); ?>/facilities/4.jpg" alt="heater" class="m-0 d-block w-100 h-100"
                id="uploadedAvatar">
            <img src="<?php echo e(asset('asset')); ?>/facilities/5.jpg" alt="heater" class="m-0 d-block w-100 h-100"
                id="uploadedAvatar">
            <img src="<?php echo e(asset('asset')); ?>/facilities/6.jpg" alt="heater" class="m-0 d-block w-100 h-100"
                id="uploadedAvatar">
            <img src="<?php echo e(asset('asset')); ?>/facilities/7.jpg" alt="heater" class="m-0 d-block w-100 h-100"
                id="uploadedAvatar">
            <img src="<?php echo e(asset('asset')); ?>/facilities/8.jpg" alt="heater" class="m-0 d-block w-100 h-100"
                id="uploadedAvatar">
        </div>
...
<?php $__env->startPush('after-style'); ?>
    <!-- Page CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('assets')); ?>/vendor/css/pages/app-service-print.css" />
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/sales/quotation/service/detail-print.blade.php ENDPATH**/ ?>