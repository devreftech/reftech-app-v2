    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('store.daily-mainlog', $monitoring->id ?? '0')); ?>" method="post"
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group input-group-merge">
                                <input id="defaultInput" class="form-control" name="technici" type="text"
                                    placeholder="Vendor" value="<?php echo e(Auth::user()->name); ?>" disabled>
                                <input id="defaultInput" class="form-control" name="technician" type="text"
                                    placeholder="Vendor" value="<?php echo e(Auth::user()->name); ?>" hidden>
                            </div>
                        </div>
                    </div>
                    <div class="float-end">
...
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/monitoring/mainlog-create.blade.php ENDPATH**/ ?>