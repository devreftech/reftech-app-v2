<form action="<?php echo e(route('invoice.form_ekspedisi', $invoice->id)); ?>" method="post" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
                                ...
                                <div class="col-12  mb-3">
                                    <div class="form-floating form-floating-outline">
                                        <input class="form-control" type="date" id="html5-date-input" name="date"
                                            value="<?php echo e(@$invoice->dateDo); ?>">
...
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/accounting/delivery/form-ekspedisi.blade.php ENDPATH**/ ?>