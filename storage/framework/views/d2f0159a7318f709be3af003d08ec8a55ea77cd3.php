...
<?php $__env->startSection('title', 'My Setting'); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="nav nav-pills flex-column flex-sm-row mb-4">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('audit-tools.index')); ?>"><i class="mdi mdi-tools me-1 mdi-20px"></i>Tools</a>
                </li>
            </ul>
            <div class="card mb-4">
                <form action="<?php echo e(route('profile.store')); ?>" id="" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input class="form-control" type="text" id="name" name="name"
                                        value="<?php echo e(old('name')); ?>" placeholder="john doe" />
                            ...
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input class="form-control" type="text" id="email" name="email"
                                        value="<?php echo e(old('email')); ?>" placeholder="john.doe@example.com" />
                            ...
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input class="form-control" type="text" id="code" name="code"
                                        value="<?php echo e(old('code')); ?>" placeholder="contoh: RZA" />
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/sales/user/create-acc.blade.php ENDPATH**/ ?>