        ...
        <div class="mb-4">
            ...
            <div class="row">
                ...
                <div class="col-4 text-end">
                    <p class="mb-1">
                        <?php echo e($quote->pic->client->info == 'Reftech' ? 'PT Reftech Jaya Optima' : 'PT Kojisha Innotiv Indonesia'); ?></p>
                    ...
                    <?php $__currentLoopData = $dquote; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr style="font-size: 13px">
                            ...
                            <td class="text-nowrap align-top">
                                ...
                                <pre class="mb-0"
                                    style="font-size: 10px; font-family: Inter ; max-width: 100%; overflow-x: auto; white-space: pre-wrap;"><?php echo e($product->detail_product); ?></pre>
                            </td>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/sales/quotation/detail-print.blade.php ENDPATH**/ ?>