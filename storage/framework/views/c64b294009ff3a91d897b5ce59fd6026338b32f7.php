...
<?php $__env->startSection('title', 'Detail Unit — ' . $product->sku); ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
        <div class="d-flex align-items-center gap-3">
            <a href="<?php echo e(route('unit-global.index')); ?>" class="btn btn-icon btn-outline-secondary btn-sm rounded-circle" data-bs-toggle="tooltip" title="Kembali ke Daftar Unit">
                <i class="mdi mdi-arrow-left fs-4"></i>
            </a>
            <div>
                <div class="d-flex align-items-center gap-2 mb-1">
                    <span class="badge bg-label-primary px-2.5 py-1 rounded-pill small fw-semibold"><?php echo e($product->unit); ?></span>
                    <?php if($product->status): ?>
                        <span class="badge bg-label-success px-2.5 py-1 rounded-pill small fw-semibold"><?php echo e($product->status); ?></span>
                    <?php endif; ?>
                </div>
                <h4 class="fw-bold mb-0 text-dark"><?php echo e($product->sku); ?></h4>
            </div>
        </div>
        <?php if($isPriv): ?>
            <div class="d-flex gap-2">
                <button type="button" class="btn btn-primary shadow-sm" data-bs-toggle="modal" data-bs-target="#updateProduct-<?php echo e($product->id); ?>">
                    <i class="mdi mdi-pencil-outline me-1"></i> Edit Unit
                </button>
                <button type="button" data-id="<?php echo e($product->id); ?>" class="btn btn-label-danger delete-product">
                ...
                <div class="col-6 col-md-3 border-end-md">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <h6 class="mb-0 fw-bold text-dark"><?php echo e($product->brand ?: '-'); ?> <?php echo e($product->model ? '/ ' . $product->model : ''); ?></h6>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-md-3 border-end-md">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <h6 class="mb-0 fw-bold text-dark"><?php echo e($product->power ?: '-'); ?></h6>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-md-3 border-end-md">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <h6 class="mb-0 fw-bold text-dark"><?php echo e($product->air_cap ? $product->air_cap . ' m³/min' : '-'); ?></h6>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <h6 class="mb-0 fw-bold text-dark"><?php echo e($allStock); ?> <span class="small text-muted fw-normal">(Awal: <?php echo e($product->frist_stock ?: 0); ?>)</span></h6>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card spec-card">
                                ...
                                <div class="card-body p-3">
                                    <div class="row spec-item align-items-center">
                                        ...
                                        <div class="col-7 spec-val"><?php echo e($product->unit ?: '-'); ?></div>
                                    </div>
                                    <div class="row spec-item align-items-center">
                                        <div class="col-5 spec-label">SKU</div>
                                        <div class="col-7 spec-val"><code class="text-primary fw-bold"><?php echo e($product->sku ?: '-'); ?></code></div>
                                    </div>
                                    <div class="row spec-item align-items-center">
                                        <div class="col-5 spec-label">Brand</div>
                                        <div class="col-7 spec-val"><?php echo e($product->brand ?: '-'); ?></div>
                                    </div>
                                    <div class="row spec-item align-items-center">
                                        <div class="col-5 spec-label">Model</div>
                                        <div class="col-7 spec-val"><?php echo e($product->model ?: '-'); ?></div>
                                    </div>
                                    <div class="row spec-item align-items-center">
                                        <div class="col-5 spec-label">Status Unit</div>
                                        <div class="col-7 spec-val">
                                            <?php if($product->status): ?>
                                                <span class="badge bg-label-info"><?php echo e($product->status); ?></span>
                                            <?php else: ?>
                                                -
                                            <?php endif; ?>
                                        </div>
                                    ...
                                    <div class="row spec-item align-items-center">
                                        ...
                                        <div class="col-7 spec-val"><?php echo e($product->frist_stock !== null ? $product->frist_stock : '-'); ?></div>
                                    </div>
                                    <?php if($product->desc && !$isCompressor && !$isDryer): ?>
                                        <div class="row spec-item align-items-center">
                                            <div class="col-5 spec-label">Deskripsi</div>
                                            <div class="col-7 spec-val"><?php echo e($product->desc); ?></div>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                                ...
                                <div class="card-body p-3">
                                    <?php if($isCompressor): ?>
                                        <div class="row spec-item align-items-center">
                                            ...
                                            <div class="col-7 spec-val"><?php echo e($product->type_unit ?: '-'); ?></div>
                                        </div>
                                        <div class="row spec-item align-items-center">
                                        ...
                                        <div class="row spec-item align-items-center">
                                            ...
                                            <div class="col-7 spec-val"><?php echo e($product->bar ? $product->bar . ' Bar' : '-'); ?></div>
                                        </div>
                                        <div class="row spec-item align-items-center">
                                            <div class="col-5 spec-label">Air Capacity</div>
                                            <div class="col-7 spec-val"><?php echo e($product->air_cap ? $product->air_cap . ' m³/min' : '-'); ?></div>
                                        </div>
                                        <div class="row spec-item align-items-center">
                                            <div class="col-5 spec-label">Motor Power</div>
                                            <div class="col-7 spec-val"><span class="badge bg-label-primary"><?php echo e($product->power ?: '-'); ?></span></div>
                                        </div>
                                        <div class="row spec-item align-items-center">
                                            <div class="col-5 spec-label">Rated Voltage</div>
                                            <div class="col-7 spec-val"><?php echo e($product->voltage ?: '-'); ?></div>
                                        </div>
                                        <div class="row spec-item align-items-center">
                                            <div class="col-5 spec-label">Drive</div>
                                            <div class="col-7 spec-val"><?php echo e($product->connect ?: '-'); ?></div>
                                        </div>
                                        <div class="row spec-item align-items-center">
                                            <div class="col-5 spec-label">Cooling Method</div>
                                            <div class="col-7 spec-val"><?php echo e($product->cooling ?: '-'); ?></div>
                                        </div>
                                        <div class="row spec-item align-items-center">
                                            <div class="col-5 spec-label">Discharge Connection</div>
                                            <div class="col-7 spec-val"><?php echo e($product->exhaust ?: '-'); ?></div>
                                        </div>
                                    <?php elseif($isDryer): ?>
                                        <div class="row spec-item align-items-center">
                                        ...
                                        <div class="row spec-item align-items-center">
                                            ...
                                            <div class="col-7 spec-val"><?php echo e($product->refrigerant_type ?: '-'); ?></div>
                                        </div>
                                        <div class="row spec-item align-items-center">
                                            <div class="col-5 spec-label">PDP</div>
                                            <div class="col-7 spec-val"><?php echo e($product->pdp ?: '-'); ?></div>
                                        </div>
                                        <div class="row spec-item align-items-center">
                                            <div class="col-5 spec-label">Rated Voltage</div>
                                            <div class="col-7 spec-val"><?php echo e($product->voltage ?: '-'); ?></div>
                                    ...
                                    <div class="row spec-item align-items-center">
                                        ...
                                        <div class="col-7 spec-val"><?php echo e($product->dimension ?: '-'); ?></div>
                                    </div>
                                    <div class="row spec-item align-items-center">
                                        <div class="col-5 spec-label">Weight</div>
                                        <div class="col-7 spec-val"><?php echo e($product->weight ? $product->weight . ' Kg' : '-'); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="card spec-card bg-light border-0">
                                    <div class="card-body p-3.5">
                                        ...
                                        <div class="p-3 bg-white rounded border text-secondary" style="font-family: inherit; white-space: pre-wrap;"><?php echo e($product->note); ?></div>
                                    </div>
                                </div>
                            </div>
                        <?php endif; ?>
                ...
                <?php if($isPriv): ?>
                    ...
                    <div class="tab-pane fade" id="tab-unit-pm-template" role="tabpanel">
                        <div id="pm-template-card"
                            data-endpoint="<?php echo e(route('unit-global.pm-template', $product->id)); ?>"
                            data-save-endpoint="<?php echo e(route('unit-global.pm-template.save', $product->id)); ?>">
                            ...
                            <div class="alert alert-info border-0 shadow-xs d-flex align-items-center mb-4 rounded-3">
                                ...
                                <div class="small">
                                    ...
                                    permanen per unit + level, dan jadi sumber data <a href="<?php echo e(route('forecast.index')); ?>" target="_blank" class="fw-bold text-decoration-underline">Forecast Sales</a> juga.
                                    Biaya jasa tetap otomatis dari <a href="<?php echo e(route('forecast.prices')); ?>" target="_blank" class="fw-bold text-decoration-underline">pricelist Forecast</a> berdasarkan Motor Power unit ini.
                                    ...
                                    <div class="card spec-card mb-3">
                                        <div class="card-body p-3">
                                            ...
                                            <dl class="row mb-0 small">
                                                ...
                                                <dd class="col-7 text-end mb-2 fw-semibold text-dark"><?php echo e($product->sku); ?></dd>
                                                <dt class="col-5 text-muted fw-normal">Brand</dt>
                                                <dd class="col-7 text-end mb-2 text-dark"><?php echo e($product->brand ?: '-'); ?></dd>
                                                <dt class="col-5 text-muted fw-normal">Model</dt>
                                                <dd class="col-7 text-end mb-2 text-dark"><?php echo e($product->model ?: '-'); ?></dd>
                                                <dt class="col-5 text-muted fw-normal">Power</dt>
                                                <dd class="col-7 text-end mb-0 fw-bold text-primary"><?php echo e($product->power ?: '-'); ?></dd>
                                            </dl>
                                        </div>
                                    </div>
                                    <div class="card spec-card">
                                        ...
                                        <div class="card spec-card">
                                            <div class="card-body p-3">
                                                ...
                                                <div id="pm-template-power-warning" class="alert alert-warning py-2 px-3 small mt-2 mb-0 rounded" style="display:none;">
                                                    Tarif jasa untuk power unit ini belum ada di pricelist Forecast. Isi dulu di halaman <a href="<?php echo e(route('forecast.prices')); ?>" target="_blank" class="fw-bold text-decoration-underline">Master Harga Jasa PM</a>.
                                                </div>
                    ...
                    <div class="tab-pane fade" id="tab-unit-equivalent" role="tabpanel">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <button type="button" class="btn btn-primary btn-sm shadow-sm" data-bs-toggle="modal" data-bs-target="#createEquivalent-<?php echo e($product->id); ?>">
    ...
    <?php echo $__env->make('components.modal.warehouse.unit.form-global', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php echo $__env->make('components.modal.warehouse.equivalent.form-global', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php
        $no = 0;
    ?>
...
<?php $__env->startPush('page-script'); ?>
    ...
    <script src="<?php echo e(asset('assets')); ?>/includes/table-equivalent-global.js"></script>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/warehouse/unit/detail-global.blade.php ENDPATH**/ ?>