<form action="<?php echo e(route('purchase-request.store', $pending->id)); ?>" method="post" enctype="multipart/form-data">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-start">
                                                        <pre class="mb-0"
                                                            ...
                                                            title="<?php echo e($title); ?>"><?php echo e($item->equivalent->product->go == "Genuine" ? 'G' : 'R'); ?> - <?php echo e($item->equivalent->brand); ?> <?php echo e($item->equivalent->pn); ?></pre>
                                                    </td>
                                                    <td>
                                                        <div class="form-floating form-floating-outline">
                                                            <input type="number" class="form-control"
                                                                ...
                                                                placeholder="Stock..."
                                                                value="<?php echo e(@$item->bdg); ?>" min="0"></input>
...
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/pending/request.blade.php ENDPATH**/ ?>