<?php $__env->startSection('title', $invoice->no_invoice ?? 'Invoice Unit'); ?>
    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        ...
        <div class="d-flex justify-content-between flex-xl-row flex-md-column flex-sm-row flex-column <?php echo e(!$quote->tax ? 'justify-content-end' : ''); ?> gap-3 mb-0">
            ...
            <div class="text-end">
                ...
                <p class="mb-1 text-muted small"><?php echo e($invoice->date ? \Carbon\Carbon::parse($invoice->date)->format('d-m-Y') : '-'); ?></p>
            </div>
        </div>
                ...
                <div style="font-size:11.5px; color:#333;" class="my-auto">
                    ...
                    <div class="mt-2">
                        ...
                        <div class="ps-2 ms-1" style="border-left:3px solid #696cff; margin-top:4px;">
                            <div class="fw-bold text-dark ps-2" style="font-size:11.5px; line-height:1.45; white-space:pre-line;"><i class="mdi mdi-chevron-right text-primary me-1" style="font-size:14px;"></i><?php echo e($invoice->term ?? $quote->payment_method ?? '-'); ?></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <table class="table table-bordered m-0" style="border: 1px solid rgb(60,60,60); width: 100%;">
                <thead class="table-light">
                    <tr>
                        ...
                        <th class="text-center align-middle" style="width:<?php echo e($quote->tax ? '38%' : '45%'); ?>"><span class="i18n" data-en="DESCRIPTION">DESKRIPSI</span></th>
                ...
                <tbody>
                    ...
                    ?>
                    <?php $__currentLoopData = $quote->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($detail->type === 'header' || $detail->type === 'heading'): ?>
                            <?php
                            ...
                            <tr style="background:#f0f0ff; border-top:1.5px solid #d0d0ff; border-bottom:1.5px solid #d0d0ff;">
                                <td colspan="<?php echo e($totCols); ?>" class="fw-bold text-uppercase py-2 px-3 text-primary" style="font-size:12px; letter-spacing:0.5px;">
                                    <i class="mdi mdi-bookmark-outline me-1"></i> <?php echo e($lbl); ?>

                                </td>
                            </tr>
                        <?php else: ?>
                            <?php $dpp = $quote->tax ? ($detail->amount * 11 / 12) : 0; ?>
                            <tr style="font-size: 13px">
                                <td class="align-top text-center"><?php echo e($itemNo++); ?></td>
                                <td class="align-top">
                                    <?php if($detail->type === 'unit' && $detail->unit): ?>
                                        <p class="mb-1 fw-medium" style="font-size: 12px"><?php echo e($detail->label ?: ($detail->unit->brand . ' ' . $detail->unit->model)); ?></p>
                                        <?php
                                            $specs       = $detail->getSpecVisibleArray();
                                            $category    = $detail->unit->unit ?? '';
                                            $catOverride = $specLabelsOverride[$category] ?? [];
                                        ?>
                                        <?php if(!empty($specs) && $invoice->show_spec): ?>
                                            <div style="font-size:10px; color:#555; margin-top:3px;">
                                                <?php $__currentLoopData = $specs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <?php $val = $detail->unit->$field ?? null; ?>
                                                    <?php if($val && isset($specLabels[$field])): ?>
                                                        <div style="display:flex; padding:1px 0;">
                                                            <span style="color:#888; min-width:110px; flex-shrink:0;"><?php echo e($catOverride[$field] ?? $specLabels[$field]); ?></span>
                                        ...
                                        <?php endif; ?>
                                    <?php elseif($detail->type === 'equivalent' || $detail->type === 'sparepart' || $detail->id_equivalent || $detail->equivalent): ?>
                                         <?php if($detail->equivalent): ?>
                                             <?php
                                             ...
                                             <p class="mb-0 fw-bold text-dark" style="font-size: 12px">
                                                 <?php echo e($brandPn ?: $detail->label); ?>
                                             ...
                                             <?php endif; ?>
                                         <?php else: ?>
                                             <p class="mb-0 fw-bold text-dark" style="font-size: 12px"><?php echo e($detail->label); ?></p>
                                         <?php endif; ?>
                                    <?php else: ?>
                                        <p class="mb-0 fw-bold text-dark" style="font-size: 12px"><?php echo e($detail->label ?: '-'); ?></p>
                                    <?php endif; ?>
                                     ...
                                     <?php if($detail->description): ?>
                                         <div style="font-size: 11px; color: #444; white-space: pre-line; margin-top: 3px; line-height: 1.4;"><?php echo e($detail->description); ?></div>
                                     <?php endif; ?>
                                </td>
                                <td class="align-top text-end"><?php echo e(number_format($detail->price, 0, '', '.')); ?></td>
                                <td class="align-top text-center" style="white-space:nowrap"><?php echo e((float) $detail->qty); ?> <?php echo e($detail->info_qty); ?></td>
                                <?php if($hasDisc): ?>
                                    <td class="align-top text-center"><?php echo e($detail->disc > 0 ? (float)$detail->disc . '%' : '-'); ?></td>
                                <?php endif; ?>
                                <?php if($quote->tax): ?>
                                    <td class="align-top text-end"><?php echo e(number_format($dpp, 0, '', '.')); ?></td>
                                <?php endif; ?>
                                <td class="align-top text-end fw-semibold"><?php echo e(number_format($detail->amount, 0, ',', '.')); ?></td>
                            </tr>
                        <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr class="fw-medium" style="font-size: 13px">
                        <td colspan="<?php echo e($quote->tax ? 2 : 1); ?>" rowspan="9" style="border: none !important;"></td>
                        <td colspan="<?php echo e($labelSpan); ?>" class="text-end py-0" style="padding-right: 10px !important;">
                            <p class="m-0"><?php echo e(($quote->tax || $totalPph > 0) ? 'Subtotal' : 'Total'); ?></p>
                        </td>
                        <td colspan="<?php echo e($amountSpan); ?>" class="py-0 text-end" style="padding-right: 10px !important;">
                            <p class="m-0">Rp <?php echo e(number_format($quote->subtotal, 0, '', '.')); ?></p>
                        </td>
                    </tr>
                    <?php if($quote->diskon > 0): ?>
                        <tr class="fw-medium" style="font-size: 13px">
                            <td colspan="<?php echo e($labelSpan); ?>" class="text-end py-0" style="padding-right: 10px !important;">
                                <p class="m-0">Discount<?php echo e($quote->discount_label ? ' (' . $quote->discount_label . ')' : ''); ?></p>
                            </td>
                            <td colspan="<?php echo e($amountSpan); ?>" class="py-0 text-end" style="padding-right: 10px !important;">
                                <p class="m-0">- Rp <?php echo e(number_format($quote->discount_amount, 0, '', '.')); ?></p>
                            </td>
                        </tr>
                        <tr class="fw-medium" style="font-size: 13px">
                            <td colspan="<?php echo e($labelSpan); ?>" class="text-end py-0" style="padding-right: 10px !important;">
                            ...
                            <td colspan="<?php echo e($amountSpan); ?>" class="py-0 text-end" style="padding-right: 10px !important;">
                                <p class="m-0">Rp <?php echo e(number_format($afterDisc, 0, '', '.')); ?></p>
                            </td>
                        </tr>
                    <?php endif; ?>
                    <?php if($quote->tax): ?>
                        <tr class="fw-medium" style="font-size: 13px">
                            ...
                            <td colspan="<?php echo e($amountSpan); ?>" class="py-0 text-end" style="padding-right: 10px !important;">
                                <p class="m-0">Rp <?php echo e(number_format($afterDisc * 11 / 12, 0, '', '.')); ?></p>
                            </td>
                        </tr>
                        <tr class="fw-medium" style="font-size: 13px">
                            <td colspan="<?php echo e($labelSpan); ?>" class="text-end py-0" style="padding-right: 10px !important;">
                            ...
                            <td colspan="<?php echo e($amountSpan); ?>" class="py-0 text-end" style="padding-right: 10px !important;">
                                <p class="m-0">Rp <?php echo e(number_format($quote->tax_amount, 0, '', '.')); ?></p>
                            </td>
                        </tr>
                    <?php endif; ?>
                    <?php if($quote->shipping > 0): ?>
                        <tr class="fw-medium" style="font-size: 13px">
                            ...
                            <td colspan="<?php echo e($amountSpan); ?>" class="py-0 text-end" style="padding-right: 10px !important;">
                                <p class="m-0">Rp <?php echo e(number_format($quote->shipping, 0, '', '.')); ?></p>
                            </td>
                        </tr>
                    <?php endif; ?>
                    <?php if($totalPph > 0): ?>
                        <tr class="fw-medium" style="font-size: 13px">
                            ...
                            <td colspan="<?php echo e($amountSpan); ?>" class="py-0 text-end" style="padding-right: 10px !important;">
                                <p class="m-0">Rp <?php echo e(number_format($totalPph, 0, '', '.')); ?></p>
                            </td>
                        </tr>
                    <?php endif; ?>
                    <?php
                    ...
                    ?>
                    <?php if($quote->tax || $totalPph > 0 || $showTagihanBreakdown): ?>
                        <tr class="fw-medium" style="font-size: 13px">
                            <td colspan="<?php echo e($labelSpan); ?>" class="text-end py-2" style="background-color:<?php echo e($bgColor); ?>; padding-right: 10px !important;">
                                <p class="m-0 fw-bold">TOTAL</p>
                            </td>
                            <td colspan="<?php echo e($amountSpan); ?>" class="py-2 text-end" style="background-color:<?php echo e($bgColor); ?>; padding-right: 10px !important;">
                                <p class="m-0 fw-bold">Rp <?php echo e(number_format($showTagihanBreakdown ? $quote->total : $totalAfterPph, 0, '', '.')); ?></p>
                            </td>
                        </tr>
                    <?php endif; ?>
                    <?php if($showTagihanBreakdown): ?>
                        <?php if(in_array($invoice->type, ['BP', 'Balance Payment'])): ?>
                            ...
                            <?php if($dpAmount > 0): ?>
                                <tr class="fw-medium" style="font-size: 13px">
                                    <td colspan="<?php echo e($labelSpan); ?>" class="text-end py-1" style="padding-right: 10px !important; color:#dc3545;">
                                        <p class="m-0"><span class="i18n" data-en="DP Already Paid (<?php echo e($dpPercent); ?>%)">DP Telah Dibayar (<?php echo e($dpPercent); ?>%)</span></p>
                                    </td>
                                    <td colspan="<?php echo e($amountSpan); ?>" class="py-1 text-end" style="padding-right: 10px !important; color:#dc3545;">
                                        <p class="m-0">Rp <?php echo e(number_format($dpAmount, 0, '', '.')); ?></p>
                                    </td>
                                </tr>
                            <?php endif; ?>
                        <?php endif; ?>
                        ...
                        <tr style="font-size: 13px; background:yellow; border-top:2px solid #e6c300;">
                            <td colspan="<?php echo e($labelSpan); ?>" class="text-end py-2 fw-bold" style="padding-right: 10px !important; color:#000;">
                                <p class="m-0 fw-bold"><span class="i18n" data-en="<?php echo e($billingLabelEn); ?>"><?php echo e($billingLabelId); ?></span></p>
                            </td>
                            <td colspan="<?php echo e($amountSpan); ?>" class="py-2 fw-bold text-end" style="padding-right: 10px !important; color:#000;">
                                <p class="m-0 fw-bold">Rp <?php echo e(number_format($totalAfterPph, 0, '', '.')); ?></p>
                            </td>
                        </tr>
                    <?php endif; ?>
                </tbody>
        ...
        <div class="mt-3 mb-3 px-1 py-2 rounded-0" style="background:#f0f2ff; border: 1px dashed #696cff; display:inline-block; width:70%; border-radius:0 !important;">
            <div style="display:flex; align-items:center; gap:8px;">
                ...
                <span style="font-weight:700; color:#111; font-size:12.5px;" class="i18n" data-en="# <?php echo e($terbilangEn); ?> Rupiah"># <?php echo e($terbilang); ?> Rupiah</span>
            </div>
        </div>
        ...
        <div style="display:flex; gap:0; margin-top:16px;">
            ...
            <div style="flex:0 0 30%; text-align:center; padding-top:8px;">
                ...
                ?>
                <p style="margin-bottom:4px; color:#777; font-size:11px;">Bandung, <span class="i18n" data-en="<?php echo e($signDateEn); ?>"><?php echo e($signDateId); ?></span></p>
                <?php if($quote->tax): ?>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/accounting/invoice/detail-print-unit.blade.php ENDPATH**/ ?>