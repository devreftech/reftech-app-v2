...
<?php $__env->startSection('content'); ?>
        ...
        <div class="col-xl-9 col-md-8 col-12 mb-md-0 mb-4">
            <div class="card invoice-preview-card mb-3">
                    ...
                    <table class="table table-bordered m-0">
                        ...
                        <tbody>
                                ...
                                <?php $__currentLoopData = $subJudul->detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr style="font-size: 13px; border-bottom:none !important; border-top:none !important;">
                                        ...
                                        <td class="align-top py-1 text-end" style="border-bottom:none !important;">
                                            <p class="mb-0"><?php echo e($product->price == 0 ? 'SBO' : 'RP ' . number_format($product->price, 0, '', '.')); ?></p>
                                        </td>
                                        <td class="align-top py-1" style="border-bottom:none !important;">
                                            <p class="mb-0"><?php echo e($product->disc); ?> %</p>
                                        </td>
                                        <td class="align-top py-1 text-end" style="border-bottom:none !important;">
                                            <p class="mb-0"><?php echo e($product->price == 0 ? 'SBO' : 'RP ' . number_format($product->amount, 0, '', '.')); ?></p>
                                        </td>
                                    </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2" class="text-end"> RP <?php echo e(number_format($quote->subtotal, 0, '', '.')); ?></td>
                            </tr>
                            <tr>
                                <td colspan="3"></td>
                                <td class="text-end"> Discount :</td>
                                <td colspan="2" class="text-end"> RP <?php echo e(number_format($quote->diskon, 0, '', '.')); ?></td>
                            </tr>
                            <tr>
                                <td colspan="3"></td>
                                <td class="text-end"> Total After Discount :</td>
                                <td colspan="2" class="text-end"> RP <?php echo e(number_format($quote->subtotal - $quote->diskon, 0, '', '.')); ?></td>
                            </tr>
                            <tr>
                                <td colspan="3"></td>
                                <td class="text-end"> Total Tax :</td>
                                <td colspan="2" class="text-end"> RP <?php echo e(number_format($tax, 0, '', '.')); ?></td>
                            </tr>
                            <tr class="border-top">
                ...
                <div class="card-body mt-2">
                    ...
                    <p class="text-center"><?php echo e($quote->sales->name); ?> <?php echo e($quote->sales->phone); ?></p>
                </div>
            </div>
        ...
        <div class="col-xl-3 col-md-4 col-12 invoice-actions">
            ...
            <?php if($quote->level == '1'): ?>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <a class="btn btn-outline-primary d-grid w-100 mb-3 waves-effect"
                                href="<?php echo e(route('overhaul-revision.quotation', @$primQuote->id ?? $lastQuote->id)); ?>">
                                + Revisi Quotation
                            </a>
                            <a class="btn btn-outline-info d-grid w-100 mb-3 waves-effect"
                                href="<?php echo e(route('edit-overhaul.quotation', $quote->id)); ?>">
                                + Edit Quotation
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <a class="btn btn-primary btn-outline-secondary d-grid w-100 mb-3 waves-effect"
                                    target="_blank" href="<?php echo e(route('overhaul-print.quotation', $quote->id)); ?>">
                                    Download ++
                                </a>
                            </div>
                            <div class="col-6">
                                <a class="btn btn-warning btn-outline-secondary d-grid w-100 mb-3 waves-effect"
                                    target="_blank" href="<?php echo e(route('overhaul-print-no-image.quotation', $quote->id)); ?>">
                                    Download --
                                </a>
                            </div>
                        </div>
                ...
                <?php if(Auth::user()->role == 'Sales'): ?>
                    <div class="card mb-3">
                        <div class="card-body">
                            <?php if((Auth::user()->id == '1' || Auth::user()->id == '16') && $invoice->count() < 1): ?>
                                <a href="#" data-id="<?php echo e($quote->id); ?>"
                                    class="btn btn-instagram d-grid w-100 waves-effect mb-3 convert-flag">Change to
                                    <?php echo e($quote->pic->client->info == 'Reftech' ? 'Kojisha' : 'Reftech'); ?></a>
                            <?php endif; ?>
                            <?php if($quote->status != '100'): ?>
                            ...
                            <?php else: ?>
                                <?php if($quote->po_file != null): ?>
                                    <?php if($invoice->count() >= 1 && $invoice[0]->no_invoice == null): ?>
                                        <button type="button"
                                            class="btn btn-outline-primary d-grid w-100 waves-effect mb-3">
                                            Waiting Accounting Apply
                                        </button>
                                    <?php elseif($invoice->count() >= 1 && $invoice[0]->no_invoice): ?>
                                        <a class="btn btn-facebook d-grid w-100 mb-3 waves-effect"
                                            href="<?php echo e(route('invoice.show', $invoice[0]->id)); ?>">
                                            Go To Invoice <?php echo e($invoice[0]->type == 'CT' ? '' : 'DP'); ?>

                                        </a>
                                        <?php if(@$payments): ?>
                                            <?php if($invoice->count() == 1): ?>
                                                <button type="button"
                                                    class="btn btn-outline-dark d-grid w-100 waves-effect mb-3"
                                                    data-bs-toggle="modal" data-bs-target="#request-bp">
                                                    Request Invoice BP
                                                </button>
                                            <?php elseif($invoice[1]->no_invoice == null): ?>
                                                <button type="button"
                                                    class="btn btn-outline-primary d-grid w-100 waves-effect mb-3">
                                                    Waiting Accounting Apply
                                                </button>
                                            <?php elseif($invoice[1]->no_invoice): ?>
                                                <a class="btn btn-facebook d-grid w-100 mb-3 waves-effect"
                                                    href="<?php echo e(route('invoice.show', $invoice[1]->id)); ?>">
                                                    Go To Invoice BP
                                                </a>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    ...
                                    <?php $__currentLoopData = $invoice; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoices): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <button type="button" class="btn btn-outline-dark d-grid w-100 waves-effect mb-3"
                                            ...
                                            Change No PO <?php echo e($invo == 0 ? 'DP' : 'BP'); ?>
    ...
    <?php $__currentLoopData = $invoice; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoices): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        ?>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <?php echo $__env->make('components.modal.quotation.request-bp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        ...
        $(document).on('click', '.delete-quotation', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        'url': '<?php echo e(url('quote')); ?>/service-delete/' + id,
                        'type': 'POST',
                        'data': {
                            '_method': 'DELETE',
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/sales/quotation/overhaul/detail.blade.php ENDPATH**/ ?>