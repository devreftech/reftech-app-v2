...
<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('pending-po.product_out', $id)); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="row">
            <div class="col-12 col-md-6">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control form-control-lg fw-bold fs-3" id="floatingInputFilled"
                        ...
                        value="<?php echo e($pending->quote->invoice[0]->no_invoice ?? ''); ?>">
            ...
            <div class="col-12 col-md-6">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control form-control-lg fw-bold fs-3" id="floatingInputFilled"
                        ...
                        value="<?php echo e($pending->quote->invoice[0]->no_po ?? ''); ?>">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6 mb-3 mb-lg-0">
                            <textarea class="form-control" rows="2" placeholder="Detail Customers" name="detail_client"
                                style="min-height: 100px"><?php echo e($pending->quote->pic->client->company); ?></textarea>
                        </div>
                                        ...
                                        <div class="col-md-6 col-12 mb-md-0 mb-3">
                                            ...
                                            <div class="form-floating form-floating-outline mb-2">
                                                <select id="replacement-dropdown-1"
                                                    ...
                                                    <?php $__currentLoopData = $detail->equivalent->product->detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-lg-4 col-12">
                            ...
                            <div class="input-group" data-total="1">
                                ...
                                <p class="form-control pending-item-total-label h-px-25 mb-0" id="total-label">
                                    <?php echo e(number_format( $pending->quote->subtotal, 0 , ',', '.')); ?> </p>
                                <input class="form-control pending-item-total" type="number" name="total"
                                    id="total" value="<?php echo e($pending->quote->subtotal); ?>" hidden>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/pending/form.blade.php ENDPATH**/ ?>