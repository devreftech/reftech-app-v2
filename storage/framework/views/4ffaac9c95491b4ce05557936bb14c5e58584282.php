...
<div class="row gy-4 mb-4">
    ...
    <div class="col-lg-3 col-md-6">
        <div class="card h-100">
            ...
            <div class="card-body d-flex flex-column align-items-center justify-content-center">
                ...
                <span class="text-muted small mt-2"><?php echo e($po->count() ?? 0); ?> PO dari <?php echo e($quotation->count() ?? 0); ?> Quotation</span>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-5 col-md-6">
        <div class="card h-100">
            ...
            <div class="card-body">
                <?php if(array_sum($salesStatusSeries ?? []) == 0): ?>
...
<div class="row gy-4 mb-4">
    ...
    <div class="col-lg-5">
        <div class="card h-100">
            ...
            <div class="card-body">
                <?php if(($sourceData ?? collect())->isEmpty()): ?>
                    <div class="d-flex align-items-center justify-content-center" style="min-height: 220px;">
    ...
    <div class="col-12">
        <div class="card h-100">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-label-primary font-semibold">Calendar Year <?php echo e($year ?? now()->year); ?></span>
            </div>
            <div class="card-body">
        ...
        (function () {
            ...
            if (funnelEl) {
                new ApexCharts(funnelEl, {
                    ...
                    series: [{ name: 'Jumlah', data: <?php echo json_encode($salesFunnelSeries ?? [0, 0, 0]) ?> }],
                    xaxis: {
                        categories: <?php echo json_encode($salesFunnelLabels ?? ['New Leads', 'Quotation', 'PO Won']) ?>,
            ...
            if (winRateEl) {
                new ApexCharts(winRateEl, {
                    chart: { type: 'radialBar', height: 220 },
                    series: [<?php echo e((float) ($salesWinRate ?? 0)); ?>],
                    labels: ['Win Rate'],
                    colors: ['#71dd37'],
                    plotOptions: {
                        radialBar: {
            ...
            if (statusEl) {
                new ApexCharts(statusEl, {
                    ...
                    labels: <?php echo json_encode($salesStatusLabels ?? [], 15, 512) ?>,
                    series: <?php echo json_encode($salesStatusSeries ?? [], 15, 512) ?>,
            ...
            if (trendEl) {
                new ApexCharts(trendEl, {
                    ...
                    series: [
                        { name: 'Quotation', data: <?php echo json_encode($salesMonthlyQuote ?? [], 15, 512) ?> },
                        { name: 'PO Won', data: <?php echo json_encode($salesMonthlyPO ?? [], 15, 512) ?> },
                    ],
                    xaxis: {
                        categories: <?php echo json_encode($salesMonthlyLabels ?? [], 15, 512) ?>,
                        labels: { style: { colors: labelColor } },
                    },
                    yaxis: { labels: { style: { colors: labelColor } } },
            ...
            if (sourceEl) {
                new ApexCharts(sourceEl, {
                    chart: { type: 'donut', height: 260 },
                    labels: <?php echo json_encode(($sourceData ?? collect())->pluck('source'), 15, 512) ?>,
                    series: <?php echo json_encode(($sourceData ?? collect())->pluck('total'), 15, 512) ?>,
                    legend: { position: 'bottom', labels: { colors: labelColor } },
                    dataLabels: { enabled: true, formatter: (val) => val.toFixed(1) + '%' },
                }).render();
            }
            ...
            if (forecastEl) {
                const targetData = <?php echo json_encode(collect($months ?? [])->pluck('target'), 15, 512) ?>;
                const projectionData = <?php echo json_encode(collect($months ?? [])->pluck('projection'), 15, 512) ?>;
                const actualData = <?php echo json_encode(collect($months ?? [])->pluck('actual'), 15, 512) ?>;
                const monthNames = <?php echo json_encode(collect($months ?? [])->pluck('name'), 15, 512) ?>;
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/sales/dashboard/_charts.blade.php ENDPATH**/ ?>