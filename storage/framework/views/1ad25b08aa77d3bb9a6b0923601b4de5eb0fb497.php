...
<form action="<?php echo e(route('unit-quotation.update-pending', $quote->id)); ?>" method="post" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
                            ...
                            <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center gap-2 position-relative"
                                ...
                                <div class="text-start">
                                    ...
                                    <p class="mb-0 text-white opacity-80" style="font-size: 12.5px;">
                                        ...
                                        PIC: <?php echo e($quote->pic->name_pic ?? ($quote->attn ?? '-')); ?>
                                ...
                                <div class="text-start text-sm-end d-flex flex-column align-items-start align-items-sm-end gap-1">
                                    <div class="px-3 py-1 rounded text-white font-monospace"
                                        ...
                                        <i class="mdi mdi-file-document-outline me-1"></i> <?php echo e($quote->no_quote); ?>

                                    </div>
                                    <div class="fw-semibold text-white mt-1" style="font-size: 13px;">
                                        Total: <span class="text-warning fw-bold">Rp
                                            <?php echo e(number_format($quote->total, 0, ',', '.')); ?></span>
                                    </div>
                                    <?php if($pendingPo): ?>
                                        <div class="px-2 py-1 rounded" style="font-size: 11px; background: rgba(255,255,255,0.12); border: 1px solid rgba(255,255,255,0.15);">
                                            ...
                                            Sales Order: <strong><?php echo e($pendingPo->no_pending); ?></strong>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                                    ...
                                    <div class="col-12 mb-3">
                                        <div class="form-floating form-floating-outline">
                                            <input type="text" class="form-control" id="uq_NoPending"
                                                ...
                                                name="no_pending"
                                                value="<?php echo e(old('no_pending', $pendingPo->no_pending ?? $quote->po_number ?? $quote->no_quote)); ?>">
                                    ...
                                    <div class="col-12 mb-3">
                                        <div class="form-floating form-floating-outline">
                                            <input type="text" class="form-control" id="uq_title"
                                                ...
                                                name="title"
                                                value="<?php echo e(old('title', $pendingPo->title ?? $quote->title)); ?>">
                                    ...
                                    <div class="col-12 mb-3">
                                        <div class="form-floating form-floating-outline">
                                            <select class="form-select" id="uq_selectEkspedisi"
                                                ...
                                                <option value="1" <?php echo e(($pendingPo->delivery ?? '') == 1 ? 'selected' : ''); ?>>JNT / JNE / Cargo</option>
                                                <option value="2" <?php echo e(($pendingPo->delivery ?? '') == 2 ? 'selected' : ''); ?>>Send By Technician</option>
                                                <option value="3" <?php echo e(($pendingPo->delivery ?? '') == 3 ? 'selected' : ''); ?>>Taken Directly</option>
                                                <option value="4" <?php echo e(($pendingPo->delivery ?? '') == 4 ? 'selected' : ''); ?>>Others</option>
                                            </select>
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating form-floating-outline">
                                            <textarea name="note" id="uq_note" class="form-control h-px-80"
                                                placeholder="Put Note Here....."><?php echo e(old('note', '-')); ?></textarea>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="form-check form-switch mb-0">
                                            <input class="form-check-input" type="checkbox"
                                                ...
                                                value="1"
                                                <?php echo e(($pendingPo->combine_shipping_and_parts ?? true) ? 'checked' : ''); ?>
                                ...
                                <div id="uq_combined_address_section">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select mb-2" id="uq_combined_address_select"
                                            ...
                                            <option value="customer">Main Address: <?php echo e($quote->client->address ?? '-'); ?></option>
                                            <?php if(!empty($quote->client->subAddress)): ?>
                                                <option value="<?php echo e($quote->client->subAddress); ?>">Sub Address: <?php echo e($quote->client->subAddress); ?></option>
                                            <?php endif; ?>
                                            <?php $__currentLoopData = $quote->client->plants ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($plant->address); ?>">Plant: <?php echo e($plant->name); ?> (<?php echo e($plant->address); ?>)</option>
                                        ...
                                        <div id="uq_combined_manual_wrapper" class="d-none mt-2">
                                            <textarea class="form-control" name="shipping_address_manual"
                                                ...
                                                placeholder="Masukkan alamat manual lengkap..."><?php echo e($pendingPo->shipping_address_manual ?? ''); ?></textarea>
                                        </div>
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <select class="form-select" id="uq_combined_recipient_select">
                                                <?php $__currentLoopData = $quote->client->pic ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c_pic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($c_pic->id); ?>"
                                                        <?php echo e(($pendingPo->shipping_recipient_id ?? $quote->id_pic) == $c_pic->id ? 'selected' : ''); ?>>
                                    ...
                                    <div class="mb-3 pb-3 border-bottom">
                                        ...
                                        <div id="uq_doc_manual_wrapper" class="d-none mt-2">
                                            <textarea class="form-control" name="doc_address_manual"
                                                ...
                                                placeholder="Masukkan alamat dokumen manual..."><?php echo e($pendingPo->doc_address_manual ?? ''); ?></textarea>
                                        </div>
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <select class="form-select" id="uq_doc_recipient_select">
                                                <?php $__currentLoopData = $quote->client->pic ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c_pic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($c_pic->id); ?>"
                                                        <?php echo e(($pendingPo->doc_recipient_id ?? $quote->id_pic) == $c_pic->id ? 'selected' : ''); ?>>
                                                        <?php echo e($c_pic->name_pic); ?> <?php echo e($c_pic->posisi ? '(' . $c_pic->posisi . ')' : ''); ?>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div id="uq_shipping_manual_wrapper" class="d-none mt-2">
                                            <textarea class="form-control" name="shipping_address_manual"
                                                ...
                                                placeholder="Masukkan alamat barang manual..."><?php echo e($pendingPo->shipping_address_manual ?? ''); ?></textarea>
                                        </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/unit-quotation/convert-po.blade.php ENDPATH**/ ?>