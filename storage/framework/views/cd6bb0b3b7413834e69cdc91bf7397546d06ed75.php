...
<?php $__env->startSection('title', 'Create Service Quotation'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <form id="formAuthentication" class="mb-3 fv-plugins-bootstrap5 fv-plugins-framework"
        action="<?php echo e(@$quotation ? route('update-service.quotation', $quotation->id) : route('store-service.quotation')); ?>"
        ...
        <div class="card">
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-12 col-lg-3 mb-3">
                        <div class="form-floating form-floating-outline">
                            <select id="select2Basic" class="select2 form-select form-select-lg invoice-item-client"
                                data-allow-clear="true" name="id_pic" <?php echo e(@$quotation ? 'disabled' : ''); ?>>
                                ...
                                <?php $__currentLoopData = $pic; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $charge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($charge->id); ?>"
                                        <?php echo e(@$quotation->pic->id_client == $charge->id ? 'selected' : ''); ?>>
                                        <?php echo e($charge->company); ?>
                    ...
                    <?php if(@$quotation): ?>
                        <input type="text" name="id_pic" id="idPic" value="<?php echo e($quotation->id_pic); ?>" hidden>
                    <?php endif; ?>
                    <div class="col-12 col-lg-3">
                        <div class="form-floating form-floating-outline mb-2">
                            <select id="pic-dropdown" class="select2 form-select invoice-item-pic" data-allow-clear="true"
                                ...
                                <?php if(@$quotation): ?>
                                    <option selected>
                                        <?php echo e($quotation->pic->name_pic); ?>
                    ...
                    <?php if(@$quotation): ?>
                        <input type="text" name="pic" id="destination" value="<?php echo e($quotation->id_pic); ?>" hidden>
                    <?php endif; ?>
                    ...
                    <?php if(@$quotation): ?>
                        <input type="text" name="destination" id="destination" value="<?php echo e($quotation->destination); ?>"
                            hidden>
                    <?php endif; ?>
                    ...
                    <div class="col-12 col-lg-3">
                        <div class="form-floating form-floating-outline mb-2">
                            <select id="address-dropdown" class="select2 form-select invoice-item-destination"
                                ...
                                <?php if(@$quotation): ?>
                                    <option selected>
                                        <?php echo e($quotation->destination == '1' ? $quotation->pic->client->address : $quotation->pic->client->subAddress); ?>
                    ...
                    <div class="col-12 col-lg-3">
                        <div class="form-floating form-floating-outline mb-4">
                            <input class="form-control" type="text" placeholder="Put your No PR Here ...."
                                id="no-pr-input" name="no_pr" value="<?php echo e(@$quotation->no_pr ?? '-'); ?>">
                    ...
                    <div class="col-md-2 col-4">
                        <div class="form-floating form-floating-outline mb-4">
                            <select class="form-select" id="Type" aria-label="Default select example" name="type">
                                ...
                                <option value="Project" <?php echo e(@$quote->type == 'Project' ? 'selected' : ''); ?>>Project
                                </option>
                            </select>
                    ...
                    <div class="col-md-2 col-4">
                        <div class="form-floating form-floating-outline">
                            <select class="form-select" id="selectWeek" aria-label="Default select example"
                                ...
                                <option value="1" <?php echo e(@$quote->week == '1' ? 'selected' : ''); ?>>Week 1</option>
                                <option value="2" <?php echo e(@$quote->week == '2' ? 'selected' : ''); ?>>Week 2</option>
                                <option value="3" <?php echo e(@$quote->week == '3' ? 'selected' : ''); ?>>Week 3</option>
                                <option value="4" <?php echo e(@$quote->week == '4' ? 'selected' : ''); ?>>Week 4</option>
                                <option value="5" <?php echo e(@$quote->week == '5' ? 'selected' : ''); ?>>Week 5</option>
                            </select>
                ...
                <?php if(@$quotation): ?>
                    <?php
                        ...
                        $dataDelete = 1;
                    ?>
                    <?php $__currentLoopData = $subtitle; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $title): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $dataDetail = 1;
                        ?>
                        <div class="service mb-3" data-row="<?php echo e($id); ?>">
                            <div class="d-flex justify-content-between mb-3">
                                <h5 class="mb-0">Title</h5>
                                <i class="mdi mdi-close cursor-pointer bg-danger text-white btn-delete-title"
                                    data-id="<?php echo e($id); ?>"></i>
                            </div>
                            <input type="text" id="title" class="subtitle form-control form-control-lg mb-2"
                                name="subTitle[]" placeholder="Title Quotation" value="<?php echo e($title->subtitle); ?>">
                            <div class="border rounded">
                                <div class="form-invoice-repeater-<?php echo e($id); ?> source-item">
                                    <div class="col-repeater mb-2" data-repeater-list="<?php echo e($id); ?>">
                                        <?php $__currentLoopData = $title->detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="repeater-wrapper pt-0" data-repeater-item="<?php echo e($dataDetail); ?>">
                                                <div class="d-flex position-relative pe-0">
                                                    <div class="row w-100 p-3 pb-0">
                                                        <div class="col-md-6 col-12 mb-md-0">
                                                            ...
                                                            <div class="form-floating form-floating-outline mb-2">
                                                                <input type="text"
                                                                    id="product-<?php echo e($id); ?>-<?php echo e($dataDetail); ?>"
                                                                    class="form-control form-control-lg mb-2"
                                                                    name="product[<?php echo e($id); ?>][]"
                                                                    placeholder="Input Product Here"
                                                                    value="<?php echo e($item->product); ?>">
                                                                <label
                                                                    for="product-<?php echo e($id); ?>-<?php echo e($dataDetail); ?>">Product</label>
                                                            </div>
                                                            <textarea class="form-control invoice-item-detail-product" rows="2"
                                                                id="detailProduct-<?php echo e($id); ?>-<?php echo e($dataDetail); ?>" placeholder="Detail Product. Example: Kaeser ASD"
                                                                name="detail_product[<?php echo e($id); ?>][]"><?php echo e($item->detail); ?></textarea>
                                                        </div>
                                                        <div class="col-md-3 col-12 mb-md-0 mb-3">
                                                            <p class="mb-2 repeater-title">Price</p>
                                                            <div class="input-group mb-3"
                                                                data-price="<?php echo e($id); ?>">
                                                                <span class="input-group-text">Rp. </span>
                                                                <input type="text"
                                                                    class="form-control invoice-item-price-label"
                                                                    id="priceLabel-<?php echo e($id); ?>-<?php echo e($dataDetail); ?>"
                                                                    data-main="<?php echo e($id); ?>"
                                                                    data-id="<?php echo e($dataDetail); ?>" name="harga"
                                                                    placeholder="Put Price Here" data-type="currency"
                                                                    min="0" pattern="^[0-9]\d{0,2}(\.\d{3})*$"
                                                                    @focus="focused = true" @blur="focused = false"
                                                                    value="<?php echo e(old('price[' . $id . '][]', @$item->price ? number_format(@$item->price, 0, '', '.') : '')); ?>">
                                                                <input class="form-control invoice-item-price"
                                                                    type="number" name="price[<?php echo e($id); ?>][]"
                                                                    id="price-<?php echo e($id); ?>-<?php echo e($dataDetail); ?>"
                                                                    value="<?php echo e(old('price[' . $id . '][]', @$item->price ?? '')); ?>"
                                                                    hidden>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-1 col-12 mb-md-0 mb-3">
                                                            ...
                                                            <input type="number"
                                                                ...
                                                                placeholder="Min 1" name="qty[<?php echo e($id); ?>][]"
                                                                id="qty-<?php echo e($id); ?>-<?php echo e($dataDetail); ?>"
                                                                data-main="<?php echo e($id); ?>"
                                                                data-id="<?php echo e($dataDetail); ?>" min="1"
                                                                value="<?php echo e($item->qty); ?>">
                                                            <div class="form-floating form-floating-outline">
                                                                <select class="form-select invoice-item-info"
                                                                    id="info-qty-<?php echo e($id); ?>-<?php echo e($dataDetail); ?>"
                                                                    data-main="<?php echo e($id); ?>"
                                                                    data-id="<?php echo e($dataDetail); ?>"
                                                                    aria-label="Default select example"
                                                                    name="info_qty[<?php echo e($id); ?>][]">
                                                                    <option disabled>---Info---</option>
                                                                    <option value="Pcs"
                                                                        <?php echo e($item->info_qty == 'Pcs' ? 'selected' : ''); ?>>
                                                                        Pcs
                                                                    </option>
                                                                    <option value="Set"
                                                                        <?php echo e($item->info_qty == 'Set' ? 'selected' : ''); ?>>
                                                                        Set
                                                                    </option>
                                                                    <option value="Pail"
                                                                        <?php echo e($item->info_qty == 'Pail' ? 'selected' : ''); ?>>
                                                                        Pail
                                                                    </option>
                                                                    <option value="Unit"
                                                                        <?php echo e($item->info_qty == 'Unit' ? 'selected' : ''); ?>>
                                                                        Unit
                                                                    </option>
                                                                    <option value="Lot"
                                                                        <?php echo e($item->info_qty == 'Lot' ? 'selected' : ''); ?>>
                                                                        Lot
                                                                    </option>
                                                                    <option value="Meter"
                                                                        <?php echo e($item->info_qty == 'Meter' ? 'selected' : ''); ?>>
                                                                        Meter
                                                                    </option>
                                                                    <option value="Can"
                                                                        <?php echo e($item->info_qty == 'Can' ? 'selected' : ''); ?>>
                                                                        Can
                                                                    </option>
                                                                    <option value="Hari"
                                                                        <?php echo e($item->info_qty == 'Hari' ? 'selected' : ''); ?>>
                                                                        Hari
                                                                    </option>
                                                                    <option value="Bulan"
                                                                        <?php echo e($item->info_qty == 'Bulan' ? 'selected' : ''); ?>>
                                                                        Bulan
                                                                    </option>
                                                                    <option value="Kg"
                                                                        <?php echo e($item->info_qty == 'Kg' ? 'selected' : ''); ?>>Kg
                                                                    </option>
                                                                    <option value="Tube"
                                                                        <?php echo e($item->info_qty == 'Tube' ? 'selected' : ''); ?>>
                                                                        Tube
                                                                    </option>
                                                                    <option value="Titik"
                                                                        <?php echo e($item->info_qty == 'Titik' ? 'selected' : ''); ?>>
                                                                        Titik
                                                                    </option>
                                                                    <option value="Batang"
                                                                        <?php echo e($item->info_qty == 'Batang' ? 'selected' : ''); ?>>
                                                                        Batang
                                                                    </option>
                                                                    <option value="Box"
                                                                        <?php echo e($item->info_qty == 'Box' ? 'selected' : ''); ?>>
                                                                        Box
                                                                    </option>
                                                                </select>
                                                        ...
                                                        <div class="col-md-1 col-12 mb-md-0 mb-3">
                                                            ...
                                                            <input type="number" class="form-control invoice-item-disc"
                                                                placeholder="%" name="disc[<?php echo e($id); ?>][]"
                                                                id="disc-<?php echo e($id); ?>-<?php echo e($dataDetail); ?>"
                                                                data-main="<?php echo e($id); ?>"
                                                                data-id="<?php echo e($dataDetail); ?>" min="0"
                                                                value="<?php echo e(old('disc[' . $id . '][]', '0')); ?>">
                                                        </div>
                                                        <div class="col-md-1 col-12 pe-0">
                                                            <p class="mb-2 repeater-title">Amount</p>
                                                            <p class="mb-0 amount-label"
                                                                id="amount-label-<?php echo e($id); ?>-<?php echo e($dataDetail); ?>"
                                                                data-main="<?php echo e($id); ?>"
                                                                data-id="<?php echo e($dataDetail); ?>">
                                                                Rp
                                                                <?php echo e(old("amount[$id][]", number_format(optional($item)->amount, 2, ',', '.'))); ?>

                                                            </p>
                                                            <input type="number" class="form-control invoice-item-amount"
                                                                name="amount[<?php echo e($id); ?>][]"
                                                                id="amount-<?php echo e($id); ?>-<?php echo e($dataDetail); ?>"
                                                                data-main="<?php echo e($id); ?>"
                                                                data-id="<?php echo e($dataDetail); ?>"
                                                                value="<?php echo e(old('amount[' . $id . '][]', @$item->amount ?? '')); ?>"
                                                                hidden>
                                                        </div>
                                                    </div>
                                                    <div
                                                        ...
                                                        <i class="mdi mdi-close cursor-pointer bg-danger text-white btn-del"
                                                            data-delete="<?php echo e($dataDelete); ?>"
                                    ...
                                    <div class="row p-3 pt-0">
                                        <div class="col-12">
                                            <button type="button"
                                                ...
                                                data-repeater-create="<?php echo e($id); ?>">
                                                ...
                                                <div class="col-md-3 col-12 mb-md-0 mb-3">
                                                    ...
                                                    <div class="input-group mb-3" data-price="1">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            @blur="focused = false" value="<?php echo e(old('price[1][]')); ?>">
                                                        <input class="form-control invoice-item-price" type="number"
                                                            name="price[1][]" id="price-1-1"
                                                            value="<?php echo e(old('price[1][]')); ?>" hidden>
                                                    </div>
                                                </div>
                                                <div class="col-md-1 col-12 mb-md-0 mb-3">
                                                    <p class="mb-2 repeater-title">Qty</p>
                ...
                <div class="row">
                    <div class="col-lg-6 col-12">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="warranty" class="form-control form-control-lg"
                                    name="warranty"
                                    value="<?php echo e(old('warranty', @$quotation->termncon[0]->warranty ?? '3 Month')); ?>">
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            ?>
                            <div class="col-sm-8">
                                <textarea id="example-textarea" rows="6" name="note" class="form-control"><?php echo e($text); ?></textarea>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <?php else: ?>
                                            ...
                                            <input type="number" id="hargaTotal" class="form-control"
                                                name="harga_total"
                                                value="<?php echo e(old('harga_total', @$quotation->harga_total ?? '')); ?>" hidden>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row w-100 p-3 pb-0">
                                ...
                                <div class="col-md-3 col-12 mb-md-0 mb-3">
                                    ...
                                    <div class="input-group mb-3" data-price="1">
                                        ...
                                        <input class="form-control invoice-item-price" type="number" name="price[][]"
                                            id="price-1-1" value="<?php echo e(old('price[1][]')); ?>" hidden>
                                    </div>
                                </div>
                                <div class="col-md-1 col-12 mb-md-0 mb-3">
                                    <p class="mb-2 repeater-title">Qty</p>
                                ...
                                <div class="col-md-1 col-12 pe-0">
                                    ...
                                    <input type="number" class="form-control invoice-item-amount" name="amount[][]"
                                        id="amount-1-1" data-main="1" data-id="1" value="<?php echo e(old('amount[1][]')); ?>"
                                        hidden>
                                </div>
                            </div>
    ...
    <?php echo $__env->make('components.modal.quotation.service.scope', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/sales/quotation/service/form.blade.php ENDPATH**/ ?>