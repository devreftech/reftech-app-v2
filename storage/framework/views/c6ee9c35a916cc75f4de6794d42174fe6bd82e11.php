        ...
        <div class="container-fluid flex-grow-1 container-p-y">
            ...
            <div class="d-flex justify-content-between flex-xl-row flex-md-column flex-sm-row flex-column mb-0">
                ...
                <div class="text-end">
                    ...
                    <p class="mb-1 fw-semibold" style="font-size:14px;">#<?php echo e($doNumber); ?></p>
                    <p class="mb-0 text-muted" style="font-size:12px;"><?php echo e(\Carbon\Carbon::parse($delivery->date)->format('d F Y')); ?></p>
                </div>
            </div>
                        ...
                        <?php $__currentLoopData = $dDelivery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php else: ?>
                                <tr style="font-size: 13px">
                                    ...
                                    <td>
                                        <p class="mb-0 fw-medium" style="font-size: 12px"><?php echo e($item->view == '0' ? $item->desc : ''); ?></p>
                                    </td>
                        ...
                        <?php $__currentLoopData = $dDelivery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(($item->type ?? 'item') === 'header'): ?>
                                <tr style="background:#f0f0ff;">
                                    <td colspan="3" class="fw-bold text-uppercase py-1" style="font-size:12px;"><?php echo e($item->desc); ?></td>
                                </tr>
                            <?php else: ?>
                                <tr style="font-size: 13px;">
                                    <td class="align-top py-1"><?php echo e($itemNo++); ?></td>
                                    <td class="align-top py-1"><?php echo e($item->qty); ?> <?php echo e($item->info_qty); ?></td>
                                    <td class="align-top py-1"><?php echo e($item->view == '0' ? $item->desc : ''); ?></td>
                                </tr>
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <tr>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/unit-quotation/sj-print.blade.php ENDPATH**/ ?>