<form action="<?php echo e(route('convert-po.quotation', $quote->id)); ?>" method="post" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="col-6 mb-3">
                                        <div class="form-floating form-floating-outline">
                                            <input class="form-control" type="date" id="po_date" name="po_date"
                                                value="<?php echo e(old('po_date', @$quote->po_date ?? now()->format('Y-m-d'))); ?>">
                                        ...
                                        <div class="form-floating form-floating-outline">
                                            <select class="form-select" id="selectType" aria-label="Default select example"
                                                ...
                                                <option value="Non Project"
                                                    <?php echo e($quote->type == 'Sparepart' && $quote->quote_for == 'Sparepart' ? 'selected' : ''); ?>>
                                                    Non Project</option>
                                    ...
                                    <div class="col-12 mb-3">
                                        <div class="form-floating form-floating-outline">
                                            <input type="text" class="form-control" id="NoPending"
                                                ...
                                                name="no_pending" value="<?php echo e($noPending ?? ''); ?>">
                                    ...
                                    <div class="col-12 mb-3">
                                        <div class="form-floating form-floating-outline">
                                            <input type="text" class="form-control" id="title"
                                                ...
                                                aria-describedby="floatingInputFilledHelp" name="title" value="<?php echo e(old('title', $quote->title)); ?>">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <select class="form-select" id="convert_combined_recipient_select">
                                                <?php $__currentLoopData = $quote->pic->client->pic; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c_pic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($c_pic->id); ?>" <?php echo e($quote->id_pic == $c_pic->id ? 'selected' : ''); ?>>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/quotation/convert-po.blade.php ENDPATH**/ ?>