<form action="<?php echo e(route('action.leads',$leads->id)); ?>" method="post" enctype="multipart/form-data">
    
    <?php echo csrf_field(); ?>
    <div class="modal animate__animated animate__fadeIn" id="createAction<?php echo e($leads->id); ?>" tabindex="-1" style="display: none;"
        aria-hidden="true">
                        ...
                        <div class="col mb-2">
                            <div class="form-floating form-floating-outline">
                                <input type="text" id="bs-datepicker-date" placeholder="MM/DD/YYYY"
                                    class="form-control" name="date" value="<?php echo e(\Carbon\Carbon::today()->format('d/m/Y')); ?>"
                                    disabled>
                            ...
                            <div class="form-floating form-floating-outline">
                                <select class="form-select" id="selectStatus" aria-label="Default select example"
                                    ...
                                    <?php $__currentLoopData = $issue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $issues): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($issues->id); ?>" <?php echo e($issues->id == $leads->id_issues ? 'selected' : ''); ?>><?php echo e($issues->issue); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <label for="selectStatus">Status</label>
                            </div>
...
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/sales/activities/form.blade.php ENDPATH**/ ?>