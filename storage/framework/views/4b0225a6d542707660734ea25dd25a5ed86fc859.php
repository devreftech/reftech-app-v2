<?php $__env->startSection('title', 'Master Harga Jasa PM'); ?>
            ...
            <div class="card h-100 border-0 shadow-sm" style="background: linear-gradient(135deg, #f6f8fd 0%, #e9effd 100%);">
                <div class="card-body d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h3 class="mb-0 fw-bold text-primary"><?php echo e($prices->count()); ?> <span class="fs-6 text-muted font-normal">Kapasitas</span></h3>
                    </div>
                ...
                <div class="card-body d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h3 class="mb-0 fw-bold text-success">
                            Rp <?php echo e(number_format($prices->count() > 0 ? $prices->avg('price_pm1') : 0, 0, ',', '.')); ?>
                ...
                <div class="card-body d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h3 class="mb-0 fw-bold text-warning">
                            Rp <?php echo e(number_format($prices->count() > 0 ? $prices->avg('price_pm2') : 0, 0, ',', '.')); ?>
        ...
        <div class="table-responsive text-nowrap">
            <table class="table table-hover align-middle mb-0" id="pricesTable">
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    <tr class="main-row" data-power="<?php echo e(strtolower($price->power)); ?>">
                        <td class="text-center">
                            <button type="button" class="btn btn-icon btn-xs btn-label-secondary btn-toggle-detail" data-target="#detail-<?php echo e($price->id); ?>" title="Lihat Scope Standar">
                                <i class="mdi mdi-chevron-down fs-5"></i>
                            </button>
                        </td>
                        <td>
                            <span class="badge bg-label-primary px-3 py-2 fs-6 fw-bold border border-primary-subtle">
                                <i class="mdi mdi-flash me-1"></i><?php echo e($price->power); ?>

                            </span>
                        </td>
                        <td><span class="fw-bold text-dark">Rp <?php echo e(number_format($price->price_pm1, 0, ',', '.')); ?></span></td>
                        <td><span class="fw-bold text-dark">Rp <?php echo e(number_format($price->price_pm2, 0, ',', '.')); ?></span></td>
                        <td><span class="fw-bold text-dark">Rp <?php echo e(number_format($price->price_pm3, 0, ',', '.')); ?></span></td>
                        <td><span class="fw-bold text-dark">Rp <?php echo e(number_format($price->price_pm4, 0, ',', '.')); ?></span></td>
                        <td class="text-center">
                            <div class="d-inline-flex gap-1">
                                <button type="button" class="btn btn-sm btn-outline-primary btn-edit waves-effect"
                                        data-id="<?php echo e($price->id); ?>"
                                        data-power="<?php echo e($price->power); ?>"
                                        data-pm1="<?php echo e($price->price_pm1); ?>"
                                        data-pm2="<?php echo e($price->price_pm2); ?>"
                                        data-pm3="<?php echo e($price->price_pm3); ?>"
                                        data-pm4="<?php echo e($price->price_pm4); ?>">
                    ...
                    <tr class="detail-row d-none bg-light" id="detail-<?php echo e($price->id); ?>">
                                        ...
                                        <div class="col-md-3">
                                            <div class="p-2 border rounded bg-white h-100">
                                                <div class="fw-bold text-success border-bottom pb-1 mb-2 d-flex justify-content-between">
                                                    <span>PM 1</span>
                                                    <span>Rp <?php echo e(number_format($price->price_pm1, 0, ',', '.')); ?></span>
                                                </div>
                                                <div class="small mb-2">
                                                    <span class="fw-semibold text-muted d-block mb-1">Scope Kerja Penawaran:</span>
                                                    <div class="text-dark whitespace-pre-line bg-light p-2 rounded" style="white-space: pre-line; max-height: 120px; overflow-y: auto;"><?php echo e($price->desc_pm1 ?: ($defaultTemplate->desc_pm1 ?? '-')); ?></div>
                                                </div>
                                                <div class="small">
                                                    <span class="fw-semibold text-muted d-block mb-1">Remarks Quotation:</span>
                                                    <div class="text-muted fst-italic bg-light p-2 rounded" style="white-space: pre-line;"><?php echo e($price->note_pm1 ?: ($defaultTemplate->note_pm1 ?? '-')); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- PM2 -->
                                        <div class="col-md-3">
                                            <div class="p-2 border rounded bg-white h-100">
                                                <div class="fw-bold text-primary border-bottom pb-1 mb-2 d-flex justify-content-between">
                                                    <span>PM 2</span>
                                                    <span>Rp <?php echo e(number_format($price->price_pm2, 0, ',', '.')); ?></span>
                                                </div>
                                                <div class="small mb-2">
                                                    <span class="fw-semibold text-muted d-block mb-1">Scope Kerja Penawaran:</span>
                                                    <div class="text-dark whitespace-pre-line bg-light p-2 rounded" style="white-space: pre-line; max-height: 120px; overflow-y: auto;"><?php echo e($price->desc_pm2 ?: ($defaultTemplate->desc_pm2 ?? '-')); ?></div>
                                                </div>
                                                <div class="small">
                                                    <span class="fw-semibold text-muted d-block mb-1">Remarks Quotation:</span>
                                                    <div class="text-muted fst-italic bg-light p-2 rounded" style="white-space: pre-line;"><?php echo e($price->note_pm2 ?: ($defaultTemplate->note_pm2 ?? '-')); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- PM3 -->
                                        <div class="col-md-3">
                                            <div class="p-2 border rounded bg-white h-100">
                                                <div class="fw-bold text-warning border-bottom pb-1 mb-2 d-flex justify-content-between">
                                                    <span>PM 3</span>
                                                    <span>Rp <?php echo e(number_format($price->price_pm3, 0, ',', '.')); ?></span>
                                                </div>
                                                <div class="small mb-2">
                                                    <span class="fw-semibold text-muted d-block mb-1">Scope Kerja Penawaran:</span>
                                                    <div class="text-dark whitespace-pre-line bg-light p-2 rounded" style="white-space: pre-line; max-height: 120px; overflow-y: auto;"><?php echo e($price->desc_pm3 ?: ($defaultTemplate->desc_pm3 ?? '-')); ?></div>
                                                </div>
                                                <div class="small">
                                                    <span class="fw-semibold text-muted d-block mb-1">Remarks Quotation:</span>
                                                    <div class="text-muted fst-italic bg-light p-2 rounded" style="white-space: pre-line;"><?php echo e($price->note_pm3 ?: ($defaultTemplate->note_pm3 ?? '-')); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- PM4 -->
                                        <div class="col-md-3">
                                            <div class="p-2 border rounded bg-white h-100">
                                                <div class="fw-bold text-danger border-bottom pb-1 mb-2 d-flex justify-content-between">
                                                    <span>PM 4</span>
                                                    <span>Rp <?php echo e(number_format($price->price_pm4, 0, ',', '.')); ?></span>
                                                </div>
                                                <div class="small mb-2">
                                                    <span class="fw-semibold text-muted d-block mb-1">Scope Kerja Penawaran:</span>
                                                    <div class="text-dark whitespace-pre-line bg-light p-2 rounded" style="white-space: pre-line; max-height: 120px; overflow-y: auto;"><?php echo e($price->desc_pm4 ?: ($defaultTemplate->desc_pm4 ?? '-')); ?></div>
                                                </div>
                                                <div class="small">
                                                    <span class="fw-semibold text-muted d-block mb-1">Remarks Quotation:</span>
                                                    <div class="text-muted fst-italic bg-light p-2 rounded" style="white-space: pre-line;"><?php echo e($price->note_pm4 ?: ($defaultTemplate->note_pm4 ?? '-')); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<div class="modal fade" id="modalManagePrice" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            ...
            <form action="<?php echo e(route('forecast.prices.update')); ?>" method="POST" id="formManagePrice">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="row g-2">
                            <div class="col-12 mb-2">
                                <select class="form-select" id="powerSelect" name="power">
                                    ...
                                    <?php $__currentLoopData = $availablePowers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $power): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($power); ?>"><?php echo e($power); ?></option>
...
<div class="modal fade" id="modalStandardTemplate" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('forecast.prices.template')); ?>" method="POST" id="formStandardTemplate">
                <?php echo csrf_field(); ?>
                <div class="modal-body p-4">
                    <div class="row g-3">
                        <!-- PM 1 Template -->
                            ...
                            <div class="card h-100 border shadow-none" style="background: #fafcfe;">
                                ...
                                <div class="card-body p-3">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control form-control-sm desc-pm-bullet" id="tpl_desc_pm1" name="desc_pm1" rows="3" placeholder="Scope kerja PM1"><?php echo e($defaultTemplate->desc_pm1 ?? "• Pembersihan unit kompresor\n• Penggantian Air Filter & Oil Filter\n• Pengecekan temperatur & tekanan kerja"); ?></textarea>
                                    </div>
                                    <div>
                                        <label class="form-label fw-semibold small" for="tpl_note_pm1">Remarks Quotation PM 1</label>
                                        <textarea class="form-control form-control-sm" id="tpl_note_pm1" name="note_pm1" rows="2" placeholder="Catatan quotation PM1"><?php echo e($defaultTemplate->note_pm1 ?? "Scope pekerjaan jasa PM 1"); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card h-100 border shadow-none" style="background: #fafcfe;">
                                ...
                                <div class="card-body p-3">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control form-control-sm desc-pm-bullet" id="tpl_desc_pm2" name="desc_pm2" rows="3" placeholder="Scope kerja PM2"><?php echo e($defaultTemplate->desc_pm2 ?? "• Pembersihan unit kompresor\n• Penggantian Separator Filter & Oli Kompresor\n• General Health Check & Pengecekan arus listrik"); ?></textarea>
                                    </div>
                                    <div>
                                        <label class="form-label fw-semibold small" for="tpl_note_pm2">Remarks Quotation PM 2</label>
                                        <textarea class="form-control form-control-sm" id="tpl_note_pm2" name="note_pm2" rows="2" placeholder="Catatan quotation PM2"><?php echo e($defaultTemplate->note_pm2 ?? "Scope pekerjaan jasa PM 2"); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card h-100 border shadow-none" style="background: #fffdfa;">
                                ...
                                <div class="card-body p-3">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control form-control-sm desc-pm-bullet" id="tpl_desc_pm3" name="desc_pm3" rows="3" placeholder="Scope kerja PM3"><?php echo e($defaultTemplate->desc_pm3 ?? "• Scope PM 2\n• Flushing system & Pembersihan Carbon Remover\n• Pengecekan elemen pendingin"); ?></textarea>
                                    </div>
                                    <div>
                                        <label class="form-label fw-semibold small" for="tpl_note_pm3">Remarks Quotation PM 3</label>
                                        <textarea class="form-control form-control-sm" id="tpl_note_pm3" name="note_pm3" rows="2" placeholder="Catatan quotation PM3"><?php echo e($defaultTemplate->note_pm3 ?? "Scope pekerjaan jasa PM 3"); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card h-100 border shadow-none" style="background: #fffafa;">
                                ...
                                <div class="card-body p-3">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control form-control-sm desc-pm-bullet" id="tpl_desc_pm4" name="desc_pm4" rows="3" placeholder="Scope kerja PM4"><?php echo e($defaultTemplate->desc_pm4 ?? "• Overhaul Service & penggantian major kit\n• Kalibrasi elemen & bearing\n• Full testing & commissioning"); ?></textarea>
                                    </div>
                                    <div>
                                        <label class="form-label fw-semibold small" for="tpl_note_pm4">Remarks Quotation PM 4</label>
                                        <textarea class="form-control form-control-sm" id="tpl_note_pm4" name="note_pm4" rows="2" placeholder="Catatan quotation PM4"><?php echo e($defaultTemplate->note_pm4 ?? "Garansi service overhaul sesuai ketentuan berlaku"); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('.btn-delete').click(function() {
            ...
            var deleteUrl = "<?php echo e(url('/forecast/prices')); ?>/" + id;
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/sales/forecast/prices.blade.php ENDPATH**/ ?>