<?php $__env->startSection('title', 'Data Unit Global'); ?>
<?php $__env->startSection('content'); ?>
    <div class="d-flex justify-content-between align-items-center py-3 mb-4">
        <h4 class="fw-bold mb-0">
            <span class="text-muted fw-light">Warehouse /</span> Unit Global
        </h4>
        <?php if(in_array(Auth::user()->role, ['Admin', 'Logistic'])): ?>
...
<?php $__env->startPush('page-script'); ?>
    ...
    <script src="<?php echo e(asset('assets')); ?>/includes/table-unit-global.js"></script>
    <script src="<?php echo e(asset('assets')); ?>/includes/table-unit-piston-global.js"></script>
    <script src="<?php echo e(asset('assets')); ?>/includes/table-unit-dryer-global.js"></script>
    <script src="<?php echo e(asset('assets')); ?>/includes/table-unit-desiccant-global.js"></script>
    <script src="<?php echo e(asset('assets')); ?>/includes/table-unit-filtration-global.js"></script>
    <script src="<?php echo e(asset('assets')); ?>/includes/table-unit-tank-global.js"></script>
    <script src="<?php echo e(asset('assets')); ?>/includes/table-unit-booster-global.js"></script>
    <script src="<?php echo e(asset('assets')); ?>/js/forms-selects.js"></script>
<?php $__env->stopPush(); ?>


<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/warehouse/unit/index-global.blade.php ENDPATH**/ ?>