...
<?php $__env->startSection('content'); ?>
    ...
    <form id="formAuthentication" class="mb-3 fv-plugins-bootstrap5 fv-plugins-framework"
        action="<?php echo e(route('store-overhaul.quotation')); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
            ...
            <div class="card-body">
                    ...
                    <div class="col-12 col-lg-2">
                        <div class="form-floating form-floating-outline">
                            <input class="form-control" type="text" placeholder="Put Title Quotation Here ...."
                                id="title" name="title"
                                value="<?php echo e(old('title', @$quotation->title ??  $machine->brand . ' ' . $machine->sku)); ?>">
                ...
                <?php if(@$machine): ?>
                    <?php
                        ...
                        $dataDelete = 1;
                    ?>
                    <?php $__currentLoopData = $subTemplate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $title): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $dataDetail = 1;
                        ?>
                    ...
                    <div class="col-lg-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <p class="mb-0 subtotal-label" id="subtotal-label" data-main="1"
                                            data-id="1">
                                            <?php echo e(old('subtotal', $subtotal ? 'RP ' . number_format($subtotal, 0, '', '.') : '')); ?>

                                        </p>
                                        <input type="number" id="subtotal" class="form-control" name="subtotal"
                                            value="<?php echo e(old('subtotal', $subtotal ?? '')); ?>" hidden>
                        ...
                        <div class="card shadow-none bg-light text-secondary border border-secondary mb-3">
                            <input type="number" id="totalNoTax" name="total_no_tax"
                                value="<?php echo e(old('total_no_tax', @$quotation->total_no_tax ?? $totalPrice)); ?>" hidden>
                            <div class="card-body ">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <p class="mb-0 harga-total-label" id="hargaTotalLabel" data-main="1"
                                            data-id="1">
                                            <?php echo e(old('harga_total', $totalPrice ? 'RP ' . number_format($totalPrice, 0, '', '.') : '')); ?>

                                        </p>
                                        <input type="number" id="hargaTotal" class="form-control" name="harga_total"
                                            value="<?php echo e(old('harga_total', $totalPrice ?? '')); ?>" hidden>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/sales/quotation/overhaul/form.blade.php ENDPATH**/ ?>