                                            ...
                                            <tbody>
                                                ...
                                                <?php $__currentLoopData = $issue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $issues): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <pre class="mb-1"
                                                                style="font-size: 15px; font-family: 'Inter', Tahoma, Geneva, Verdana, sans-serif; max-width: 100%; overflow-x: auto;"><?php echo e($issues->desc); ?></pre>
                                                        </td>
                                                        <td><?php echo e($issues->pic->name); ?></td>
                                                    </tr>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <?php
                                                    $no = 0;
                                                ?>
                                                <?php $__currentLoopData = $monitoring; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php
                                                        $no++;
                                                    ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <pre class="mb-1"
                                                                style="font-size: 15px; font-family: 'Inter', Tahoma, Geneva, Verdana, sans-serif; max-width: 100%; overflow-x: auto;"><?php echo e($item->main_desc); ?></pre>
                                                        </td>
...
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/monitoring/maintenance-log.blade.php ENDPATH**/ ?>