...
<?php $__env->startSection('content'); ?>
            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="d-flex align-items-center gap-2 mb-2 flex-wrap">
                        ...
                        ?>
                        <span class="badge <?php echo e($statusBadge); ?> fw-bold"><i class="mdi mdi-checkbox-marked-circle-outline me-1"></i> <?php echo e($statusName); ?></span>
                    </div>
                    <h3 class="fw-bold mb-1 text-white"><?php echo e($quotation->pic->client->company); ?></h3>
                    <p class="mb-0 opacity-80 small">
                        <i class="mdi mdi-tag-outline me-1"></i> No SO: <span class="fw-semibold text-white"><?php echo e($pending->no_pending); ?></span>
                        <span class="mx-2">|</span>
                        <i class="mdi mdi-calendar-blank-outline me-1"></i> Tanggal: <span class="fw-semibold text-white"><?php echo e(\Carbon\Carbon::parse($pending->date)->format('d M Y')); ?></span>
                    </p>
                </div>
                <div class="col-md-4 text-md-end mt-3 mt-md-0 d-flex flex-column flex-md-row justify-content-md-end gap-2 align-items-md-center">
                    <?php if($pending->status != '6' && $pending->status != '8' && $pending->status != '9'): ?>
                        <div class="btn-group">
                            <button type="button" class="btn btn-outline-light dropdown-toggle waves-effect waves-light text-white"
                                data-bs-toggle="dropdown" aria-expanded="false" <?php echo e((auth()->user()->role != 'Sales' && $isInvoiceApproved) ? '' : 'disabled'); ?>>
                    ...
                    <?php elseif($pending->status == '6'): ?>
                        <?php if($pending->id_product_out == null): ?>
                            <button type="button" class="btn btn-danger waves-effect waves-light border-0" data-bs-toggle="modal" data-bs-target="#inputProductOut"
                                <?php echo e((auth()->user()->role != 'Sales' && $isInvoiceApproved) ? '' : 'disabled'); ?>>
                        ...
                        <?php else: ?>
                            <button type="button" class="btn btn-outline-light waves-effect waves-light text-white" data-bs-toggle="modal" data-bs-target="#productReturn"
                                <?php echo e(auth()->user()->role != 'Sales' ? '' : 'disabled'); ?>>
                                <i class="mdi mdi-arrow-u-left-bottom me-1"></i> Retur Barang
                            </button>
                        <?php endif; ?>
                    <?php elseif($pending->status == '9'): ?>
                        <button type="button" class="btn btn-success done-po waves-effect waves-light border-0 text-white" data-id="<?php echo e($pending->id); ?>"
                            <?php echo e((auth()->user()->role != 'Sales' && $isInvoiceApproved) ? '' : 'disabled'); ?>>
    ...
    <div class="tab-content p-0 border-0 bg-transparent" id="orderDetailTabsContent">
                        ...
                        <div class="card-body pt-3">
                            <div class="d-flex align-items-center mb-3 p-2 rounded hover-light">
                                ...
                                <div>
                                    ...
                                    <span class="fw-semibold text-dark"><?php echo e($quotation->sales->name); ?></span>
                                </div>
                            </div>
                            <div class="d-flex align-items-center mb-3 p-2 rounded hover-light">
                                ...
                                <div>
                                    ...
                                    <span class="fw-semibold text-dark"><?php echo e($quotation->pic->client->company); ?></span>
                                </div>
                            </div>
                            <div class="d-flex align-items-center mb-3 p-2 rounded hover-light">
                                ...
                                <div>
                                    ...
                                    <span class="fw-semibold text-dark"><?php echo e($quotation->pic->name_pic); ?></span>
                                </div>
                            </div>
                            <div class="d-flex align-items-center mb-3 p-2 rounded hover-light">
                                ...
                                <div>
                                    ...
                                    <span class="badge bg-label-info fw-semibold"><?php echo e($quotation->pic->client->info ?? '-'); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-start mb-3 p-2 rounded hover-light border-top pt-3">
                                ...
                                <div class="text-wrap" style="max-width: calc(100% - 50px);">
                                    ...
                                    <?php if(($pending->doc_address_type ?? 'customer') === 'customer'): ?>
                                        <span class="badge bg-label-secondary mb-1 btn-xs" style="font-size: 9px; padding: 2px 4px;">Sesuai Customer</span>
                                        <span class="fw-semibold text-dark d-block" style="font-size: 12px; line-height: 1.4;"><?php echo e($quotation->pic->client->address); ?></span>
                                    <?php else: ?>
                                        <span class="badge bg-label-warning mb-1 btn-xs" style="font-size: 9px; padding: 2px 4px;">Manual</span>
                                        <span class="fw-semibold text-dark d-block" style="font-size: 12px; line-height: 1.4;"><?php echo e($pending->doc_address_manual); ?></span>
                                    <?php endif; ?>
                                    <?php if($docChargeText): ?>
                                        <span class="badge <?php echo e($docChargeClass); ?> fw-semibold mt-1 btn-xs" style="font-size: 9px; padding: 2px 4px;">Charged to: <?php echo e($docChargeText); ?></span>
                                    <?php endif; ?>
                                    <?php if($pending->doc_recipient): ?>
                                        <span class="badge bg-label-info fw-semibold mt-1 btn-xs" style="font-size: 9px; padding: 2px 4px;">Penerima: <?php echo e($pending->doc_recipient->name_pic); ?> | Telp: <?php echo e($pending->doc_recipient->phone ?? '-'); ?></span>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-start mb-3 p-2 rounded hover-light">
                                ...
                                <div class="text-wrap" style="max-width: calc(100% - 50px);">
                                    ...
                                    <?php if(($pending->shipping_address_type ?? 'customer') === 'customer'): ?>
                                        <span class="badge bg-label-secondary mb-1 btn-xs" style="font-size: 9px; padding: 2px 4px;">Sesuai Customer</span>
                                        <span class="fw-semibold text-dark d-block" style="font-size: 12px; line-height: 1.4;"><?php echo e($quotation->pic->client->address); ?></span>
                                    <?php else: ?>
                                        <span class="badge bg-label-warning mb-1 btn-xs" style="font-size: 9px; padding: 2px 4px;">Manual</span>
                                        <span class="fw-semibold text-dark d-block" style="font-size: 12px; line-height: 1.4;"><?php echo e($pending->shipping_address_manual); ?></span>
                                    <?php endif; ?>
                                    <?php if($shippingChargeText): ?>
                                        <span class="badge <?php echo e($shippingChargeClass); ?> fw-semibold mt-1 btn-xs" style="font-size: 9px; padding: 2px 4px;">Charged to: <?php echo e($shippingChargeText); ?></span>
                                    <?php endif; ?>
                                    <?php if($pending->shipping_recipient): ?>
                                        <span class="badge bg-label-info fw-semibold mt-1 btn-xs" style="font-size: 9px; padding: 2px 4px;">Penerima: <?php echo e($pending->shipping_recipient->name_pic); ?> | Telp: <?php echo e($pending->shipping_recipient->phone ?? '-'); ?></span>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center mb-3 p-2 rounded hover-light">
                                ...
                                <div>
                                    ...
                                    <span class="badge <?php echo e($pending->combine_shipping_and_parts ? 'bg-label-success' : 'bg-label-danger'); ?> fw-semibold" style="font-size: 10px; padding: 3px 6px;">
                                        <?php echo e($pending->combine_shipping_and_parts ? 'Barang & Part Digabung' : 'Barang & Part Dipisah'); ?>
                            ...
                            <?php if($pending->status != '6' && $pending->status != '8' && $pending->status != '9'): ?>
                                ...
                                <form action="<?php echo e(route('pending-po.changeType', $pending->id)); ?>" method="POST" class="mt-3 pt-2 border-top">
                                    <?php echo csrf_field(); ?>
                        ...
                        <div class="card-body pt-3">
                            ...
                            <div class="d-flex align-items-center mb-3 p-2 rounded hover-light">
                                ...
                                <div>
                                    ...
                                    <a class="fw-bold text-primary" href="<?php echo e(route($link, $quotation->id)); ?>">
                            ...
                            <div class="d-flex align-items-center mb-3 p-2 rounded hover-light">
                                ...
                                <div>
                                    ...
                                    <?php if(@$invoice->no_invoice): ?>
                                        <a class="fw-bold text-success" href="<?php echo e(route('invoice.show', $invoice->id)); ?>">
                            ...
                            <div class="d-flex align-items-center mb-3 p-2 rounded hover-light">
                                ...
                                <div>
                                    ...
                                    <?php if(@$invoice->no_po): ?>
                                        <span class="fw-bold text-dark"><?php echo e($invoice->no_po); ?></span>
                                    <?php else: ?>
                            ...
                            <div class="d-flex align-items-center mb-3 p-2 rounded hover-light">
                                ...
                                <div>
                                    ...
                                    <?php if($invoice): ?>
                                        <span class="badge <?php echo e($invoice->status_p == 1 ? 'bg-label-success' : 'bg-label-danger'); ?> fw-semibold">
                                            <?php echo e($invoice->status_p == 1 ? 'Payment Confirmed' : 'Unpaid'); ?>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card h-100 shadow-sm border-0">
                        <div class="card-header pb-2 border-bottom py-3 d-flex justify-content-between align-items-center">
                            ...
                            <?php if($pending->status != '6' && $pending->status != '8' && $pending->status != '9' && $isInvoiceApproved): ?>
                        ...
                        <div class="card-body pt-3 d-flex flex-column" style="max-height: 450px; overflow-y: auto;">
                            ...
                            <div class="d-flex align-items-center mb-3 p-2 rounded hover-light">
                                ...
                                <div>
                                    ...
                                    <span class="fw-semibold text-dark"><?php echo e($kurir); ?></span>
                                </div>
                            </div>

                            <!-- Rincian Ongkir & Resi -->
                            <h6 class="fw-bold text-dark mt-2 mb-2 border-bottom pb-1" style="font-size: 13px;">Daftar Resi & Ongkos Kirim:</h6>
                            <?php $__empty_1 = true; $__currentLoopData = $resis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="mb-3 p-2 rounded bg-label-light border border-light hover-light position-relative">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <span class="fw-bold text-dark fs-7"><?php echo e($r->no_track ?? '-'); ?></span>
                                        </div>
                                    </div>
                                    <?php if($r->note): ?>
                                        <div class="mt-1">
                                            <small class="text-muted d-block" style="font-size: 10px;">Catatan Kurir</small>
                                            <p class="mb-0 text-muted small" style="line-height: 1.3;"><?php echo e($r->note); ?></p>
                                        </div>
                                    <?php endif; ?>
                                    <div class="d-flex justify-content-between align-items-center mt-2 border-top pt-2">
                                        <span class="fw-bold text-primary" style="font-size: 12px;">Rp <?php echo e(number_format($r->cost ?? 0, 0, '.', ',')); ?></span>
                                        <div class="d-flex gap-1">
                                            <?php if($r->image): ?>
                                                <a href="#" onclick="openPdfViewer('<?php echo e(url($r->image)); ?>', 'Resi <?php echo e($r->no_track); ?>'); return false;" class="btn btn-xs btn-outline-primary px-2" style="font-size: 10px; padding: 2px 4px;">
                                                    <i class="mdi mdi-image-outline"></i> Resi
                                                </a>
                                            <?php endif; ?>
                                            <?php if($pending->status != '6' && $pending->status != '8' && $pending->status != '9'): ?>
                                                <a href="#" data-id="<?php echo e($r->id); ?>" data-pending="<?php echo e($pending->id); ?>" class="btn btn-xs btn-outline-danger delete-resi px-2" style="font-size: 10px; padding: 2px 4px;">
                ...
                <div class="card mb-4 shadow-sm border-0">
                    ...
                    <div class="card-body pt-4">
                        <ul class="timeline card-timeline mb-0">
                            <?php $__currentLoopData = $activity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stats): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    switch ($stats->status) {
                                ...
                                <li class="timeline-item timeline-item-transparent clearfix">
                                    ...
                                    <div class="timeline-event">
                                        <div class="timeline-header mb-1">
                                            <h6 class="mb-0 fw-bold text-dark">Status: <span class="badge bg-label-<?php echo e($color); ?> btn-xs"><?php echo e($st); ?></span></h6>
                                            <small class="text-muted"><?php echo e($stats->created_at->diffForHumans()); ?> (<?php echo e($stats->created_at->format('d M Y H:i')); ?>)</small>
                                        </div>
                                        <p class="mb-2 small text-muted">Diperbarui oleh: <span class="fw-semibold text-dark"><?php echo e($stats->user->name ?? 'System'); ?></span></p>
                                        
                                        <!-- Comments list inside timeline item -->
                                        <div class="ms-3 border-start ps-3 py-1">
                                            <?php $__currentLoopData = $stats->comment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $com): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="mb-2 p-2 rounded bg-light hover-light border border-light position-relative">
                                                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                                                        <span class="fw-bold text-dark" style="font-size: 12px;"><?php echo e($com->user->name); ?></span>
                                                        <small class="text-muted" style="font-size: 10px;"><?php echo e($com->date); ?></small>
                                                    </div>
                                                    <p class="mb-0 text-muted mt-1" style="font-size: 12px; line-height: 1.4;"><?php echo e($com->comment); ?></p>
                                                    <?php if($com->id_user == Auth::id()): ?>
                                                        <a href="#" data-id="<?php echo e($com->id); ?>" data-pending="<?php echo e($pending->id); ?>" class="delete-comment position-absolute text-danger" style="top: 8px; right: 8px;" title="Hapus Komentar">
                                ...
                                <?php if($stats->id == $lastStat->id && $pending->status != '6'): ?>
                                    <form action="<?php echo e(route('pending-po.addComment', $pending->id)); ?>" method="post" enctype="multipart/form-data" class="mb-4">
                                        <?php echo csrf_field(); ?>
        ...
        <div class="tab-pane fade" id="logistic-pane" role="tabpanel" aria-labelledby="logistic-tab">
            <?php if($pending->type == 'Project'): ?>
                <?php if($pending->status != '6' && $pending->status != '8'): ?>
                    <div class="d-flex justify-content-end mb-3 gap-2">
                        <button type="button" class="btn btn-outline-warning" data-bs-toggle="modal"
                            data-bs-target="#replacementEdit" <?php echo e(auth()->user()->role != 'Sales' ? '' : 'disabled'); ?>>
                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = $subQuote; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subJudul): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr class="table-secondary">
                                        <td class="align-middle fw-bold text-center"><?php echo e(chr($abjad)); ?></td>
                                        <td colspan="5" class="align-middle fw-bold"><?php echo e($subJudul->subtitle); ?></td>
                                    </tr>
                                    <?php $__currentLoopData = $subJudul->detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                        <tr>
                                            <td class="text-center"><?php $no++; ?> <?php echo e($no); ?></td>
                                            <td class="fw-semibold text-wrap" style="max-width: 250px;"><?php echo e($product->product); ?></td>
                                            <td class="text-wrap" style="max-width: 350px;">
                                                <?php if($product->detail != '-'): ?>
                                                    <pre class="mb-0 text-muted" style="font-family: inherit; font-size: 13px; white-space: pre-wrap;"><?php echo e($product->detail); ?></pre>
                                                <?php else: ?>
                                                    -
                                                <?php endif; ?>
                                            </td>
                                            ...
                                            <td>
                                                <span class="badge <?php echo e($pending->status == '6' ? 'bg-label-success' : $badge); ?>">
                                                    <?php echo e($pending->status == '6' ? 'Done' : $status); ?>

                                                </span>
                                            </td>
                                            <td class="text-wrap" style="max-width: 250px;"><?php echo e($product->pending[0]->note ?? '-'); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
                ...
                <?php if($pending->status != '6' && $pending->status != '8'): ?>
                    <div class="d-flex justify-content-end mb-3 mt-3 gap-2">
                        <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal"
                            data-bs-target="#purchaseReqPrj" <?php echo e(auth()->user()->role != 'Sales' ? '' : 'disabled'); ?>>
                ...
                <div class="card mb-4 shadow-sm border-0">
                    ...
                    <div class="table-responsive text-nowrap">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                <?php $no = 1; ?>
                                <?php $__empty_1 = true; $__currentLoopData = $purchase; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <?php
                                        switch ($pr->status) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="fw-bold"><a href="<?php echo e(route('purchase-request.show', $pr->id_pending)); ?>" class="text-primary"><?php echo e($pr->no_pr ?? '-'); ?></a></td>
                                        <td>
                                            <?php if($pr->id_equivalent == '0'): ?>
                                                -
                                            <?php else: ?>
                                                <?php echo e($pr->equivalent->brand ?? ''); ?> <?php echo e($pr->equivalent->pn ?? ''); ?>

                                            <?php endif; ?>
                                        </td>
                                        <td><?php echo e($pr->qty); ?> <?php echo e($pr->equivalent->product->unit ?? ''); ?></td>
                                        <td class="text-wrap" style="max-width: 250px;"><?php echo e($pr->note ?? '-'); ?></td>
                                        <td><span class="badge <?php echo e($color_pr); ?>"><?php echo e($status_pr); ?></span></td>
                                        <td class="text-center">
                                            <button data-id="<?php echo e($pr->id); ?>" data-pending="<?php echo e($pending->id); ?>"
                                                data-qty="<?php echo e($pr->qty); ?>" data-note="<?php echo e($pr->note); ?>"
            ...
            <?php else: ?>
                <?php if($pending->status != '6' && $pending->status != '8'): ?>
                    <div class="d-flex justify-content-end mb-3 gap-2">
                        <button type="button" class="btn btn-outline-warning" data-bs-toggle="modal"
                            data-bs-target="#productEdit" <?php echo e(auth()->user()->role != 'Sales' ? '' : 'disabled'); ?>>
                            <i class="mdi mdi-list-status me-1"></i> Update Status Barang
                        </button>
                    </div>
                <?php endif; ?>
                                ...
                                <?php $__currentLoopData = $detQuotation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr style="font-size: 13px">
                                        ...
                                        <td class="fw-semibold">
                                            <?php if($item->id_equivalent == '0'): ?>
                                                -
                                            <?php else: ?>
                                                <?php echo e($item->equivalent->brand ?? ''); ?> <?php echo e($item->equivalent->pn ?? ''); ?>

                                            <?php endif; ?>
                                        </td>
                                        <td class="text-wrap" style="max-width: 350px;">
                                            <pre class="mb-0 text-muted" style="font-family: inherit; font-size: 13px; white-space: pre-wrap;"><?php echo e($item->detail_product); ?></pre>
                                        </td>
                                        <td><?php echo e($item->equivalent->product->go ?? '-'); ?></td>
                                        ...
                                        <td>
                                            ...
                                            <?php if($pending->status != '6' && $pending->status != '8' && $item->id_equivalent != '0'): ?>
                                                <?php
                                                ...
                                                <div class="mt-1" style="font-size: 10px;">
                                                    <?php if($item->status == '1' || is_null($item->status)): ?>
                                                        <?php if($isEnough): ?>
                                                        ...
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                    <span class="text-muted d-block" style="font-size: 9px; line-height: 1.2;">BDG: <?php echo e($bdgStock); ?> | BKS: <?php echo e($bksStock); ?> (Total: <?php echo e($totalStock); ?>)</span>
                                                </div>
                                            <?php elseif($item->id_equivalent != '0'): ?>
                                                <?php
                                                    $bdgStock = $item->equivalent->product->stock ?? 0;
                                                    $bksStock = $item->equivalent->product->warehouse_stock ?? 0;
                                                ?>
                                                <span class="text-muted d-block mt-1" style="font-size: 9px; line-height: 1.2;">Stock: BDG <?php echo e($bdgStock); ?> | BKS <?php echo e($bksStock); ?></span>
                                            <?php endif; ?>
                                        </td>
                                        <td class="text-wrap" style="max-width: 200px;"><?php echo e($pending->status == '6' ? 'Done' : ($item->note ?? '-')); ?></td>
                                    </tr>
                                    <?php $no++; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
                ...
                <?php if($pending->status != '6' && $pending->status != '8'): ?>
                    <div class="d-flex justify-content-end mb-3 mt-3 gap-2">
                        <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal"
                            data-bs-target="#purchaseReq" <?php echo e(auth()->user()->role != 'Sales' ? '' : 'disabled'); ?>>
                            <i class="mdi mdi-plus-box me-1"></i> Purchase Request
                        </button>
                    </div>
                <?php endif; ?>
                ...
                <div class="card mb-4 shadow-sm border">
                    <div class="card-header bg-light py-3 border-bottom d-flex justify-content-between align-items-center">
                        ...
                        <a href="#" class="btn btn-sm btn-outline-danger clear-return waves-effect" data-id="<?php echo e($pending->id); ?>">
                            ...
                            <tbody>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $return; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $retur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="text-center"><?php echo e($no); ?></td>
                                        <td>
                                            <a href="<?php echo e(route('return.show', $retur->id)); ?>" class="fw-bold text-primary">
                                                <?php echo e($retur->no_return); ?>

                                            </a>
                                        </td>
                                        <td><?php echo e($retur->product_in->no_do ?? 'Belum Ada Product In'); ?></td>
                                        <td><?php echo e($retur->date); ?></td>
                                        <td><?php echo e($retur->date_done ?? '-'); ?></td>
                                    </tr>
                                    <?php $no++; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <tr>
            ...
            <?php if($pending->status == '6' && $pending->id_product_out != null): ?>
                <div class="card invoice-preview-card border shadow-sm mb-4">
                    <div class="card-header bg-light py-3 border-bottom d-flex justify-content-between align-items-center flex-wrap gap-2">
                        <h5 class="m-0 fw-bold text-success"><i class="mdi mdi-file-document-check-outline me-1"></i> Surat Jalan Barang Keluar (<?php echo e($product->vers); ?>)</h5>
                        <h6 class="m-0 fw-semibold text-muted">#<?php echo e($product->no_type == '1' ? $product->invoice : $product->po); ?></h6>
                    </div>
                    <div class="card-body pt-3">
                        <div class="row gy-3">
                            <div class="col-md-6">
                                <span class="text-muted fw-semibold d-block mb-1">Customers / Alamat Pengiriman:</span>
                                <pre class="mb-0 text-dark fw-medium p-2 bg-light rounded border text-wrap" style="font-family: inherit; font-size: 14px;"><?php echo e($product->detail_client); ?></pre>
                            </div>
                            <div class="col-md-3">
                                <span class="text-muted fw-semibold d-block mb-1">Tanggal Keluar:</span>
                                <p class="mb-0 fw-medium text-dark"><i class="mdi mdi-calendar-range me-1"></i> <?php echo e(Carbon\Carbon::parse($product->date)->format('d-m-Y')); ?></p>
                            </div>
                            <div class="col-md-3">
                                <span class="text-muted fw-semibold d-block mb-1">Dibuat Oleh:</span>
                                <p class="mb-0 fw-medium text-dark"><i class="mdi mdi-account-circle-outline me-1"></i> <?php echo e($product->user->name); ?></p>
                            </div>
                            <?php if($product->note): ?>
                                <div class="col-12">
                                    <span class="text-muted fw-semibold d-block mb-1">Catatan Tambahan:</span>
                                    <pre class="mb-0 text-muted p-2 bg-light rounded border text-wrap" style="font-family: inherit; font-size: 13px;"><?php echo e($product->note); ?></pre>
                                </div>
                            <?php endif; ?>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = $detProduct; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $products): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="text-center"><?php echo e($no); ?></td>
                                            <td>
                                                <p class="mb-0 fw-semibold text-primary"><?php echo e($products->detailProduct->replacement); ?></p>
                                                <small class="text-muted"><?php echo e($products->detailProduct->product->description); ?></small>
                                            </td>
                                            <td><?php echo e($products->qty); ?> <?php echo e($products->detailProduct->product->unit); ?></td>
                                            <td>Rp <?php echo e(number_format($products->price, 0, ',', '.')); ?></td>
                                            <td class="fw-bold">Rp <?php echo e(number_format($products->amount, 0, ',', '.')); ?></td>
                                        </tr>
                                        <?php $no++; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="table-light">
                                        ...
                                        <td class="fw-bold">: Rp <?php echo e(number_format($product->shipping, 0, ',', '.')); ?></td>
                                    </tr>
                                    <tr class="table-light">
                                        <td colspan="3" class="border-0"></td>
                                        <td class="fw-semibold border-top text-primary">Grand Total</td>
                                        <td class="fw-bold border-top text-primary">: Rp <?php echo e(number_format($product->total, 0, ',', '.')); ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <div class="card invoice-preview-card mb-4 border">
                    <div class="card-body">
                        <div class="d-flex justify-content-between flex-xl-row flex-md-column flex-sm-row flex-column">
                            ...
                            <div class="text-end">
                                <h3 class="fw-bold">Barang Keluar (<?php echo e($product->vers); ?>)</h3>
                                <div>
                                    <span
                                        class="fw-bolder">#<?php echo e($product->no_type == '1' ? $product->invoice : $product->po); ?></span>
                                </div>
                                <div class="mt-1">
                    ...
                    <div class="card-body mb-3">
                        <div class="row">
                            ...
                            <div class="col-8 col-lg-10">
                                <pre class="mb-1"
                                    style="font-size: 15px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 100%; overflow-x: auto; white-space: pre-wrap;">: <?php echo e($product->detail_client); ?></pre>
                            </div>
                        </div>
                    </div>
                    <hr class="my-0">
                    <div class="card-body mb-3">
                        <div class="row">
                            ...
                            <div class="col-8 col-lg-6">
                                <pre
                                    style="font-size: 15px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; overflow-x: auto; white-space: pre-wrap;">: <?php echo e($product->note); ?></pre>
                            </div>
                            <div class="col-4 col-lg-2 fw-medium">
                                <p class="mb-1">User</p>
                            </div>
                            <div class="col-8 col-lg-2">
                                <p class="mb-1">: <?php echo e($product->user->name); ?></p>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = $detProduct; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $products): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr style="font-size: 13px">
                                        ...
                                        <td class="align-top">RP <?php echo e(number_format($products->price, 0, '', '.')); ?></td>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row g-3">
                        <div class="col-12 col-md-4">
                            <div class="p-3 bg-white rounded border border-light shadow-sm">
                                ...
                                <h4 class="fw-bold text-success mb-0">Rp <?php echo e(number_format($quotation->nett, 0, ',', '.')); ?></h4>
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                            <div class="p-3 bg-white rounded border border-light shadow-sm">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="p-3 bg-white rounded border border-light shadow-sm">
                                ...
                                <h4 class="fw-bold <?php echo e($estimatedProfit >= 0 ? 'text-primary' : 'text-danger'); ?> mb-0">
                                    Rp <?php echo e(number_format($estimatedProfit, 0, ',', '.')); ?>
                    ...
                    <div>
                        ...
                        <div class="d-flex justify-content-between mt-2 text-muted small" style="font-size: 11px;">
                            <span>Biaya Operasional &amp; Material: <?php echo e(number_format($costRatio, 1)); ?>%</span>
                            <span>Margin Keuntungan: <?php echo e(number_format($profitRatio, 1)); ?>%</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <?php echo $__env->make('components.modal.pending.status', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('components.modal.pending.kurir', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('components.modal.pending.product', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('components.modal.pending.product-out', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('components.modal.pending.project', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('components.modal.pending.return', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('components.modal.pending.resi', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('components.modal.viewer.pdf', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php if($pending->type == 'Project'): ?>
        <?php echo $__env->make('components.modal.pending.request-project', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php else: ?>
        <?php echo $__env->make('components.modal.pending.request', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
    ...
    <div class="modal fade animate__animated" id="editAddresses" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <form action="<?php echo e(route('pending-po.updateAddresses', $pending->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="modal-header border-bottom">
                        ...
                        <div class="mb-4 p-3 bg-label-light rounded border">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="form-check form-switch mb-0">
                                    <input class="form-check-input" type="checkbox" name="combine_shipping_and_parts" id="detail_combine_shipping_and_parts" value="1" <?php echo e(($pending->combine_shipping_and_parts ?? true) ? 'checked' : ''); ?> onchange="toggleAddressLayout('detail')">
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="detail_combined_address_section" class="col-12">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select mb-2" id="detail_combined_address_select" onchange="onAddressSelectChange('detail', 'combined')">
                                        <option value="customer" <?php echo e(($pending->shipping_address_type ?? 'customer') === 'customer' ? 'selected' : ''); ?>>Main Address: <?php echo e($quotation->pic->client->address); ?></option>
                                        <?php $__currentLoopData = $quotation->pic->client->plants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($plant->address); ?>" <?php echo e(($pending->shipping_address_type === 'manual' && $pending->shipping_address_manual === $plant->address) ? 'selected' : ''); ?>>Plant: <?php echo e($plant->name); ?> (<?php echo e($plant->address); ?>)</option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <option value="manual" <?php echo e(($pending->shipping_address_type === 'manual' && !in_array($pending->shipping_address_manual, $quotation->pic->client->plants->pluck('address')->toArray())) ? 'selected' : ''); ?>>-- Alamat Lain (Isi Manual) --</option>
                                    </select>
                                    
                                    <div id="detail_combined_manual_wrapper" class="d-none mt-2">
                                        <textarea class="form-control" name="shipping_address_manual" id="detail_combined_address_manual" rows="3" placeholder="Masukkan alamat manual lengkap..."><?php echo e($pending->shipping_address_manual); ?></textarea>
                                    </div>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <select class="form-select" id="detail_combined_recipient_select">
                                            <?php $__currentLoopData = $quotation->pic->client->pic; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c_pic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($c_pic->id); ?>" <?php echo e($pending->shipping_recipient_id == $c_pic->id ? 'selected' : ''); ?>>
                                                    <?php echo e($c_pic->name_pic); ?> <?php echo e($c_pic->posisi ? '(' . $c_pic->posisi . ')' : ''); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 pe-md-3 border-end">
                                        ...
                                        <select class="form-select mb-2" id="detail_doc_address_select" onchange="onAddressSelectChange('detail', 'doc')">
                                            <option value="customer" <?php echo e(($pending->doc_address_type ?? 'customer') === 'customer' ? 'selected' : ''); ?>>Main Address: <?php echo e($quotation->pic->client->address); ?></option>
                                            <?php $__currentLoopData = $quotation->pic->client->plants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($plant->address); ?>" <?php echo e(($pending->doc_address_type === 'manual' && $pending->doc_address_manual === $plant->address) ? 'selected' : ''); ?>>Plant: <?php echo e($plant->name); ?> (<?php echo e($plant->address); ?>)</option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <option value="manual" <?php echo e(($pending->doc_address_type === 'manual' && !in_array($pending->doc_address_manual, $quotation->pic->client->plants->pluck('address')->toArray())) ? 'selected' : ''); ?>>-- Alamat Lain (Isi Manual) --</option>
                                        </select>
                                        
                                        <div id="detail_doc_manual_wrapper" class="d-none mt-2">
                                            <textarea class="form-control" name="doc_address_manual" id="detail_doc_address_manual" rows="3" placeholder="Masukkan alamat dokumen manual..."><?php echo e($pending->doc_address_manual); ?></textarea>
                                        </div>
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <select class="form-select" id="detail_doc_recipient_select">
                                                <?php $__currentLoopData = $quotation->pic->client->pic; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c_pic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($c_pic->id); ?>" <?php echo e($pending->doc_recipient_id == $c_pic->id ? 'selected' : ''); ?>>
                                                        <?php echo e($c_pic->name_pic); ?> <?php echo e($c_pic->posisi ? '(' . $c_pic->posisi . ')' : ''); ?>
                                    ...
                                    <div class="col-md-6 ps-md-3">
                                        ...
                                        <div id="detail_shipping_manual_wrapper" class="d-none mt-2">
                                            <textarea class="form-control" name="shipping_address_manual" id="detail_shipping_address_manual" rows="3" placeholder="Masukkan alamat barang manual..."><?php echo e($pending->shipping_address_manual); ?></textarea>
                                        </div>
...
<?php $__env->startPush('page-script'); ?>
    ...
    <script src="<?php echo e(asset('assets')); ?>/includes/table-pending-non-project-admin.js"></script>
    ...
    <script>
        ...
        $(document).on('click', '.delete-resi', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        'url': '<?php echo e(url('pending-po')); ?>/delete-resi/' + id,
                        'type': 'DELETE',
                        'data': {
                            '_method': 'DELETE',
                            '_token': '<?php echo e(csrf_token()); ?>'
        ...
        $(document).on('click', '.delete-request', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        'url': '<?php echo e(url('purchase-request')); ?>/delete/' + id,
                        'type': 'DELETE',
                        'data': {
                            '_method': 'DELETE',
                            '_token': '<?php echo e(csrf_token()); ?>'
        ...
        $(document).on('click', '.edit-request', function() {
            ...
            var $form = $('#editPrForm');
            $form.attr('action', '<?php echo e(url('purchase-request')); ?>/update/' + id);
        ...
        $(document).on('click', '.clear-return', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        'url': '<?php echo e(url('pending-po')); ?>/clear-return/' + id,
                        'type': 'POST',
                        'data': {
                            '_method': 'POST',
                            '_token': '<?php echo e(csrf_token()); ?>'
        ...
        $(document).on('click', '.done-po', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        'url': '<?php echo e(url('pending-po')); ?>/done/' + id,
                        'type': 'POST',
                        'data': {
                            '_method': 'POST',
                            '_token': '<?php echo e(csrf_token()); ?>'
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/pending/detail.blade.php ENDPATH**/ ?>