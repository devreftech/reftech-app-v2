...
<?php $__env->startSection('content'); ?>
                            ...
                            <div class="card shadow-none bg-transparent border border-primary mb-3" data-bs-toggle="modal" data-bs-target="#detailOutstanding">
                                <div class="card-body">
                                    ...
                                    <h2 class="card-text text-primary">Rp.
                                        <?php echo e(number_format($invoice->sum('amount', 0, '.', ','))); ?>
                            ...
                            <div class="card shadow-none bg-transparent border border-danger mb-3" data-bs-toggle="modal" data-bs-target="#detailOverdue">
                                <div class="card-body">
                                    ...
                                    <h2 class="card-text text-danger">Rp.
                                        <?php echo e(number_format($overdue->sum('amount', 0, '.', ','))); ?>
                            ...
                            <div class="card shadow-none bg-transparent border border-success mb-3" data-bs-toggle="modal" data-bs-target="#detailOnDue">
                                <div class="card-body">
                                    ...
                                    <h2 class="card-text text-success">Rp.
                                        <?php echo e(number_format($ondue->sum('amount', 0, '.', ','))); ?>
                        ...
                        <div class="col-4">
                            <div class="card shadow-none bg-transparent border border-primary mb-3">
                                <div class="card-body">
                                    <h5 class="card-title">Total Outstanding</h5>
                                    <h2 class="card-text text-primary">Rp.
                                        <?php echo e(number_format($invoice->where('info', 'Reftech')->sum('amount', 0, '.', ','))); ?>
                        ...
                        <div class="col-4">
                            <div class="card shadow-none bg-transparent border border-danger mb-3">
                                <div class="card-body">
                                    <h5 class="card-title">Total Overdue</h5>
                                    <h2 class="card-text text-danger">Rp.
                                        <?php echo e(number_format($overdue->where('info', 'Reftech')->sum('amount', 0, '.', ','))); ?>
                        ...
                        <div class="col-4">
                            <div class="card shadow-none bg-transparent border border-success mb-3">
                                <div class="card-body">
                                    <h5 class="card-title">Total On Due</h5>
                                    <h2 class="card-text text-success">Rp.
                                        <?php echo e(number_format($ondue->where('info', 'Reftech')->sum('amount', 0, '.', ','))); ?>
                        ...
                        <div class="col-4">
                            <div class="card shadow-none bg-transparent border border-primary mb-3">
                                <div class="card-body">
                                    <h5 class="card-title">Total Outstanding</h5>
                                    <h2 class="card-text text-primary">Rp.
                                        <?php echo e(number_format($invoice->where('info', 'Kojisha')->sum('amount', 0, '.', ','))); ?>
                        ...
                        <div class="col-4">
                            <div class="card shadow-none bg-transparent border border-danger mb-3">
                                <div class="card-body">
                                    <h5 class="card-title">Total Overdue</h5>
                                    <h2 class="card-text text-danger">Rp.
                                        <?php echo e(number_format($overdue->where('info', 'Kojisha')->sum('amount', 0, '.', ','))); ?>
                        ...
                        <div class="col-4">
                            <div class="card shadow-none bg-transparent border border-success mb-3">
                                <div class="card-body">
                                    <h5 class="card-title">Total On Due</h5>
                                    <h2 class="card-text text-success">Rp.
                                        <?php echo e(number_format($ondue->where('info', 'Kojisha')->sum('amount', 0, '.', ','))); ?>
                        ...
                        <div class="col-4">
                            <div class="card shadow-none bg-transparent border border-primary mb-3">
                                <div class="card-body">
                                    <h5 class="card-title">Total Outstanding</h5>
                                    <h2 class="card-text text-primary">Rp.
                                        <?php echo e(number_format($invoice->whereIn('id_sales', [2, 3, 4, 32])->sum('amount', 0, '.', ','))); ?>
                        ...
                        <div class="col-4">
                            <div class="card shadow-none bg-transparent border border-danger mb-3">
                                <div class="card-body">
                                    <h5 class="card-title">Total Overdue</h5>
                                    <h2 class="card-text text-danger">Rp.
                                        <?php echo e(number_format($overdue->whereIn('id_sales', [2, 3, 4, 32])->sum('amount', 0, '.', ','))); ?>
                        ...
                        <div class="col-4">
                            <div class="card shadow-none bg-transparent border border-warning mb-3">
                                <div class="card-body">
                                    <h5 class="card-title">Total On Due</h5>
                                    <h2 class="card-text text-success">Rp.
                                        <?php echo e(number_format($ondue->whereIn('id_sales', [2, 3, 4, 32])->sum('amount', 0, '.', ','))); ?>
                        ...
                        <div class="col-4">
                            <div class="card shadow-none bg-transparent border border-primary mb-3">
                                <div class="card-body">
                                    <h5 class="card-title">Total Outstanding</h5>
                                    <h2 class="card-text text-primary">Rp.
                                        <?php echo e(number_format($invoice->whereIn('id_sales', [1, 16, 23])->sum('amount', 0, '.', ','))); ?>
                        ...
                        <div class="col-4">
                            <div class="card shadow-none bg-transparent border border-danger mb-3">
                                <div class="card-body">
                                    <h5 class="card-title">Total Overdue</h5>
                                    <h2 class="card-text text-danger">Rp.
                                        <?php echo e(number_format($overdue->whereIn('id_sales', [1, 16, 23])->sum('amount', 0, '.', ','))); ?>
                        ...
                        <div class="col-4">
                            <div class="card shadow-none bg-transparent border border-warning mb-3">
                                <div class="card-body">
                                    <h5 class="card-title">Total On Due</h5>
                                    <h2 class="card-text text-success">Rp.
                                        <?php echo e(number_format($ondue->whereIn('id_sales', [1, 16, 23])->sum('amount', 0, '.', ','))); ?>
    ...
    <?php echo $__env->make('components.modal.payment.outstanding', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('components.modal.payment.overdue', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('components.modal.payment.ondue', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startPush('page-script'); ?>
    ...
    <script src="<?php echo e(asset('assets')); ?>/includes/table-ar-aging-report.js"></script>
    <script src="<?php echo e(asset('assets')); ?>/includes/table-ar-aging-report-reftech.js"></script>
    <script src="<?php echo e(asset('assets')); ?>/includes/table-ar-aging-report-kojisha.js"></script>
    <script src="<?php echo e(asset('assets')); ?>/includes/table-ar-aging-report-ahmad.js"></script>
    <script src="<?php echo e(asset('assets')); ?>/includes/table-ar-aging-report-rayi.js"></script>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/accounting/payment/index-aging.blade.php ENDPATH**/ ?>