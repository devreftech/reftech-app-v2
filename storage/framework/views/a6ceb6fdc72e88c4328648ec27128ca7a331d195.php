...
<?php $__env->startSection('content'); ?>
    <h3 class="text-center">
        Pilih Bulan / Tahun nya Untuk Masuk Detail Equity
    </h3>
...
<?php $__env->startPush('script'); ?>
    <script>
        ...
        yearSelect.addEventListener('change', function() {
            ...
            window.open(`/equity-print/${this.value}`, '_blank');
        });
        ...
        document.getElementById('html5-month-input').addEventListener('change', function() {
            ...
            window.open(`/equity-print/${year}/${month}`, '_blank');
        });
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/finance/equity/index.blade.php ENDPATH**/ ?>