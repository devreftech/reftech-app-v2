<form action="<?php echo e(route('pending-po.resiEdit', $pending->id)); ?>" method="post" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-check form-check-inline mt-3">
                                            <input class="form-check-input" type="radio" name="charged"
                                                id="inlineRadio1" value="1" <?php echo e($pending->id == 1 ? 'selected' : ''); ?>>
                                            <label class="form-check-label" for="inlineRadio1">Company</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="charged"
                                                id="inlineRadio2" value="2" <?php echo e($pending->id == 2 ? 'selected' : ''); ?>>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/pending/resi.blade.php ENDPATH**/ ?>