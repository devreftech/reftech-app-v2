<form action="<?php echo e(route('invoice.date_label', $invoice->id)); ?>" method="post" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="form-floating form-floating-outline">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" type="date" id="dateInput"
                                                name="date" value="<?php echo e(@$invoice->date); ?>">
                                        </div>
...
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/accounting/delivery/change-date-label.blade.php ENDPATH**/ ?>