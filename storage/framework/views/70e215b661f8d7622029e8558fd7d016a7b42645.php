<form action="<?php echo e(route('insert_fee.quotation', $quote->id)); ?>" method="post" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
                        ...
                        <form>
                            <div class="row">
                                ...
                                <?php $__currentLoopData = $dquote; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <div class="col-4">
                                        <p class="text-start">Fee <?php echo e($detail->product); ?></p>
                                    </div>
                                        ...
                                        <div class="form-floating form-floating-outline">
                                            <div class="input-group" data-price="<?php echo e($row); ?>">
                                                ...
                                                <input type="text" class="form-control invoice-item-price-label"
                                                    id="priceLabel-<?php echo e($row); ?>" data-id="<?php echo e($row); ?>"
                                                    name="harga[]" placeholder="Put Fee Here" data-type="currency"
                                                    min="0" pattern="^[0-9]\d{0,2}(\.\d{3})*$"
                                                    @focus="focused = true" @blur="focused = false"
                                                    value="<?php echo e(old('price[]', $detail->fee != 0 ? number_format($detail->fee, 0, ',', '.') : 0)); ?>">
                                                <input class="form-control invoice-item-price" type="number"
                                                    name="fee[]" id="price-<?php echo e($row); ?>"
                                                    value="<?php echo e(old('price[]', $detail->fee != 0 ? $detail->fee : 0)); ?>" hidden>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-8 mb-3">
                                    <div class="form-floating-outline">
                                        <input type="text" id="totalLabel"
                                            class="form-control form-control-sm invoice-item-total-label" value="Rp <?php echo e(old('total[]', $quote->fee != 0 ? number_format($quote->fee, 0, ',', '.') : 0)); ?>" disabled>
                                        <input class="form-control invoice-item-total" type="number" name="total"
                                            id="total" value="<?php echo e(old('total[]', $quote->fee != 0 ? $quote->fee : 0)); ?>" hidden>
                                    </div>
                                </div>
                            </div>
                        </form>
...
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/quotation/insert-fee.blade.php ENDPATH**/ ?>