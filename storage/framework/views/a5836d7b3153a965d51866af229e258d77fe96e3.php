<form action="<?php echo e(route('pic.cust.store', $customers->id)); ?>" method="post"
    ...
    <div class="modal animate__animated animate__fadeIn"
        id="<?php echo e('createPic'); ?>" tabindex="-1" style="display: none;"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel5"><?php echo e('Create New '); ?> Pic
                    </h4>
...
</form><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/pic/customers/form-create.blade.php ENDPATH**/ ?>