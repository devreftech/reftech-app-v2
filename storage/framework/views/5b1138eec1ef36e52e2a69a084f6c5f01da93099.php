<form action="<?php echo e(route('payable.addPph', $product->id)); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="form-control invoice-item-pph-label" id="pphLabel"
                                        ...
                                        @blur="focused = false" value="<?php echo e(old('pph', number_format($product->pph, 0, '', '.'))); ?>">
                                    <input class="form-control invoice-item-pph" type="number" name="pph"
                                        id="pph" value="<?php echo e(old('pph', $product->pph)); ?>" hidden>
...
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/payable/pph.blade.php ENDPATH**/ ?>