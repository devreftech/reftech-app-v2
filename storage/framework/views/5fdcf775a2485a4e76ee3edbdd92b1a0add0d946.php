<?php $__env->startSection('title', 'Project Monitoring Dashboard'); ?>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center py-3 mb-4 gap-2">
            ...
            <div class="d-flex align-items-center">
                <form action="<?php echo e(route('project-monitoring.index')); ?>" method="GET" class="d-flex align-items-center">
                ...
                <div class="card card-border-shadow-primary h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-2 pb-1">
                            ...
                            <h4 class="ms-1 mb-0"><?php echo e($totalProjects); ?></h4>
                        </div>
                ...
                <div class="card card-border-shadow-success h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-2 pb-1">
                            ...
                            <h4 class="ms-1 mb-0 text-success">Rp <?php echo e(number_format($totalRevenue, 0, ',', '.')); ?></h4>
                        </div>
                ...
                <div class="card card-border-shadow-warning h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-2 pb-1">
                            ...
                            <h4 class="ms-1 mb-0 text-warning">Rp <?php echo e(number_format($totalMaterial + $totalGeneral + $totalShipping, 0, ',', '.')); ?></h4>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-2 pb-1">
                            ...
                            <div class="d-flex flex-column">
                                <h5 class="ms-1 mb-0 text-primary fw-bold">Rp <?php echo e(number_format($totalProfit, 0, ',', '.')); ?></h5>
                                <small class="ms-1 text-muted fw-bold">Margin: <?php echo e(number_format($overallMargin, 1)); ?>%</small>
                            </div>
                        </div>
            ...
            <div class="card-body">
                <div class="tab-content p-0 border-0 shadow-none">
                    ...
                    <div class="tab-pane fade show active" id="tab-new" role="tabpanel">
                        <?php echo $__env->make('pages.project-monitoring._table', ['projectList' => $newProjects, 'tableId' => 'table-new'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <!-- Tab Check Parts -->
                    <div class="tab-pane fade" id="tab-check" role="tabpanel">
                        <?php echo $__env->make('pages.project-monitoring._table', ['projectList' => $checkPartsProjects, 'tableId' => 'table-check'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <!-- Tab Sched -->
                    <div class="tab-pane fade" id="tab-sched" role="tabpanel">
                        <?php echo $__env->make('pages.project-monitoring._table', ['projectList' => $schedulingProjects, 'tableId' => 'table-sched'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <!-- Tab In Progress -->
                    <div class="tab-pane fade" id="tab-progress" role="tabpanel">
                        <?php echo $__env->make('pages.project-monitoring._table', ['projectList' => $inProgressProjects, 'tableId' => 'table-progress'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <!-- Tab Completed -->
                    <div class="tab-pane fade" id="tab-completed" role="tabpanel">
                        <?php echo $__env->make('pages.project-monitoring._table', ['projectList' => $completedProjects, 'tableId' => 'table-completed'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/project-monitoring/index.blade.php ENDPATH**/ ?>