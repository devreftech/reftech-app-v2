...
<html lang="en" class="light-style layout-navbar-fixed layout-menu-fixed" dir="ltr" data-theme="theme-default"
    ...
    <title>Daily Check | Monitoring</title>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between flex-xl-row flex-md-column flex-row flex-column">
                                ...
                                <div>
                                    ...
                                    <div>
                                        <span class="fw-bolder">HEAD</span>
                                    </div>
                                    <div class="mt-1">
                                        <span class="fw-bold">THEAD</span>
                                    </div>
                                    <div class="mt-1">
                            ...
                            <div class="daily mb-4">
                                <h4>Kamis, 24 April 2025</h4><br>
                                <h5>Data Compressor</h5>
                                <div class="table-responsive text-nowrap mt-4">
                                    <table class="table table-bordered">
                                        <thead class="table-light" align="center">
                                            <th style="vertical-align: middle;">Location</th>
                                            <th style="vertical-align: middle;">Tag Number</th>
                                            <th style="vertical-align: middle;">Model</th>
                                            <th style="vertical-align: middle;">Status</th>
                                            <th style="vertical-align: middle;">Preventive</th>
                                            <th style="vertical-align: middle;">Corrective</th>
                                            <th style="vertical-align: middle;">Issue</th>
                                        </thead>
                                        <tbody>
                                            <td style="text-align: center;">BM 1-2</td>
                                            <td style="text-align: center;">MK 34</td>
                                            <td style="text-align: center;">Kaeser CS 91</td>
                                            <td style="text-align: center;">Running Abnormal</td>
                                            <td style="text-align: center;">-</td>
                                            <td style="text-align: center;">Cleaning Air Filter</td>
                                            <td style="text-align: center;">High Temperature & Vibrasi Abnormal</td>
                                        </tbody>
                                        <tbody>
                                            <td style="text-align: center;">BM 1-2</td>
                                            <td style="text-align: center;">MK 31</td>
                                            <td style="text-align: center;">Kaeser CS 121</td>
                                            <td style="text-align: center;">Running Normal</td>
                                            <td style="text-align: center;">-</td>
                                            <td style="text-align: center;">Cleaning Air Filter</td>
                                            <td style="text-align: center;">-</td>
                                        </tbody>
...
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/kosongan.blade.php ENDPATH**/ ?>