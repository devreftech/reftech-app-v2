...
<?php $__env->startSection('content'); ?>
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Units /</span> <?php echo e($product->sku); ?>
                    ...
                    <div class="row mb-1">
                        <div class="col-6">
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-9">
                                    : <?php echo e($product->first_stock); ?>
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-9">
                                    : <?php echo e($product->warehouse_stock); ?>
        ...
        <div class="row">
            <div class="col-md-5 col-12 ">
                <div class="d-flex justify-content-between mb-2">
                    ...
                    <a type="button" data-bs-toggle="modal" data-bs-target="#createReplacement-<?php echo e($product->id); ?>">
            ...
            <div class="col-md col-12 flex-1 mb-3">
                <div class="d-flex justify-content-between mb-2">
                    ...
                    <a type="button" data-bs-toggle="modal" data-bs-target="#createEquivalent-<?php echo e($product->id); ?>">
                        <button type="button" class="btn btn-primary">
                            + New Equivalent
                        </button>
                    </a>
    ...
    <?php echo $__env->make('components.modal.warehouse.unit.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('components.modal.warehouse.unit.stock', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php echo $__env->make('components.modal.warehouse.equivalent.form-unit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php
        $no = 0;
    ?>
...
<?php $__env->startPush('page-script'); ?>
    ...
    <script src="<?php echo e(asset('assets')); ?>/includes/table-equivalent-unit.js"></script>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/warehouse/unit/detail.blade.php ENDPATH**/ ?>