...
<div class="modal fade" id="dueDate" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('invoice.due_date', $invoice->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-body p-4">
                    <div class="p-3 mb-3 rounded bg-light-subtle border">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            <span class="text-muted small">No. Invoice</span>
                            <span class="fw-bold text-primary"><?php echo e($invoice->no_invoice); ?></span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center">
                            <span class="text-muted small">Term / Payment Method</span>
                            <span class="fw-semibold text-dark"><?php echo e($termStr ?: 'Tempo'); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="date" id="modal-due-inv-date" name="date"
                            value="<?php echo e($invDateObj->format('Y-m-d')); ?>" required>
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            ...
                            <button type="button" class="btn btn-link btn-sm p-0 text-decoration-none" id="btn-recalc-due" style="font-size:11px;">
                                <i class="mdi mdi-refresh me-1"></i>Reset ke Default (+<?php echo e($tempoDays); ?> Hari)
                            </button>
                        </div>
                        <input class="form-control fw-bold text-dark border-warning" type="date" id="modal-due-date-val" name="due_date"
                            value="<?php echo e($defaultDueDate); ?>" required>
                        <div class="form-text text-muted mt-1" style="font-size: 11px;">
                            <i class="mdi mdi-information-outline me-1 text-warning"></i>
                            Otomatis dihitung dari <strong>Tanggal Invoice + <?php echo e($tempoDays); ?> Hari</strong>. Anda dapat mengedit tanggal ini secara manual jika ada penyesuaian (misal: keterlambatan pengiriman ekspedisi).
                        </div>
                    </div>

                    <div class="mb-2">
                        <label class="form-label fw-semibold">Catatan / Keterangan Penyesuaian <span class="text-muted small">(Opsional)</span></label>
                        <input type="text" class="form-control" name="note" value="<?php echo e($paymentRec?->note); ?>"
...
<script>
    (function () {
        const tempoDays = <?php echo e($tempoDays); ?>;
...
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/invoice/due-date.blade.php ENDPATH**/ ?>