...
<?php $__env->startSection('title', 'Create Manual DO'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <form id="formAuthentication" class="mb-3 fv-plugins-bootstrap5 fv-plugins-framework"
        action="<?php echo e(route('delivery.store_manual', $invoice->id)); ?>"
        ...
        <div class="card">
            <div class="card-body">
                <div class="row mb-3">
                    ...
                    <div class="col-8">
                        <div class="form-floating form-floating-outline">
                            <select class="select2 form-select" id="selectAddress" aria-label="Default select example"
                                name="destination" data-allow-clear="true">
                                <option value="1" <?php echo e(old('address', @$invoice->invoiceTo) == '1' ? 'selected' : ''); ?>>
                                    <?php echo e(@$invoice->quote->pic->client->address); ?>

                                </option>
                                <option value="2" <?php echo e(old('address', @$invoice->invoiceTo) == '2' ? 'selected' : ''); ?>>
                                    <?php echo e(@$invoice->quote->pic->client->subAddress); ?></option>
                            </select>
                                            ...
                                            <div class="col-md-8 col-12 mb-md-0">
                                                ...
                                                <div class="form-floating form-floating-outline mb-2">
                                                    <input type="text" id="product-1-1"
                                                        class="form-control form-control-lg mb-2" name="product[]"
                                            ...
                                            <div class="col-md-2 col-12 mb-md-0 mb-3">
                                                ...
                                                <div class="form-floating form-floating-outline">
                                                    <input type="number" class="form-control mb-4 invoice-item-qty"
                                                        placeholder="Min 1" name="qty[]" id="qty-1-1" data-main="1"
                                                        data-id="1" min="1" value="1">
                                                </div>
                                            </div>
                                            <div class="col-md-2 col-12 mb-md-0 mb-3">
                                                <p class="mb-2 repeater-title">Qty Info</p>
                                                <div class="form-floating form-floating-outline">
                ...
                <div class="float-end">
                    <a href="<?php echo e(route('invoice.index')); ?>" type="button" class="btn btn-lg btn-outline-secondary">
                        Back
                    </a>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/accounting/delivery/manual/form-ekspedisi.blade.php ENDPATH**/ ?>