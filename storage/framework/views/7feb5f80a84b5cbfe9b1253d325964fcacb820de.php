<form action="<?php echo e(route('update.stock-unit', $product->id)); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-8 mb-2">
                            ...
                            <div class="form-floating form-floating-outline">
                                ...
                                <input type="number" id="stock" class="form-control recent-warehouse-stock"
                                    name="warehouse_recent_stock" value="<?php echo e(old('stock', $product->warehouse_stock)); ?>" hidden>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/warehouse/unit/stock.blade.php ENDPATH**/ ?>