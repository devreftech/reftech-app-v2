<?php $__env->startSection('title', @$purchase ? 'Edit Purchase Order' : 'Create Purchase Order'); ?>
<?php $__env->startSection('content'); ?>
    
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center py-3 mb-3 gap-3">
        <div>
            <h4 class="fw-bold mb-1">
                <span class="text-muted fw-light">Procurement / <a href="<?php echo e(route('purchase.index')); ?>" class="text-muted">Purchase Order</a> /</span>
                <?php echo e(@$purchase ? 'Edit' : 'Create'); ?>

            </h4>
            <p class="text-muted mb-0 small"><i class="mdi mdi-cart-outline me-1"></i> Buat dokumen Purchase Order ke Supplier</p>
        </div>
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('purchase.index')); ?>" class="btn btn-label-secondary">
    ...
    <form id="formAuthentication" class="fv-plugins-bootstrap5 fv-plugins-framework"
        action="<?php echo e(@$purchase ? route('purchase.update', $purchase->id) : route('purchase.store')); ?>" method="post"
                ...
                <div class="row align-items-center g-3">
                    <div class="col-md-8 col-12">
                        ...
                        <input type="text" class="form-control form-control-lg fw-bold bg-white text-primary border-primary-subtle shadow-sm"
                            ...
                            value="<?php echo e(old('no_po', @$purchase->no_po ?? $previewNoPo ?? '')); ?>">
                    </div>
                    <div class="col-md-4 col-12 text-md-end">
                        <?php if(@$purchase): ?>
                            <span class="badge bg-label-primary px-3 py-2 fs-6 rounded-pill">
                                <i class="mdi mdi-shape-outline me-1"></i> <?php echo e($purchase->category); ?>
                                ...
                                <select id="supplier-dropdown" class="select2 form-select invoice-item-supplier"
                                    ...
                                    <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($supp->id); ?>" data-info="<?php echo e($supp->info); ?>"
                                            data-code="<?php echo e($supp->code); ?>" data-phone="<?php echo e($supp->phone); ?>"
                                            <?php echo e(@$purchase->id_supplier == $supp->id ? 'selected' : ''); ?>>
                    ...
                    <div class="col-md-4">
                        <div class="form-floating form-floating-outline">
                            <input class="form-control" type="date" id="date" name="date" required
                                value="<?php echo e(old('date', @$purchase->date ?? \Carbon\Carbon::today()->format('Y-m-d'))); ?>">
                    ...
                    <div class="col-md-3">
                        <div class="form-floating form-floating-outline">
                            <input class="form-control" type="text" placeholder="Put Delivery Time Here ...."
                                ...
                                value="<?php echo e(old('delivery', @$purchase->delivery ?? '')); ?>">
                    ...
                    <div class="col-md-3">
                        <div class="form-floating form-floating-outline">
                            <input class="form-control" type="text" placeholder="Put ATTN Quotation Here ...."
                                id="attn" name="attn" value="<?php echo e(old('attn', @$purchase->attn ?? '')); ?>">
                    ...
                    <div class="col-md-3">
                        <div class="form-floating form-floating-outline">
                            <input class="form-control" type="text" placeholder="Put Mobile Here ...."
                                id="mobile" name="mobile" value="<?php echo e(old('mobile', @$purchase->mobile ?? '')); ?>">
                    ...
                    <div class="col-md-3">
                        <div class="form-floating form-floating-outline">
                            <input class="form-control" type="text" placeholder="text Payment Here ...."
                                ...
                                value="<?php echo e(old('payment', @$purchase->payment ?? '')); ?>">
                    ...
                    <?php if(@$purchase): ?>
                        <div class="mb-0" data-repeater-list="group-a">
                            <?php
                                $no = 1;
                            ?>
                            <?php $__currentLoopData = $dPurchase; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="row w-100">
                                            ...
                                            <div class="col-md col-12 mb-md-0 item-fields">
                                                <div class="item-category-toggle mb-2">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input item-category-radio" type="radio"
                                                            value="Sparepart" <?php echo e(($item->category ?? 'Sparepart') != 'Unit' && ($item->category ?? '') != 'Custom' ? 'checked' : ''); ?>>
                                                        <label class="form-check-label small">Sparepart</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input item-category-radio" type="radio"
                                                            value="Unit" <?php echo e(($item->category ?? '') == 'Unit' ? 'checked' : ''); ?>>
                                                        <label class="form-check-label small">Unit Global</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input item-category-radio" type="radio"
                                                            value="Custom" <?php echo e(($item->category ?? '') == 'Custom' ? 'checked' : ''); ?>>
                                                    ...
                                                    <select class="form-select form-select-sm select2-product-po" name="id_product[]">
                                                        ...
                                                        <?php $__currentLoopData = $products ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($p->id); ?>"
                                                                data-label="<?php echo e($p->commodity); ?> — <?php echo e($p->description); ?>"
                                                                data-unit="<?php echo e($p->unit); ?>"
                                                                <?php echo e($item->id_product == $p->id ? 'selected' : ''); ?>>
                                                                <?php echo e($p->commodity); ?> — <?php echo e($p->description); ?>
                                                    ...
                                                    <select class="form-select form-select-sm select2-unit-po" name="id_unit[]">
                                                        ...
                                                        <?php $__currentLoopData = $units ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($u->id); ?>"
                                                                data-sku="<?php echo e($u->sku); ?>"
                                                                data-name="<?php echo e($u->brand); ?> <?php echo e($u->model); ?>"
                                                                data-label="<?php echo e($u->sku); ?> - <?php echo e($u->brand); ?> <?php echo e($u->model); ?>"
                                                                <?php echo e($item->id_unit == $u->id ? 'selected' : ''); ?>>
                                                                <?php echo e($u->sku); ?> <?php echo e($u->brand); ?> <?php echo e($u->model); ?>
                                                ...
                                                <div class="field-product-custom" style="display:none;">
                                                    <textarea class="form-control form-control-sm invoice-item-detail-product"
                                                        name="product[]" rows="2"
                                                        placeholder="Nama/Deskripsi Item Custom..."><?php echo e($item->product); ?></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-12 mb-md-0 mb-3">
                                                <p class="mb-2 repeater-title small text-muted">Price</p>
                                                <div class="input-group input-group-sm" data-price="<?php echo e($no); ?>">
                                                    <span class="input-group-text">Rp. </span>
                                                    <input type="text" class="form-control invoice-item-price-label"
                                                        id="priceLabel-<?php echo e($no); ?>"
                                                        data-id="<?php echo e($no); ?>" name="harga"
                                                    ...
                                                    <input class="form-control invoice-item-price" type="number"
                                                        name="price[]" id="price-<?php echo e($no); ?>"
                                                        value="<?php echo e(old('price[]', $item->price)); ?>" hidden>
                                                </div>
                                            </div>
                                            <div class="col-md-1 col-12 mb-md-0 mb-3">
                                                ...
                                                <input type="number" class="form-control form-control-sm invoice-item-qty"
                                                    placeholder="Min 1" name="qty[]" id="qty-<?php echo e($no); ?>"
                                                    data-id="<?php echo e($no); ?>" min="1"
                                            ...
                                            <div class="col-md-1 col-12 mb-md-0 mb-3">
                                                ...
                                                <select class="form-select form-select-sm invoice-item-info"
                                                    id="info-qty-<?php echo e($no); ?>"
                                                    data-id="<?php echo e($no); ?>"
                                                    aria-label="Default select example" name="info_qty[]">
                                                    <option disabled>---Info---</option>
                                                    <option value="Pcs" <?php echo e($item->info_qty == 'Pcs' ? 'selected' : ''); ?>>Pcs</option>
                                                    <option value="Set" <?php echo e($item->info_qty == 'Set' ? 'selected' : ''); ?>>Set</option>
                                                    <option value="Pail" <?php echo e($item->info_qty == 'Pail' ? 'selected' : ''); ?>>Pail</option>
                                                    <option value="Unit" <?php echo e($item->info_qty == 'Unit' ? 'selected' : ''); ?>>Unit</option>
                                                    <option value="Lot" <?php echo e($item->info_qty == 'Lot' ? 'selected' : ''); ?>>Lot</option>
                                                    <option value="Meter" <?php echo e($item->info_qty == 'Meter' ? 'selected' : ''); ?>>Meter</option>
                                                    <option value="Can" <?php echo e($item->info_qty == 'Can' ? 'selected' : ''); ?>>Can</option>
                                                    <option value="Hari" <?php echo e($item->info_qty == 'Hari' ? 'selected' : ''); ?>>Hari</option>
                                                    <option value="Bulan" <?php echo e($item->info_qty == 'Bulan' ? 'selected' : ''); ?>>Bulan</option>
                                                    <option value="Kg" <?php echo e($item->info_qty == 'Kg' ? 'selected' : ''); ?>>Kg</option>
                                                    <option value="Tube" <?php echo e($item->info_qty == 'Tube' ? 'selected' : ''); ?>>Tube</option>
                                                    <option value="Titik" <?php echo e($item->info_qty == 'Titik' ? 'selected' : ''); ?>>Titik</option>
                                                </select>
                                            </div>
                                            <div class="col-md-1 col-12 mb-md-0 mb-3">
                                                <p class="mb-2 repeater-title small text-muted">Disc (%)</p>
                                                <div class="input-group input-group-sm" data-disc="<?php echo e($no); ?>">
                                                    <input type="text" class="form-control invoice-item-disc"
                                                        id="disc-<?php echo e($no); ?>" data-id="<?php echo e($no); ?>"
                                                        name="disc[]" placeholder="%"
                                                        value="<?php echo e(old('disc[]', $item->disc)); ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-2 col-12 pe-4 text-md-end">
                                                <p class="mb-2 repeater-title small text-muted">Amount</p>
                                                <p class="mb-0 amount-label fw-semibold text-primary" id="amount-label-<?php echo e($no); ?>" data-id="<?php echo e($no); ?>">
                                                    <?php echo e(number_format($item->amount, 0, ',', '.')); ?></p>
                                                <input type="number" class="form-control invoice-item-amount"
                                                    name="amount[]" id="amount-<?php echo e($no); ?>"
                                                    data-id="<?php echo e($no); ?>"
                                                    value="<?php echo e(old('amount[]', $item->amount)); ?>" hidden>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row w-100">
                                        ...
                                        <div class="col-md-3 col-12 mb-md-0 mb-3">
                                            ...
                                            <div class="input-group input-group-sm" data-price="1">
                                                ...
                                                <input class="form-control invoice-item-price" type="number"
                                                    name="price[]" id="price-1" value="<?php echo e(old('price[]')); ?>" hidden>
                                            </div>
                                        </div>
                                        <div class="col-md-1 col-12 mb-md-0 mb-3">
                                            <p class="mb-2 repeater-title small text-muted">Qty</p>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-7">
                        ...
                        <textarea class="form-control h-px-100" rows="3" placeholder="Write your note here...."
                            name="note"><?php echo e(@$purchase->note); ?></textarea>
                    </div>
                            ...
                            <div class="card-body p-4">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <div class="text-end">
                                        <span class="fw-bold text-dark fs-6 subtotal-label" id="subtotal-label" data-id="1">
                                            <?php echo e(old('subtotal', @$purchase->subtotal ? 'RP ' . number_format(@$purchase->subtotal, 0, '', '.') : 'RP 0')); ?>

                                        </span>
                                        <input type="number" id="subtotal" name="subtotal"
                                            value="<?php echo e(old('subtotal', @$purchase->subtotal ?? '')); ?>" hidden>
                                    </div>
                                </div>
                                    ...
                                    <div style="width: 160px;">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" id="diskon-label" class="form-control text-end fw-semibold"
                                                ...
                                                pattern="^[0-9]\d{0,2}(\.\d{3})*$"
                                                value="<?php echo e(old('diskon', @$purchase->diskon ? number_format(@$purchase->diskon, 0, '', '.') : '0')); ?>">
                                            <input type="number" name="diskon" id="diskon"
                                                value="<?php echo e(old('diskon', @$purchase->diskon ?? '0')); ?>" hidden>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div class="form-check form-switch mb-0">
                                            <input class="form-check-input" type="checkbox" role="switch"
                                                id="taxSwitch" <?php echo e(@$purchase->vat == '11' ? 'checked' : ''); ?>>
                                        </div>
                                    </div>
                                    <span class="fw-semibold tax-amount-label text-muted small" id="taxAmountLabel">
                                        <?php if(@$purchase && $purchase->vat == '11'): ?>
                                            <?php echo e('RP ' . number_format(($purchase->subtotal - $purchase->diskon) * $purchase->vat / 100, 0, '', '.')); ?>

                                        <?php endif; ?>
                                    </span>
                                    <input type="hidden" id="tax" name="tax" value="<?php echo e(old('tax', @$purchase->vat ?? '0')); ?>">
                                </div>
                                ...
                                <div class="p-3 rounded-3 d-flex justify-content-between align-items-center" style="background: linear-gradient(135deg, #f0f2ff 0%, #e8ebff 100%); border: 1px dashed #696cff;">
                                    ...
                                    <div class="fw-bolder text-primary fs-3 harga-total-label" id="hargaTotalLabel" data-id="1" style="letter-spacing: -0.5px;">
                                        <?php echo e(old('harga_total', @$purchase->total ? 'RP ' . number_format(@$purchase->total, 0, '', '.') : 'RP 0')); ?>

                                    </div>
                                    <input type="number" id="hargaTotal" name="harga_total"
                                        value="<?php echo e(old('harga_total', @$purchase->total ?? '')); ?>" hidden>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="d-flex justify-content-end gap-2 mb-4">
            <a href="<?php echo e(route('purchase.index')); ?>" class="btn btn-label-secondary">Cancel</a>
    ...
    <script>
        $(() => {
            ...
            $('#saveQuickAddSupplier').on('click', function() {
                ...
                $.ajax({
                    url: '<?php echo e(route('supplier.quick-store')); ?>',
                    type: 'POST',
                    data: {
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/accounting/purchase/form.blade.php ENDPATH**/ ?>