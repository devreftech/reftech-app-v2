<div class="modal-onboarding modal modal-xl fade animate__animated" id="detailOnDue" tabindex="-1" style="display: none;"
    aria-hidden="true">
        ...
        <div class="modal-content text-center">
            ...
            <div class="modal-body p-0">
                <div class="onboarding-content mb-0">
                    <h3 class="onboarding-title"> Detail Of OnDue
                    </h3>
                    <form>
                        <div class="row">
                            <div class="col-12">
                                    ...
                                    <table class="table m-0">
                                        ...
                                        <tbody>
                                            <?php
                                                $no = 0;
                                            ?>
                                            <?php $__empty_1 = true; $__currentLoopData = $ondue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <?php
                                                    $no++;
                                                ...
                                                <tr>
                                                    ...
                                                    <td><p><?php echo e(abs($days)); ?> Days Left</p></td>
                                                    <td><?php echo e(number_format($total, 0, ',', '.')); ?></td>
                                                </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                                <tr>
                                                    <td colspan="3">tidak ada OnDue</td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
...
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/payment/ondue.blade.php ENDPATH**/ ?>