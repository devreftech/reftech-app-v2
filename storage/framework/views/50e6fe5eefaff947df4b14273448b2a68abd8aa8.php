                ...
                <div class="card-body mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3 text-end">
                            <p class="mb-1">
                                <?php echo e($quote->flag == 'Reftech' ? 'PT Reftech Jaya Optima' : 'PT Kojisha Innotiv Indonesia'); ?>
                        ...
                        <div class="card-body">
                            <?php if((Auth::user()->id == '1' || Auth::user()->id == '16') && $invoice->count() < 1): ?>
                                <a href="#" data-id="<?php echo e($quote->id); ?>"
                                    ...
                                    <?php echo e($quote->flag == 'Reftech' ? 'Kojisha' : 'Reftech'); ?></a>
                            <?php endif; ?>
                            <?php if($quote->status != '100'): ?>
                            ...
                            <?php else: ?>
                                ...
                                <?php else: ?>
                                    <button type="button" class="btn btn-whatsapp d-grid w-100 waves-effect mb-3 btn-upload-po"
                                        data-npwp="<?php echo e($quote->pic->client->npwp ?? ''); ?>">Upload PO</button>
                                <?php endif; ?>
                            <?php endif; ?>
                        </div>
                    </div>
                    <?php if($quote->status == 100 && isset($invoice)): ?>
                        <div class="card mb-3">
                            <div class="card-body">
                                <div class="d-flex justify-content-between mb-3">
                                    <?php if($remaining != 0): ?>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/sales/quotation/unit/detail.blade.php ENDPATH**/ ?>