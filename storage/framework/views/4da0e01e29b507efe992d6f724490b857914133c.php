...
<?php $__env->startSection('title', 'Kanban Board - ' . $board->title); ?>
    ...
    <div class="app-kanban">
        ...
        <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center py-3 mb-4 gap-2 border-bottom">
            <div class="d-flex align-items-center flex-wrap gap-3">
                <h4 class="fw-bold mb-0 text-primary"><?php echo e($board->title); ?></h4>
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="boardSwitcher">
                        <?php $__currentLoopData = $myBoards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a class="dropdown-item <?php echo e($mb->id == $board->id ? 'active' : ''); ?>" href="<?php echo e(route('kanban.boards.show', $mb->id)); ?>">
                                <?php echo e($mb->title); ?>
                ...
                <?php if($board->type === 'monitoring'): ?>
                    <select class="form-select form-select-sm ms-2" id="kanbanAccountingFilter" style="width: 200px;">
                        ...
                        <?php $__currentLoopData = $accountingUsers ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $accountingUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($accountingUser->id); ?>"><?php echo e($accountingUser->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                <?php endif; ?>
            </div>
            <div class="d-flex gap-2 align-items-center">
                ...
                <?php if(auth()->user()->role === 'Admin' || auth()->id() == $board->created_by): ?>
                ...
                <?php endif; ?>
                <?php if(auth()->user()->role === 'Admin' || (auth()->user()->role === 'Accounting' && $board->type === 'monitoring')): ?>
                            ...
                            <div class="dropdown me-3">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownTaskStatus" id="dropdownTaskStatusMenu">
                                    <?php $__currentLoopData = $board->columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li><a class="dropdown-item btn-change-status-top" href="javascript:void(0);" data-column-id="column_<?php echo e($column->id); ?>"><?php echo e($column->title); ?></a></li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>
                            </div>
                                ...
                                <div class="d-flex flex-wrap gap-1 align-items-center">
                                    ...
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu p-2" aria-labelledby="dropdownLabels" style="min-width: 180px;">
                                            ...
                                            <li><hr class="dropdown-divider my-1"></li>
                                            <?php $__currentLoopData = $activeLabels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li><a class="dropdown-item rounded btn-toggle-label py-1" href="javascript:void(0);" data-color="<?php echo e($color); ?>"><span class="badge bg-<?php echo e($color); ?> me-2">&nbsp;</span><?php echo e($name ?: $color); ?></a></li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <form id="boardSettingsForm" enctype="multipart/form-data">
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="settingsBoardTitle" name="title" value="<?php echo e($board->title); ?>" required>
                            </div>
                            <div class="mb-3">
                                <label for="settingsBoardDescription" class="form-label">Description</label>
                                <textarea class="form-control" id="settingsBoardDescription" name="description" rows="2"><?php echo e($board->description); ?></textarea>
                            </div>
                            <div class="mb-3">
                                ...
                                <select class="select2 form-select" id="settingsBoardMembers" name="member_ids[]" multiple="multiple" data-placeholder="Select members">
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($user->id); ?>" <?php echo e($board->members->contains($user->id) ? 'selected' : ''); ?>>
                            ...
                            <div class="mb-3">
                                ...
                                <div id="settingsColumnsContainer">
                                    <?php $__currentLoopData = $board->columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="input-group mb-2 settings-column-item" data-id="<?php echo e($column->id); ?>">
                                            <input type="hidden" name="columns[][id]" value="<?php echo e($column->id); ?>">
                                            <input type="text" class="form-control" name="columns[][title]" value="<?php echo e($column->title); ?>" required>
                            ...
                            <div class="mb-3 border-top pt-3">
                                ...
                                <div id="settingsLabelsContainer" class="row g-2">
                                    <?php $__currentLoopData = $activeLabels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-sm-6 settings-label-item" data-color="<?php echo e($color); ?>">
                                            <div class="input-group input-group-sm mb-2">
                                                <span class="input-group-text bg-<?php echo e($color); ?> text-white" style="width: 35px; border: 0;">&nbsp;</span>
                                                <input type="text" class="form-control" name="labels[<?php echo e($color); ?>]" value="<?php echo e($board->labels ? ($board->labels[$color] ?? '') : ''); ?>" placeholder="<?php echo e($name); ?>">
                            ...
                            <div class="mb-3 border-top pt-3">
                                ...
                                <?php if($board->notification_sound): ?>
                                    <div class="d-flex align-items-center mt-2 gap-2">
                                        <small class="text-success mb-0">
                                            <i class="mdi mdi-check-circle-outline"></i> Sound kustom aktif: <?php echo e(basename($board->notification_sound)); ?>

                                        </small>
                                        <button type="button" class="btn btn-xs btn-outline-info py-0 px-2" id="btnTestSound" data-sound="<?php echo e(asset($board->notification_sound)); ?>">
                            ...
                            <div class="mb-3 border-top pt-3">
                                ...
                                <p class="text-muted mb-2" style="font-size: 12px;">Atur sales yang ditangani tiap Accounting, dipakai untuk filter "<?php echo e('-- Semua Accounting --'); ?>" di halaman board.</p>
                                <div id="accountingMappingContainer">
                                    <?php $__currentLoopData = $accountingUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $accountingUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="mb-2">
                                            <label class="form-label" style="font-size: 12.5px;"><?php echo e($accountingUser->name); ?></label>
                                            <select class="select2 form-select accounting-mapping-select" multiple="multiple" data-accounting-id="<?php echo e($accountingUser->id); ?>" data-placeholder="Pilih sales yang ditangani">
                                                <?php $__currentLoopData = $salesUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salesUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($salesUser->id); ?>" <?php echo e($accountingUser->handledSales->contains($salesUser->id) ? 'selected' : ''); ?>><?php echo e($salesUser->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->startPush('after-style'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('assets')); ?>/vendor/libs/jkanban/jkanban.css" />
    <link rel="stylesheet" href="<?php echo e(asset('assets')); ?>/vendor/css/pages/app-kanban.css" />
...
<?php $__env->startPush('after-script'); ?>
    <script src="<?php echo e(asset('assets')); ?>/vendor/libs/jkanban/jkanban.js"></script>
...
<?php $__env->startPush('page-script'); ?>
    <script>
        $(document).ready(function() {
            const boardId = "<?php echo e($board->id); ?>";
            const csrfToken = $('meta[name="csrf-token"]').attr('content');
            const boardType = "<?php echo e($board->type); ?>";
            let kanbanBoardInstance = null;
            const boardLabels = <?php echo json_encode($board->labels ?? (object)[], 15, 512) ?>;
            const accountingSalesMap = <?php echo json_encode(($accountingUsers ?? collect())->mapWithKeys(function ($acc) {
            ...
            function openCreateTaskModal(boardId) {
                ...
                <?php if($board->type === 'monitoring'): ?>
                    ...
                    $.ajax({
                        url: '<?php echo e(route("kanban.monitoring-document.available-pos")); ?>',
                        method: 'GET',
            ...
            const boardMembers = [
                <?php $__currentLoopData = $board->members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    { id: "<?php echo e($member->id); ?>", name: "<?php echo e($member->name); ?>" },
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ];
            ...
            $('#btnSaveAccountingMapping').click(function() {
                ...
                $.ajax({
                    url: '<?php echo e(route("kanban.monitoring-document.accounting-mapping")); ?>',
                    method: 'POST',
                    data: {
                        mappings: mappings,
                        _token: csrfToken
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success && response.new_cards > 0) {
                            const soundPath = "<?php echo e($board->notification_sound ? asset($board->notification_sound) : asset('assets/audio/kanban-notification-default.wav')); ?>";
                            try {
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/kanban/board.blade.php ENDPATH**/ ?>