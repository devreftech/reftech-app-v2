                    ...
                    <?php if($contract->type == 'Selling'): ?>
                        <div
                            ...
                            <div class="text-end">
                                ...
                                <div>
                                    <span class="fw-bolder">#<?php echo e($contract->no_contract); ?></span>
                                </div>
                                <div class="mt-1">
                                    <span
                                        class="text-muted"><?php echo e(Carbon\Carbon::parse($contract->date)->format('d-m-Y')); ?></span>
                                </div>
                            </div>
                        </div>
                    <?php else: ?>
                ...
                <div class="card-body mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3 text-end">
                            <p class="mb-1">
                                <?php if($quote->tax != '0'): ?>
                                    <?php echo e($contract->type == 'Selling' ? 'PT Reftech Jaya Optima' : 'PT Kojisha Innotiv Indonesia'); ?>

                                <?php else: ?>
                                    <?php echo e($quote->sales->name); ?>
                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = $dquote; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr style="font-size: 13px">
                                        ...
                                        <td class="align-top text-end"><?php echo e($product->amount == 0 ? 'SBO' : 'RP ' . number_format($product->price, 0, '', '.')); ?>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" class="px-4 py-5">
                                        ...
                                        <p class="fw-semibold mb-2 text-end">RP
                                            <?php echo e(number_format($quote->subtotal - $quote->diskon, 0, '', '.')); ?>

                                        <p class="fw-semibold mb-2 text-end">
                                            <?php echo e($tax == '0' ? '0' : 'RP ' . number_format($vat, 0, '', '.')); ?></p>
                                        </p>
                                        <p class="fw-semibold mb-2 text-end">RP
                                ...
                                <tr class="border-top">
                                    <td colspan="4" class="px-4 border-right" style="background-color: #E7FF00">
                                        <p class="fw-semibold mb-0 text-black">TOTAL PRICE,
                                            <?php echo e($quote->tax != 0 ? 'INCLUDE' : 'EXCLUDE'); ?> VAT 11%</p>
                                    </td>
                ...
                <?php if($contract->type == 'Selling'): ?>
                    <div class="row mt-3">
                        <div class="col-4 my-5 text-center">
                            ...
                            <?php if($quote->tax != '0'): ?>
                                <img src="<?php echo e(asset('/asset')); ?>/contract\sign-irene.jpeg" alt="" srcset=""
                                    style="width: 100px; height: 77px;">
                            <?php else: ?>
                                <img src="<?php echo e(asset('/asset')); ?>/sign\ttdirene.jpg" alt="" srcset=""
                                    style="width: 100px; height: 77px;">
                            <?php endif; ?>
                        ...
                        <div class="col-4 my-5 text-center">
                            ...
                            <div class="pb-5"></div>
                            <p class="pt-5"><?php echo e($quote->pic->name_pic); ?></p>
                            <p><?php echo e($quote->pic->client->company); ?></p>
                        </div>
                    </div>
                <?php else: ?>
                    <div class="row mt-5">
                        <div class="col-4 my-5 text-center">
                            <p class="fs-normal fw-medium">Authorized By,</p>
                            <img src="<?php echo e(asset('/asset')); ?>/contract\sign-dedeh.png" alt="" srcset=""
                                style="width: 100px; height: 77px;">
                ...
                <div class="card-body">
                    <?php if($contract->level == '0'): ?>
                        <button type="button" class="btn btn-primary d-grid w-100 waves-effect mb-3"
                            data-bs-toggle="modal" data-bs-target="#acceptContract<?php echo e($contract->id); ?>">
                            Accept
                        </button>
                        <a href="#" class="btn btn-outline-danger d-grid w-100 mb-3 waves-effect delete-contract"
                            data-id="<?php echo e($contract->id); ?>" data-quote="<?php echo e($quote->id); ?>">Reject</a>
                    <?php elseif($contract->level == '1'): ?>
                        ...
                        <a href="#" class="btn btn-outline-danger d-grid w-100 mb-3 waves-effect delete-contract"
                            data-id="<?php echo e($contract->id); ?>" data-quote="<?php echo e($quote->id); ?>">Delete</a>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/accounting/contract/detail.blade.php ENDPATH**/ ?>