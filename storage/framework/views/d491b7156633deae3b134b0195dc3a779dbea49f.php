<form action="<?php echo e(route('expense-account.update', 1)); ?>" id="editForm" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
                                ...
                                <div class="col-12 ">
                                    <div class="form-floating form-floating-outline mb-2">
                                        <select class="select2 form-select edit_parent" data-allow-clear="true" name="parent"
                                            ...
                                            <?php $__currentLoopData = $prim; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($acc->id); ?>" >
                                                    <?php echo e($acc->code); ?> - <?php echo e($acc->name); ?> <?php echo e($acc->category); ?>
...
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/finance/edit-account.blade.php ENDPATH**/ ?>