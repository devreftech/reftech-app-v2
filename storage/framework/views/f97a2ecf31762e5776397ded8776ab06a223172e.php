                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div
                                ...
                                <div>
                                    ...
                                    <h4 class="mb-2">Rp <?php echo e(number_format($asset, '0', ',', '.')); ?></h4>
                                    <p class="mb-0"><span class="badge rounded-pill bg-label-success"></span></p>
                                </div>
                                <div class="avatar me-sm-4">
                                    <span class="avatar-initial rounded bg-label-secondary">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <h4 class="mb-2">Rp <?php echo e(number_format($revenue, '0', ',', '.')); ?></h4>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/warehouse/product/index.blade.php ENDPATH**/ ?>