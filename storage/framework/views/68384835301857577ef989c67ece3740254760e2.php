...
<?php $__env->startSection('title', 'Non Project'); ?>
    ...
    <div class="container-fluid p-0" style="width: calc(100% - 10px); margin-right:5px;margin-left:5px;">
        <div class="card mb-3">
            <div class="card-datatable table-responsive pt-0">
                <table
                    class="datatable-pending-po-non-project<?php echo e(auth::user()->role == 'Sales' ? '' : '-admin'); ?> table table-bordered">
                    <thead>
                        <tr>
                            <th></th>
...
<?php $__env->startPush('page-script'); ?>
    ...
    <script src="<?php echo e(asset('assets')); ?>/includes/table-pending-non-project.js"></script>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/pending/index.blade.php ENDPATH**/ ?>