<form action="<?php echo e(route('tool-master.store')); ?>" method="post" enctype="multipart/form-data" id="formToolMaster">
    <?php echo csrf_field(); ?>
...
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/technician/tool-master/form.blade.php ENDPATH**/ ?>