                ...
                <div class="card-body">
                    <div class="form-floating form-floating-outline mb-2">
                        <select class="form-select change-no" name="changeNo" id="changeNo"
                            aria-label="Default select example" data-id="<?php echo e($product->id); ?>">
                            <option value="1" <?php echo e($product->no_type == '1' ? 'Selected' : ''); ?>>
                                No Invoice
                            </option>
                            <option value="2" <?php echo e($product->no_type == '2' ? 'Selected' : ''); ?>>
                                No PO
                            </option>
                        </select>
    ...
    <script>
        $(document).on('click', '.delete-invoice', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        'url': '<?php echo e(url('product-out')); ?>/' + id,
                        'type': 'POST',
                        'data': {
                            '_method': 'DELETE',
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/warehouse/product-out/detail.blade.php ENDPATH**/ ?>