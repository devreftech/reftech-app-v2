...
<?php $__env->startSection('content'); ?>
    <?php
        $no = 0;
    ?>
    <form action="<?php echo e(route('product-in.invoicing', $productIn->id)); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <h5>Edit Barang Masuk <span class="fw-bolder fs-4"><?php echo e($productIn->no_do); ?></span></h5>
            ...
            <div class="card-body">
                <div class="form-invoice-repeater source-item">
                        ...
                        <div class="col-6 col-lg-2">
                            <div class="form-floating form-floating-outline mb-4">
                                <select class="form-select invoice-item-info" id="info-dropdown" name="info"
                                    ...
                                    <option selected disabled><?php echo e($productIn->supp->info ?? 'Pilih Supplier Dulu'); ?></option>
                                </select>
                    ...
                    <div class="mb-3" data-repeater-list="group-a">
                        <?php $__currentLoopData = $dProductIn; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $no++;
                            ?>
                                        ...
                                        <div class="col-md-4 col-12 mb-md-0 mb-3">
                                            ...
                                            <div class="form-floating form-floating-outline mb-2">
                                                <select id="replacement-dropdown-<?php echo e($product->id); ?>"
                                                    ...
                                                    <option selected>
                                                        <?php echo e($product->detailProduct->product->description); ?>

                                                        <?php echo e($product->detailProduct->product->commodity); ?>

                                                        (<?php echo e($product->detailProduct->product->detail_desc); ?>)
                                                        ||
                                                        <?php echo e($product->detailProduct->replacement); ?> -
                                                        <?php echo e($product->detailProduct->product->go == 'Genuine' ? 'G' : 'R'); ?>
                                        ...
                                        <div class="col-md-1 col-12 mb-md-0 mb-3">
                                            ...
                                            <div class="form-floating form-floating-outline mb-4">
                                                <select class="form-select invoice-item-warehouse" id="warehouse-1"
                                                    ...
                                                    disabled>
                                                    <option selected> <?php echo e($product->warehouse); ?> </option>
                                                </select>
                                            </div>
                                        </div>
                        ...
                        <div class="col-lg-4 col-12">
                            ...
                            <div class="input-group" data-subtotal="1">
                                ...
                                <input class="form-control invoice-item-total-no-tax" type="number" name="total_no_tax"
                                    id="totalNoTax" value="<?php echo e(old('total_no_tax')); ?>" hidden>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-1">
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/warehouse/product-in/invoicing.blade.php ENDPATH**/ ?>