<form action="<?php echo e(route('status.change.quotation', $quote->id)); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="modal-onboarding modal fade animate__animated" id="changeStatus-<?php echo e($quote->id); ?>" tabindex="-1"
                        ...
                        <div class="p-4 text-white rounded-3 position-relative overflow-hidden mb-4" style="background: linear-gradient(135deg, #696cff 0%, #3f42b3 100%) !important;">
                            ...
                            <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center gap-2 position-relative" style="z-index: 2;">
                                <div class="text-start">
                                    ...
                                    <h4 class="text-white fw-bold mb-1" style="font-size: 20px;"><?php echo e($quote->pic->client->company); ?></h4>
                                    <p class="mb-0 text-white opacity-80" style="font-size: 12.5px;">
                                        <i class="mdi mdi-account-circle-outline me-1"></i> PIC: <?php echo e($quote->pic->name); ?>
                                ...
                                <div class="text-start text-sm-end d-flex flex-column align-items-start align-items-sm-end gap-1">
                                    ...
                                    <div class="fw-semibold text-white mt-1" style="font-size: 13px;">
                                        Total: <span class="text-warning fw-bold">Rp <?php echo e(number_format($quote->harga_total, 0, ',', '.')); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-6 mb-3">
                                        <div class="form-floating form-floating-outline">
                                            <select class="form-select" tabindex="0" id="statusChange" name="status">
                                                <option value="20" <?php echo e($quote->status == '20' ? 'selected' : ''); ?>>Send
                                                    WA/Email <small class="text-muted">20%</small></option>
                                                <option value="30" <?php echo e($quote->status == '30' ? 'selected' : ''); ?>>
                                                    Inquiry Accepted <small class="text-muted">30%</small></option>
                                                <option value="40" <?php echo e($quote->status == '40' ? 'selected' : ''); ?>>
                                                    Progress Follow Up <small class="text-muted">40%</small>
                                                </option>
                                                <option value="60" <?php echo e($quote->status == '60' ? 'selected' : ''); ?>>
                                                    Negotiation/Revisi <small class="text-muted">60%</small>
                                                </option>
                                                <option value="80" <?php echo e($quote->status == '80' ? 'selected' : ''); ?>>Hot
                                                    Prospect<small class="text-muted">80%</small>
                                                </option>
                                                <option value="90" <?php echo e($quote->status == '90' ? 'selected' : ''); ?>>Hold
                                                    <small class="text-muted">90%</small>
                                                </option>
                                                <option value="100" <?php echo e($quote->status == '100' ? 'selected' : ''); ?>>Done
                                                    PO <small class="text-muted">100%</small>
                                                </option>
                                                <option value="0" <?php echo e($quote->status == '0' ? 'selected' : ''); ?>>Loss
                                    ...
                                    <div class="col-6 mb-3">
                                        <div class="form-floating form-floating-outline">
                                            <select class="form-select" id="type" name="type" disabled>
                                                <option value="Non Project" <?php echo e(($quote->type == 'Sparepart' && $quote->quote_for == 'Sparepart') ? 'selected' : ''); ?>>Non Project</option>
                                                <option value="Project" <?php echo e(!($quote->type == 'Sparepart' && $quote->quote_for == 'Sparepart') ? 'selected' : ''); ?>>Project</option>
                                            </select>
                                    ...
                                    <div class="col-12 mb-3">
                                        <div class="form-floating form-floating-outline">
                                            <input type="text" class="form-control" id="noPending"
                                                ...
                                                name="no_pending" value="<?php echo e($noPending); ?>" disabled>
                                    ...
                                    <div class="col-12 mb-3">
                                        <div class="form-floating form-floating-outline">
                                            <input type="text" class="form-control" id="title"
                                                ...
                                                aria-describedby="floatingInputFilledHelp" name="title" value="<?php echo e(old('title', $quote->title)); ?>" disabled>
                                ...
                                <div id="modal_combined_address_section">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select mb-2" id="modal_combined_address_select" onchange="onAddressSelectChange('modal', 'combined')">
                                            <option value="customer">Main Address: <?php echo e($quote->pic->client->address); ?></option>
                                            <?php if(!empty($quote->pic->client->subAddress)): ?>
                                                <option value="<?php echo e($quote->pic->client->subAddress); ?>">Sub Address: <?php echo e($quote->pic->client->subAddress); ?></option>
                                            <?php endif; ?>
                                            <?php $__currentLoopData = $quote->pic->client->plants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/sales/quotation/modal-status.blade.php ENDPATH**/ ?>