                ...
                <div class="form-invoice-repeater source-item">
                    ...
                    <div class="mb-3" data-repeater-list="group-a">
                        <?php
                            ...
                            $row = 0;
                        ?>
                        <?php $__currentLoopData = $dPending; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $row++;
                            ?>
                                    ...
                                    <div class="row w-100 p-3">
                                        <div class="col-md-6 col-12 mb-md-0 mb-3">
                                            ...
                                            <div class="form-floating form-floating-outline mb-2">
                                                <select id="equivalent-dropdown"
                                                    ...
                                                    <option value="<?php echo e($fullEquiv[$no]->id); ?>"
                                                        data-commodity="<?php echo e($fullEquiv[$no]->id_product); ?>" selected>
                                                        <?php echo e($fullEquiv[$no]->pn); ?> ||
                                                        <?php echo e($fullEquiv[$no]->product->commodity); ?> -
                                                        <?php echo e($fullEquiv[$no]->product->go == 'Genuine' ? 'G' : 'R'); ?>
                                            ...
                                            <input type="text" class="form-control invoice-item-equivalent"
                                                ...
                                                value="<?php echo e($fullEquiv[$no]->id); ?>" hidden>
                                            <div class="form-floating form-floating-outline mb-2">
                                        ...
                                        <div class="col-md-1 col-12 mb-md-0 mb-3">
                                            ...
                                            <input type="number" class="form-control mb-3 invoice-item-qty"
                                                ...
                                                value="<?php echo e($detail->service->qty); ?>" disabled>
                                            <p class="info-max-label" id="info-max-<?php echo e($row); ?>"></p>
                                            <input type="number" class="form-control invoice-item-qty" name="qty[]"
                                                id="qty-<?php echo e($row); ?>" data-id="<?php echo e($row); ?>"
                                                value="<?php echo e($detail->service->qty); ?>" hidden>
                                        </div>
                                        <div class="col-md-1 col-12 mb-md-0 mb-3">
                                        ...
                                        <div class="col-md-2 col-12 mb-md-0 mb-3">
                                            ...
                                            <div class="input-group" data-price="1">
                                                ...
                                                <input type="text" class="form-control invoice-item-price-label"
                                                    ...
                                                    @blur="focused = false"
                                                    value="<?php echo e(number_format($detail->service->price, 2, ',', '.')); ?>"
                                                    disabled>
                                                <input class="form-control invoice-item-price" type="number"
                                                    name="price[]" id="price-1" value="<?php echo e($detail->service->price); ?>"
                                                    hidden>
                                            </div>
                                        </div>
                                        <div class="col-md-2 col-12 pe-0">
                                            ...
                                            <p class="mb-0 amount-label" id="amount-label-1" data-id="1">
                                                Rp <?php echo e(number_format($detail->service->amount, 2, ',', '.')); ?></p>
                                            <input type="number" class="form-control invoice-item-amount"
                                                name="amount[]" id="amount-<?php echo e($row); ?>" data-id="1"
                                                min="12" value="<?php echo e($detail->service->amount); ?>" hidden>
                                        </div>
                                    </div>
                                    <div
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/pending/form-project.blade.php ENDPATH**/ ?>