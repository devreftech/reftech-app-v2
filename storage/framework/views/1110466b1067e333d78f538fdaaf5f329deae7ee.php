<div class="modal fade" id="formHelpdesk" tabindex="-1" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('helpdesk.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/helpdesk/form.blade.php ENDPATH**/ ?>