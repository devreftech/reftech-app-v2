...
<?php $__env->startSection('content'); ?>
    ...
    <form id="formAuthentication" class="mb-3 fv-plugins-bootstrap5 fv-plugins-framework"
        action="<?php echo e(route('edit-service.quotation', $quotation->id)); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <select id="pic-dropdown" class="select2 form-select invoice-item-pic" data-allow-clear="true"
                                ...
                                <?php if(@$pics): ?>
                                    <?php $__currentLoopData = $pics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($p->id); ?>" <?php echo e($quotation->id_pic == $p->id ? 'selected' : ''); ?>>
                                            <?php echo e($p->name_pic); ?>

                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php else: ?>
                                    <?php if(@$quotation): ?>
                                        <option value="<?php echo e($quotation->id_pic); ?>" selected>
                                            ...
                                            <div class="d-flex position-relative pe-0">
                                                <div class="row w-100 p-3 pb-0">
                                                    ...
                                                    <div class="col-md-3 col-12 mb-md-0 mb-3">
                                                        ...
                                                        <div class="input-group mb-3" data-price="<?php echo e($id); ?>">
                                                ...
                                                <div
                                                    ...
                                                    <i class="mdi mdi-close cursor-pointer bg-danger text-white btn-del"
                                                        data-delete="<?php echo e($dataDelete); ?>" data-repeater-delete=""></i>
                                                </div>
                                            </div>
                                        </div>
                                        <?php
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/sales/quotation/service/edit.blade.php ENDPATH**/ ?>