...
<?php $__env->startSection('content'); ?>
            ...
            <div class="card h-100 border-0 shadow-sm custom-stat-card">
                <div class="card-body p-3">
                    ...
                    <h4 class="mb-2 fw-bold text-dark">Rp
                        <span id="card-forecast-sum"><?php echo e(number_format(Auth::user()->role == 'Admin' ? $forecastAdmin : $forecast, 2, ',', '.')); ?></span>
                    </h4>
                    <div class="d-flex align-items-center gap-1">
                        <span class="badge bg-label-primary rounded-pill fw-semibold" id="card-forecast-count"><?php echo e(Auth::user()->role == 'Admin' ? $forecastAdminCount : $forecastCount); ?></span>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card h-100 border-0 shadow-sm custom-stat-card">
                <div class="card-body p-3">
                    ...
                    <h4 class="mb-2 fw-bold text-dark">Rp
                        <span id="card-prospect-sum"><?php echo e(number_format(Auth::user()->role == 'Admin' ? $prospectAdmin : $prospect, 2, ',', '.')); ?></span>
                    </h4>
                    <div class="d-flex align-items-center gap-1">
                        <span class="badge bg-label-warning rounded-pill fw-semibold" id="card-prospect-count"><?php echo e(Auth::user()->role == 'Admin' ? $prospectAdminCount : $prospectCount); ?></span>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card h-100 border-0 shadow-sm custom-stat-card">
                <div class="card-body p-3">
                    ...
                    <h4 class="mb-2 fw-bold text-dark">Rp
                        <span id="card-po-sum"><?php echo e(number_format(Auth::user()->role == 'Admin' ? $poAdmin : $po, 2, ',', '.')); ?></span>
                    </h4>
                    <div class="d-flex align-items-center gap-1">
                        <span class="badge bg-label-success rounded-pill fw-semibold" id="card-po-count"><?php echo e(Auth::user()->role == 'Admin' ? $poAdminCount : $poCount); ?></span>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card h-100 border-0 shadow-sm custom-stat-card">
                <div class="card-body p-3">
                    ...
                    <h4 class="mb-2 fw-bold text-dark">Rp
                        <span id="card-loss-sum"><?php echo e(number_format(Auth::user()->role == 'Admin' ? $lossAdmin : $loss, 2, ',', '.')); ?></span>
                    </h4>
                    <div class="d-flex align-items-center gap-1">
                        <span class="badge bg-label-danger rounded-pill fw-semibold" id="card-loss-count"><?php echo e(Auth::user()->role == 'Admin' ? $lossAdminCount : $lossCount); ?></span>
    ...
    <?php echo $__env->make('components.modal.quotation.overhaul.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startPush('page-script'); ?>
    ...
    <script src="<?php echo e(asset('assets')); ?>/includes/table-quotation.js"></script>
    ...
    <script src="<?php echo e(asset('assets')); ?>/includes/table-loss.js"></script>
    <script src="<?php echo e(asset('assets')); ?>/includes/table-quotation-archive.js"></script>
    <script src="<?php echo e(asset('assets')); ?>/includes/table-unit-quotation.js"></script>
    <script src="<?php echo e(asset('assets')); ?>/includes/table-quotation-admin-tab.js"></script>
    <script src="<?php echo e(asset('assets')); ?>/includes/table-unit-quotation-admin.js"></script>
    <script src="<?php echo e(asset('assets')); ?>/includes/table-hot-prospect-admin.js"></script>
    <script src="<?php echo e(asset('assets')); ?>/includes/table-po-admin-tab.js"></script>
    <script src="<?php echo e(asset('assets')); ?>/includes/table-loss-admin-tab.js"></script>
...
<?php $__env->startPush('script'); ?>
    <script>
        ...
        function updateCardStats() {
            var isAdmin = <?php echo e(Auth::user()->role === 'Admin' ? 'true' : 'false'); ?>;
            ...
            $.ajax({
                url: '<?php echo e(route("quotation.card-stats")); ?>',
                type: 'GET',
                data: {
                    year: year,
                    sales_id: salesId
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/sales/quotation/index.blade.php ENDPATH**/ ?>