...
<?php $__env->startSection('content'); ?>
    <?php
        $no = 0;
    ?>
    <form action="<?php echo e(route('product-in.return-store', $id)); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <h5>Return Barang Masuk <span class="fw-bolder fs-4"><?php echo e($return->no_return); ?></span></h5>
        <div class="form-floating mb-3">
            <input type="text" class="form-control form-control-lg fw-bold fs-3" id="floatingInputFilled"
                ...
                value="<?php echo e($return->no_return); ?>">
                ...
                <div class="form-invoice-repeater source-item">
                    <div class="row">
                        <div class="col-12 col-lg-6">
                                ...
                                <select id="supplier-dropdown" class="select2 form-select invoice-item-supplier"
                                    ...
                                    <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($supp->id); ?>" data-info="<?php echo e($supp->info); ?>"
                                            <?php echo e($supp->id == @$productIn->id_supplier ? 'selected' : ''); ?>>
                            ...
                            <div class="text-muted"><?php echo e(@$productIn->supplier ?? ''); ?></div>
                        ...
                        <div class="col-6 col-lg-2">
                            <div class="form-floating form-floating-outline mb-4">
                                <select class="form-select invoice-item-info" id="info-dropdown" name="info"
                                    ...
                                    <option selected disabled><?php echo e(@$productIn->supp->info ?? 'Pilih Supplier Dulu'); ?>
                        ...
                        <div class="col-6 col-lg-2">
                            <div class="form-floating form-floating-outline mb-4">
                                <input class="form-control" type="date" id="Date" name="date"
                                    ...
                                    value="<?php echo e(old('date', @$return->date ?? now()->format('Y-m-d'))); ?>"
                                    >
                                <?php if(empty($return->date)): ?>
                                ...
                                <div class="d-flex border rounded position-relative pe-0">
                                    <div class="row w-100 p-3">
                                        <div class="col-md-4 col-12 mb-md-0 mb-3">
                                            ...
                                            <div class="form-floating form-floating-outline mb-2">
                                                <select id="replacement-dropdown-<?php echo e($product->id); ?>"
                                                    ...
                                                    <option selected>
                                                        <?php echo e($product->replacement->product->description); ?>
                                        ...
                                        <div class="col-md-1 col-12 mb-md-0 mb-3">
                                            ...
                                            <input type="number" class="form-control mb-3 invoice-item-qty"
                                                ...
                                                data-id="<?php echo e($no); ?>" min="1" value="<?php echo e($product->qty); ?>"
                                                disabled>
                                        </div>
                                        <div class="col-md-1 col-12 mb-md-0 mb-3">
                                            ...
                                            <div class="form-floating form-floating-outline mb-4">
                                                <select class="form-select invoice-item-warehouse" id="warehouse-1"
                                                    ...
                                                    <option selected>
                                                        <?php echo e($product->return->pending->product_out->detail[$no - 1]->warehouse); ?>

                                                    </option>
                                                </select>
                                                <input class="form-control" type="text"
                                                    name="warehouse[]"
                                                    value="<?php echo e($product->return->pending->product_out->detail[$no - 1]->warehouse); ?>"
                                                    hidden>
                                            </div>
                                        </div>
                                        <div class="col-md-2 col-12 mb-md-0 mb-3">
                                            <p class="mb-2 repeater-title">Price</p>
                                            <div class="input-group" data-price="<?php echo e($no); ?>">
                                                <span class="input-group-text">Rp. </span>
                                                <input type="text" class="form-control invoice-item-price-label"
                                                    id="price-label" data-id="<?php echo e($no); ?>" min="0"
                                                    placeholder="Put Price Here" data-type="currency"
                                                    pattern="^[0-9]\d{0,2}(\.\d{3})*$" @focus="focused = true"
                                                    @blur="focused = false"
                                                    value="<?php echo e(number_format($product->return->pending->product_out->detail[$no - 1]->price, 0, ',', '.')); ?>">
                                                <input class="form-control invoice-item-price" type="number"
                                                    name="price[]" id="price-<?php echo e($no); ?>"
                                                    value="<?php echo e($product->return->pending->product_out->detail[$no - 1]->price); ?>"
                                                    hidden>
                                            </div>
                                        </div>
                                        <div class="col-md-2 col-12 mb-md-0 mb-3">
                                            <p class="mb-2 repeater-title">Discount</p>
                                            <div class="input-group" data-disc="<?php echo e($no); ?>">
                                                <span class="input-group-text">Rp. </span>
                                                <input type="text" class="form-control invoice-item-disc-label"
                                                    id="disc-label" data-id="<?php echo e($no); ?>" min="0"
                                                ...
                                                <input class="form-control invoice-item-disc" type="number"
                                                    name="disc[]" id="disc-<?php echo e($no); ?>"
                                                    value="<?php echo e(old('disc[]')); ?>" hidden>
                                            </div>
                                        </div>
                                        <div class="col-md-2 col-12 pe-0">
                                            <p class="mb-2 repeater-title">Amount</p>
                                            <p class="mb-0 amount-label" id="amount-label-<?php echo e($no); ?>"
                                                data-id="<?php echo e($no); ?>">
                                                <?php echo e(number_format($product->return->pending->product_out->detail[$no - 1]->price * $product->qty, 0, ',', '.')); ?>

                                            </p>
                                            <input type="number" class="form-control invoice-item-amount"
                                                name="amount[]" id="amount-<?php echo e($no); ?>"
                                                data-id="<?php echo e($no); ?>" min="0"
                                                value="<?php echo e($product->return->pending->product_out->detail[$no - 1]->price * $product->qty); ?>"
                                                hidden>
                                        </div>
                                    </div>
                                    <div
                        ...
                        <div class="col-lg-4 col-12">
                            ...
                            <div class="input-group" data-subtotal="1">
                                ...
                                <input class="form-control invoice-item-subtotal" type="number" name="subtotal"
                                    id="subtotal" value="<?php echo e($subtotal); ?>" hidden>
                                <input class="form-control invoice-item-total-no-tax" type="number" name="total_no_tax"
                                    id="totalNoTax" value="<?php echo e($subtotal); ?>" hidden>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-1">
                        ...
                        <div class="col-lg-4 col-12">
                            ...
                            <div class="input-group" data-shipping="1">
                                ...
                                <input type="text" class="form-control invoice-item-shipping-label"
                                    ...
                                    @blur="focused = false" value="<?php echo e(number_format(0, 0, ',', '.')); ?>">
                        ...
                        <div class="col-lg-4 col-12">
                            ...
                            <div class="input-group" data-total="1">
                                ...
                                <input class="form-control invoice-item-total" type="number" name="total"
                                    id="total" value="<?php echo e($subtotal); ?>" hidden>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/warehouse/product-in/return.blade.php ENDPATH**/ ?>