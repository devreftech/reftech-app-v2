<form action="<?php echo e(route('change_date.delivery', $delivery->id)); ?>" method="post" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="modal-onboarding modal modal-xl fade animate__animated" id="changeDate" tabindex="-1"
                ...
                <?php if($delivery->type == 'ekspedisi'): ?>
                    <div class="modal-body p-0">
                        <div class="onboarding-content mb-0">
                            <h4 class="onboarding-title text-body"> Change Date and Address of
                                    ...
                                    <div class="col-12 mb-3">
                                        <div class="form-floating form-floating-outline">
                                            <select class="select2 form-select" id="selectAddress"
                                                ...
                                                <option value="1"
                                                    <?php echo e(old('address', $delivery->destination) == '1' ? 'selected' : ''); ?>>
                                                    <?php echo e($quote->pic->client->address); ?>

                                                </option>
                                                <option value="2"
                                                    <?php echo e(old('address', $delivery->destination) == '2' ? 'selected' : ''); ?>>
                                    ...
                                    <div class="col-12  mb-3">
                                        <div class="form-floating form-floating-outline">
                                            <input class="form-control" type="date" id="html5-date-input"
                                                name="date" value="<?php echo e($delivery->date); ?>">
...
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/accounting/delivery/change-date.blade.php ENDPATH**/ ?>