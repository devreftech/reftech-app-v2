        ...
        <div class="card-body pt-0 pb-4">
            <div class="d-flex flex-column flex-md-row align-items-center align-items-md-end gap-3" style="margin-top: -50px;">
                <div class="position-relative">
                    <img src="<?php echo e($userAvatar); ?>" alt="<?php echo e($user->name); ?>" class="rounded-circle border border-4 border-white shadow" style="width: 110px; height: 110px; object-fit: cover;">
                ...
                <div class="flex-grow-1 text-center text-md-start">
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-start gap-2 mb-2">
                        <span class="badge bg-label-primary px-2.5 py-1 fw-semibold"><i class="mdi mdi-shield-account-outline me-1"></i><?php echo e($user->role); ?></span>
                        <?php if($user->code): ?>
                            <span class="badge bg-label-warning px-2.5 py-1 fw-semibold"><i class="mdi mdi-ticket-confirmation-outline me-1"></i>Code: <?php echo e($user->code); ?></span>
                        <?php endif; ?>
                        <?php if($user->area): ?>
                            <span class="badge bg-label-info px-2.5 py-1 fw-semibold"><i class="mdi mdi-map-marker-outline me-1"></i><?php echo e($user->area); ?></span>
                        <?php endif; ?>
                        <span class="badge bg-label-secondary px-2.5 py-1 fw-semibold">
                            <i class="mdi mdi-calendar-blank-outline me-1"></i>Joined <?php echo e($user->created_date ? \Carbon\Carbon::parse($user->created_date)->format('M Y') : ($user->created_at ? $user->created_at->format('M Y') : '-')); ?>

                        </span>
                    </div>
                </div>
                <div class="d-flex gap-2">
                    <a href="<?php echo e(route('profile.edit', Auth::user()->id)); ?>" class="btn btn-primary shadow-sm">
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card border-0 shadow-sm h-100 profile-kpi-card">
                <div class="card-body p-3">
                    ...
                    <h3 class="mb-1 fw-bold text-dark"><?php echo e(number_format($totalQuotations)); ?></h3>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card border-0 shadow-sm h-100 profile-kpi-card">
                <div class="card-body p-3">
                    ...
                    <h3 class="mb-1 fw-bold text-dark"><?php echo e(number_format($totalDonePo)); ?></h3>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card border-0 shadow-sm h-100 profile-kpi-card">
                <div class="card-body p-3">
                    ...
                    <h3 class="mb-1 fw-bold text-dark"><?php echo e(number_format($totalClients)); ?></h3>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card border-0 shadow-sm h-100 profile-kpi-card">
                <div class="card-body p-3">
                    ...
                    <h3 class="mb-1 fw-bold text-dark"><?php echo e(number_format($totalCustomers)); ?></h3>
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <li class="d-flex align-items-center py-2 border-bottom">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <span class="fw-semibold text-dark"><?php echo e($user->code ?? '-'); ?></span>
                            </div>
                        </li>
                        <li class="d-flex align-items-center py-2 border-bottom">
                        ...
                        <li class="d-flex align-items-center py-2 border-bottom">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <span class="fw-semibold text-dark"><?php echo e($user->phone ?? '-'); ?></span>
                            </div>
                        </li>
                        <li class="d-flex align-items-center py-2 border-bottom">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <span class="fw-semibold text-dark"><?php echo e($user->area ?? '-'); ?></span>
                            </div>
                        </li>
                        <li class="d-flex align-items-center py-2">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <span class="badge bg-label-primary rounded-pill"><?php echo e($user->role); ?></span>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <div class="card border-0 shadow-sm mb-4" style="border-radius: 12px;">
                ...
                <div class="card-body py-3">
                    <div id="payment-templates-list">
                        <?php $__empty_1 = true; $__currentLoopData = $paymentTemplates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="p-3 rounded border mb-3 position-relative bg-light-subtle">
                                <div class="d-flex align-items-center justify-content-between mb-1">
                                    <h6 class="fw-bold text-dark mb-0"><?php echo e($pt->name); ?></h6>
                                    <div>
                                ...
                                <div class="mb-2">
                                    <?php $cList = $pt->clients_list; ?>
                                    <?php if($cList->count() > 0): ?>
                                        <?php $__currentLoopData = $cList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="badge bg-label-info rounded-pill me-1 mb-1" title="Khusus Client: <?php echo e($cItem->company); ?>">
                                                <i class="mdi mdi-domain me-1"></i><?php echo e($cItem->company); ?>
                                ...
                                <p class="text-muted small mb-2 text-wrap" style="white-space: pre-line;"><?php echo e($pt->payment_term); ?></p>
                                <?php
                                    $cIds = $pt->client_ids ?: ($pt->id_client ? [(int)$pt->id_client] : []);
                                ?>
                                <div class="d-flex gap-2 justify-content-end pt-1 border-top">
                                    <?php if(!$pt->is_default): ?>
                                        <button type="button" class="btn btn-xs btn-label-success btn-set-default-template" data-id="<?php echo e($pt->id); ?>">
                                            Set Default
                                        </button>
                                    <?php endif; ?>
                                    <button type="button" class="btn btn-xs btn-label-primary btn-edit-template" 
                                        data-id="<?php echo e($pt->id); ?>" 
                                        data-name="<?php echo e($pt->name); ?>" 
                                        data-term="<?php echo e($pt->payment_term); ?>" 
                                        data-clients="<?php echo e(json_encode($cIds)); ?>" 
                                        data-default="<?php echo e($pt->is_default ? 1 : 0); ?>">
                                        Edit
                                    </button>
                                    <button type="button" class="btn btn-xs btn-label-danger btn-delete-template" data-id="<?php echo e($pt->id); ?>">
                                        Hapus
                                    </button>
                                </div>
                            </div>
            ...
            <div class="card border-0 shadow-sm" style="border-radius: 12px;">
                ...
                <div class="card-body py-3">
                    <div class="d-grid gap-2">
                        <a href="<?php echo e(route('unit-quotation.create')); ?>" class="btn btn-outline-primary btn-sm text-start py-2">
                            <i class="mdi mdi-sparkles text-warning me-2 fs-6"></i> Create Smart Quote
                        </a>
                        <a href="<?php echo e(route('quotation.index')); ?>" class="btn btn-outline-secondary btn-sm text-start py-2">
                            <i class="mdi mdi-file-document-outline me-2 fs-6"></i> Quotation Dashboard
                        </a>
                        <a href="<?php echo e(route('profile.edit', Auth::user()->id)); ?>" class="btn btn-outline-secondary btn-sm text-start py-2">
                    ...
                    <div class="row g-3">
                        <div class="col-sm-6 col-md-4">
                            <div class="p-3 rounded border bg-light-subtle text-center">
                                ...
                                <h4 class="fw-bold mb-1 text-dark"><?php echo e(number_format($countHotProspect)); ?></h4>
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="p-3 rounded border bg-light-subtle text-center">
                                ...
                                <h4 class="fw-bold mb-1 text-dark"><?php echo e(number_format($countNegotiation)); ?></h4>
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="p-3 rounded border bg-light-subtle text-center">
                                ...
                                <h4 class="fw-bold mb-1 text-dark"><?php echo e(number_format($countPoReceived)); ?></h4>
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="p-3 rounded border bg-light-subtle text-center">
                                ...
                                <h4 class="fw-bold mb-1 text-dark"><?php echo e(number_format($countDraft)); ?></h4>
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="p-3 rounded border bg-light-subtle text-center">
                                ...
                                <h4 class="fw-bold mb-1 text-dark"><?php echo e(number_format($countLoss)); ?></h4>
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="p-3 rounded border bg-primary-subtle text-center">
                                ...
                                <h4 class="fw-bold mb-1 text-primary"><?php echo e(number_format($totalQuotations)); ?></h4>
                        ...
                        <div class="col-6 col-sm-4 col-md-3">
                            <div class="d-flex align-items-center p-2 rounded border">
                                ...
                                <div>
                                    ...
                                    <span class="fw-bold text-dark"><?php echo e(number_format($typeUnit)); ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-sm-4 col-md-3">
                            <div class="d-flex align-items-center p-2 rounded border">
                                ...
                                <div>
                                    ...
                                    <span class="fw-bold text-dark"><?php echo e(number_format($typeParts)); ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-sm-4 col-md-3">
                            <div class="d-flex align-items-center p-2 rounded border">
                                ...
                                <div>
                                    ...
                                    <span class="fw-bold text-dark"><?php echo e(number_format($typeService)); ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-sm-4 col-md-3">
                            <div class="d-flex align-items-center p-2 rounded border">
                                ...
                                <div>
                                    ...
                                    <span class="fw-bold text-dark"><?php echo e(number_format($typeRental)); ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-sm-4 col-md-3">
                            <div class="d-flex align-items-center p-2 rounded border">
                                ...
                                <div>
                                    ...
                                    <span class="fw-bold text-dark"><?php echo e(number_format($typeProject)); ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-sm-4 col-md-3">
                            <div class="d-flex align-items-center p-2 rounded border">
                                ...
                                <div>
                                    ...
                                    <span class="fw-bold text-dark"><?php echo e(number_format($typePiping)); ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-sm-4 col-md-3">
                            <div class="d-flex align-items-center p-2 rounded border">
                                ...
                                <div>
                                    ...
                                    <span class="fw-bold text-dark"><?php echo e(number_format($typeAirAudit)); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select id="pt-client" name="client_ids[]" class="select2 form-select" multiple="multiple" style="width: 100%;">
                                <?php $__currentLoopData = $salesClients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($sc->id); ?>"><?php echo e($sc->company); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/sales/user/profile.blade.php ENDPATH**/ ?>