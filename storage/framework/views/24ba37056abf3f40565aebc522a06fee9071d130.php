...
<script>
    (function() {
        ...
        $(document).on('submit', '#bastForm', function(e) {
            ...
            const isEdit = !!bastId;
            const url = isEdit ? `<?php echo e(url('/bast')); ?>/${bastId}` : `<?php echo e(route('bast.store')); ?>`;
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/bast/create.blade.php ENDPATH**/ ?>