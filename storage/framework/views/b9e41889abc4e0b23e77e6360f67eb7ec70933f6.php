            ...
            <div class="card">
                <div class="card-body">
                    <a class="btn btn-primary btn-outline-secondary d-grid w-100 mb-3 waves-effect" target="_blank"
                        href="<?php echo e(route('payable.print', $payable->id)); ?>">
                        Download
                    </a>
                    
                    <a href="#" class="btn btn-danger d-grid w-100 waves-effect delete-payable mb-3"
                        data-id="<?php echo e($payable->id); ?>">Delete</a>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/finance/payable/detail.blade.php ENDPATH**/ ?>