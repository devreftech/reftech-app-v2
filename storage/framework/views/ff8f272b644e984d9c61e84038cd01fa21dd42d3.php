                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-floating form-floating-outline mb-2">
                                <input class="form-control fw-bold bg-light" type="text" id="no-expense-input"
                                    name="no_expense" value="<?php echo e($noExpense); ?>" readonly>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/finance/expense/form.blade.php ENDPATH**/ ?>