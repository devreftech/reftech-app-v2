...
<?php $__env->startSection('content'); ?>
    ...
    <form id="formAuthentication" class="mb-3 fv-plugins-bootstrap5 fv-plugins-framework"
        action="<?php echo e(route('template.update', $machine->id)); ?>" method="post" enctype="multipart/form-data">
        <?php echo method_field('PATCH'); ?>
        <?php echo csrf_field(); ?>
        <div class="card">
            <div class="card-header">
                <h3>Create Template of <?php echo e($machine->brand); ?> <?php echo e($machine->sku); ?></h3>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    <div class="float-end">
                        <a href="<?php echo e(route('template.index')); ?>" type="button" class="btn btn-lg btn-outline-secondary">
                            Back
                        </a>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/admin/template/edit.blade.php ENDPATH**/ ?>