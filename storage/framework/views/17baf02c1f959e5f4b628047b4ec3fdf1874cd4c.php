            ...
            <div class="card-body">
                <div class="d-flex align-items-center mb-2">
                    ...
                    <div>
                        ...
                        <h5 class="mb-0"><?php echo e($acctInvoiceBelumDibuatCount); ?></h5>
                    </div>
                </div>
                <small class="text-muted">Total Rp <?php echo e(number_format($acctInvoiceBelumDibuatTotal, 0, ',', '.')); ?></small><br>
                <a href="<?php echo e(route('invoice.request')); ?>" class="small">Lihat Detail <i class="mdi mdi-arrow-right"></i></a>
            </div>
        </div>
    </div>
    <div class="col-sm-6 col-lg-3 mb-4">
            ...
            <div class="card-body">
                <div class="d-flex align-items-center mb-2">
                    ...
                    <div>
                        ...
                        <h5 class="mb-0"><?php echo e($acctApUnpaidCount); ?></h5>
                    </div>
                </div>
                <small class="text-muted">Total Rp <?php echo e(number_format($acctApUnpaidTotal, 0, ',', '.')); ?></small><br>
                <a href="<?php echo e(route('payable.index_invoice')); ?>" class="small">Lihat Detail <i class="mdi mdi-arrow-right"></i></a>
            </div>
        </div>
    </div>
    <div class="col-sm-6 col-lg-3 mb-4">
            ...
            <div class="card-body">
                <div class="d-flex align-items-center mb-2">
                    ...
                    <div>
                        ...
                        <h5 class="mb-0"><?php echo e($acctApPaidMonthCount); ?></h5>
                    </div>
                </div>
                <small class="text-muted">Total Rp <?php echo e(number_format($acctApPaidMonthTotal, 0, ',', '.')); ?></small><br>
                <a href="<?php echo e(route('payable.index_invoice')); ?>" class="small">Lihat Detail <i class="mdi mdi-arrow-right"></i></a>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center mb-2">
                    ...
                    <div>
                        ...
                        <h5 class="mb-0"><?php echo e($acctFixedAssetMonthCount); ?></h5>
                    </div>
                </div>
                <small class="text-muted">Total Rp <?php echo e(number_format($acctFixedAssetMonthTotal, 0, ',', '.')); ?></small><br>
                <a href="<?php echo e(route('fixed.index')); ?>" class="small">Lihat Detail <i class="mdi mdi-arrow-right"></i></a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-sm-6 col-lg-3 mb-4">
        <div class="card h-100">
            <div class="card-body">
                ...
                <h5 class="mb-1">Rp <?php echo e(number_format($acctApUnpaidTotal, 0, ',', '.')); ?></h5>
                <small class="text-muted">Total <?php echo e($acctApSupplierCount); ?> Supplier</small><br>
                <a href="<?php echo e(route('payable.index_invoice')); ?>" class="small">Lihat Aging AP <i class="mdi mdi-arrow-right"></i></a>
            </div>
        </div>
    </div>
    <div class="col-sm-6 col-lg-3 mb-4">
        <div class="card h-100">
            <div class="card-body">
                ...
                <h5 class="mb-1">Rp <?php echo e(number_format($acctArOutstanding, 0, ',', '.')); ?></h5>
                <small class="text-muted">Total <?php echo e($acctArCustomerCount); ?> Customer</small><br>
                <a href="<?php echo e(route('payment_index.aging')); ?>" class="small">Lihat Aging AR <i class="mdi mdi-arrow-right"></i></a>
            </div>
        </div>
    </div>
    <div class="col-sm-6 col-lg-3 mb-4">
        <div class="card h-100">
            <div class="card-body">
                ...
                <h5 class="mb-1">Rp <?php echo e(number_format($acctExpenseMonth, 0, ',', '.')); ?></h5>
                <small class="<?php echo e($acctExpenseChangePct <= 0 ? 'text-success' : 'text-danger'); ?>">
                    <i class="mdi <?php echo e($acctExpenseChangePct <= 0 ? 'mdi-arrow-down' : 'mdi-arrow-up'); ?>"></i>
                    <?php echo e(abs($acctExpenseChangePct)); ?>% dari bulan lalu
                </small>
            </div>
        </div>
    </div>
    <div class="col-sm-6 col-lg-3 mb-4">
        <div class="card h-100">
            <div class="card-body">
                ...
                <h5 class="mb-1">Rp <?php echo e(number_format($acctCogsMonth, 0, ',', '.')); ?></h5>
                <small class="<?php echo e($acctCogsChangePct <= 0 ? 'text-success' : 'text-danger'); ?>">
                    <i class="mdi <?php echo e($acctCogsChangePct <= 0 ? 'mdi-arrow-down' : 'mdi-arrow-up'); ?>"></i>
                    <?php echo e(abs($acctCogsChangePct)); ?>% dari bulan lalu
                </small>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-6 mb-4">
        <div class="card h-100">
            <div class="card-header">
                ...
                <small class="text-muted">Total Rp <?php echo e(number_format($acctArOutstanding, 0, ',', '.')); ?></small>
            </div>
            <div class="card-body">
...
<div class="row mb-2">
    ...
    <div class="col-lg-7 mb-4">
        <div class="card h-100">
            ...
            <div class="card-body">
                <?php if($acctExpenseByAccount->isEmpty()): ?>
                ...
                <div class="tab-content p-0">
                    <div class="tab-pane fade show active" id="acct-doc-bill" role="tabpanel">
                        <div class="table-responsive">
                            <table class="table table-sm mb-0">
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $acctRecentSupplierBill; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td>
                                                <a href="<?php echo e(route('product-in.show', $bill->id)); ?>" class="fw-semibold text-primary-hover d-block"><?php echo e($bill->no_product_in); ?></a>
                                                <small class="text-muted"><?php echo e($bill->supplier); ?></small>
                                            </td>
                                            <td class="text-end">
                                                Rp <?php echo e(number_format($bill->total ?? 0, 0, ',', '.')); ?><br>
                                                <span class="badge bg-label-<?php echo e($bill->accept == '1' ? 'success' : 'warning'); ?>"><?php echo e($bill->accept == '1' ? 'Lunas' : 'Belum Lunas'); ?></span>
                                            </td>
                                        </tr>
                    ...
                    <div class="tab-pane fade" id="acct-doc-invoice" role="tabpanel">
                        <div class="table-responsive">
                            <table class="table table-sm mb-0">
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $acctRecentCustomerInvoice; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td>
                                                <a href="<?php echo e(route('invoice.show', $inv->id)); ?>" class="fw-semibold text-primary-hover d-block"><?php echo e($inv->no_invoice); ?></a>
                                                <small class="text-muted"><?php echo e($inv->company); ?></small>
                                            </td>
                                            <td class="text-end">Rp <?php echo e(number_format($inv->harga_total ?? 0, 0, ',', '.')); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <tr><td class="text-center text-muted">Belum ada data.</td></tr>
                                    <?php endif; ?>
                    ...
                    <div class="tab-pane fade" id="acct-doc-expense" role="tabpanel">
                        <div class="table-responsive">
                            <table class="table table-sm mb-0">
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $acctRecentExpense; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td>
                                                <a href="<?php echo e(route('expense.show', $exp->id)); ?>" class="fw-semibold text-primary-hover d-block"><?php echo e($exp->no_expense); ?></a>
                                                <small class="text-muted"><?php echo e($exp->memo); ?></small>
                                            </td>
                                            <td class="text-end">Rp <?php echo e(number_format($exp->amount ?? 0, 0, ',', '.')); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <tr><td class="text-center text-muted">Belum ada data.</td></tr>
                                    <?php endif; ?>
                    ...
                    <div class="tab-pane fade" id="acct-doc-fa" role="tabpanel">
                        <div class="table-responsive">
                            <table class="table table-sm mb-0">
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $acctRecentFixedAsset; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td>
                                                <a href="<?php echo e(route('fixed.show', $fa->id)); ?>" class="fw-semibold text-primary-hover d-block"><?php echo e($fa->code); ?></a>
                                                <small class="text-muted"><?php echo e($fa->desc); ?></small>
                                            </td>
                                            <td class="text-end">Rp <?php echo e(number_format($fa->total ?? 0, 0, ',', '.')); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <tr><td class="text-center text-muted">Belum ada data.</td></tr>
                                    <?php endif; ?>
            ...
            <div class="card-body">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item d-flex align-items-center justify-content-between px-0">
                        ...
                        <a href="<?php echo e(route('invoice.request')); ?>" class="badge bg-label-primary text-decoration-none"><?php echo e($acctInvoiceBelumDibuatCount); ?></a>
                    </li>
                    <li class="list-group-item d-flex align-items-center justify-content-between px-0">
                        <span><i class="mdi mdi-file-clock-outline text-warning me-2"></i>Review Supplier Bill</span>
                        <a href="<?php echo e(route('payable.index_invoice')); ?>" class="badge bg-label-warning text-decoration-none"><?php echo e($acctApUnpaidCount); ?></a>
                    </li>
                    <li class="list-group-item d-flex align-items-center justify-content-between px-0">
                        <span><i class="mdi mdi-account-cash-outline text-info me-2"></i>Review Piutang Tempo (AR)</span>
                        <a href="<?php echo e(route('payment_index.aging')); ?>" class="badge bg-label-info text-decoration-none"><?php echo e(count($acctTempoPayments)); ?></a>
                    </li>
                    <li class="list-group-item d-flex align-items-center justify-content-between px-0">
                        <span><i class="mdi mdi-office-building-outline text-success me-2"></i>Fixed Asset Baru Bulan Ini</span>
                        <a href="<?php echo e(route('fixed.index')); ?>" class="badge bg-label-success text-decoration-none"><?php echo e($acctFixedAssetMonthCount); ?></a>
                    </li>
                    <li class="list-group-item d-flex align-items-center justify-content-between px-0">
            ...
            <div class="card-body">
                <div class="row text-center g-3">
                    <div class="col-6 col-md-2">
                        <a href="<?php echo e(route('invoice.request')); ?>" class="text-decoration-none">
                    ...
                    <div class="col-6 col-md-2">
                        <a href="<?php echo e(route('payable.index_invoice')); ?>" class="text-decoration-none">
                    ...
                    <div class="col-6 col-md-2">
                        <a href="<?php echo e(route('expense.create')); ?>" class="text-decoration-none">
                    ...
                    <div class="col-6 col-md-2">
                        <a href="<?php echo e(route('fixed.create')); ?>" class="text-decoration-none">
                    ...
                    <div class="col-6 col-md-2">
                        <a href="<?php echo e(route('report.finance')); ?>" class="text-decoration-none">
        ...
        (function () {
            ...
            if (agingArEl) {
                new ApexCharts(agingArEl, {
                    ...
                    series: <?php echo json_encode(array_values($acctArAgingBuckets), 15, 512) ?>,
            ...
            if (billStatusEl) {
                new ApexCharts(billStatusEl, {
                    ...
                    series: [<?php echo e((int) $acctApPaidTotalAll); ?>, <?php echo e((int) $acctApUnpaidCount); ?>],
            ...
            if (expenseByAccountEl) {
                new ApexCharts(expenseByAccountEl, {
                    ...
                    series: [{ name: 'Beban', data: <?php echo json_encode($acctExpenseByAccount->pluck('total'), 15, 512) ?> }],
                    xaxis: {
                        categories: <?php echo json_encode($acctExpenseByAccount->pluck('name'), 15, 512) ?>,
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/accounting/dashboard/_content.blade.php ENDPATH**/ ?>