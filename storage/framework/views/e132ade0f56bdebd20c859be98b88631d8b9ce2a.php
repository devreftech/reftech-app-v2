<?php $__env->startSection('title', 'Selling Contract — ' . $contract->no_contract); ?>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between flex-xl-row flex-md-column flex-sm-row flex-column">
                        ...
                        <div class="text-end">
                            ...
                            <div><span class="fw-bolder">#<?php echo e($contract->no_contract); ?></span></div>
                            <div class="mt-1">
                                <span class="text-muted"><?php echo e(Carbon\Carbon::parse($contract->date)->format('d-m-Y')); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $unitQuote->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr style="font-size:13px;">
                                    ...
                                    <td class="align-top"><?php echo e($item->qty); ?> <?php echo e($item->info_qty ?? 'Unit'); ?></td>
                                    <td class="align-top text-end">Rp <?php echo e(number_format($item->price, 0, '', '.')); ?></td>
                                    <td class="align-top text-end">Rp <?php echo e(number_format($item->amount, 0, '', '.')); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr class="border-top" style="font-size:13px;">
                                ...
                                <td class="text-end px-4 py-4">
                                    <p class="fw-semibold mb-2">Rp <?php echo e(number_format($unitQuote->subtotal, 0, '', '.')); ?></p>
                                    <?php if($unitQuote->diskon > 0): ?>
                                        <p class="fw-semibold mb-2">- Rp <?php echo e(number_format($unitQuote->discount_amount, 0, '', '.')); ?></p>
                                        <p class="fw-semibold mb-2">Rp <?php echo e(number_format($afterDisc, 0, '', '.')); ?></p>
                                    <?php endif; ?>
                                    <p class="fw-semibold mb-2"><?php echo e($unitQuote->tax ? 'Rp ' . number_format($unitQuote->tax_amount, 0, '', '.') : '0'); ?></p>
                                </td>
                            </tr>
        ...
        <div class="col-xl-3 col-md-4 col-12 invoice-actions">
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <?php elseif($contract->level == '1'): ?>
                        <a class="btn btn-primary d-grid w-100 mb-3 waves-effect" target="_blank"
                            href="<?php echo e(route('contract.print', $contract->id)); ?>">
                    ...
                    <?php endif; ?>
                    <a href="<?php echo e(route('unit-quotation.show', $unitQuote->id)); ?>"
            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between mb-1" style="font-size:13px;">
                        ...
                        <span class="fw-medium"><?php echo e($contract->no_contract); ?></span>
                    </div>
                    <div class="d-flex justify-content-between mb-1" style="font-size:13px;">
                        <span class="text-muted">Type</span>
                        <span><?php echo e($contract->type); ?></span>
                    </div>
                    <div class="d-flex justify-content-between mb-1" style="font-size:13px;">
                        <span class="text-muted">Date</span>
                        <span><?php echo e(Carbon\Carbon::parse($contract->date)->format('d/m/Y')); ?></span>
                    </div>
                    <div class="d-flex justify-content-between mb-1" style="font-size:13px;">
                        <span class="text-muted">Client</span>
                        <span><?php echo e($unitQuote->client?->company ?? '-'); ?></span>
                    </div>
                    <div class="d-flex justify-content-between mb-1" style="font-size:13px;">
                        <span class="text-muted">Quotation</span>
                        <a href="<?php echo e(route('unit-quotation.show', $unitQuote->id)); ?>">
                            <?php echo e($unitQuote->no_quote); ?>
                ...
                <form action="<?php echo e(route('accept.contract', $contract->id)); ?>" method="POST">
                    ...
                    <div class="modal-body">
                        <p class="text-muted mb-3">
                            Request dari <strong><?php echo e($unitQuote->client?->company ?? '-'); ?></strong>
                            &nbsp;·&nbsp; <?php echo e($unitQuote->no_quote); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="no_contract"
                                value="<?php echo e($formattedNumberSC); ?>/<?php echo e($unitQuote->tax ? 'P' : 'NP'); ?>/SELLCTX/RJO/<?php echo e($thisYear); ?>"
                                required>
                            <div class="form-text text-danger">
                                Last No SC: <?php echo e(\App\Models\Contract::where('type','Selling')->where('level','1')->whereYear('date',now())->orderByDesc('id')->value('no_contract') ?? '-'); ?>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/accounting/contract/detail-unit.blade.php ENDPATH**/ ?>