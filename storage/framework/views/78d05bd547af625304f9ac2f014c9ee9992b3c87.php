...
<?php $__env->startSection('title', 'Product Out'); ?>
<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('product-out.store')); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="row">
            <div class="col-12 col-md-6">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control form-control-lg fw-bold fs-3" id="floatingInputFilled"
                        ...
                        value="<?php echo e($invoice->no_invoice); ?>">
            ...
            <div class="col-12 col-md-6">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control form-control-lg fw-bold fs-3" id="floatingInputFilled"
                        ...
                        value="<?php echo e($invoice->no_po); ?>">
                ...
                <div class="form-invoice-repeater source-item">
                    <div class="row">
                        <div class="col-12 col-lg-6 mb-3 mb-lg-0">
                            <textarea class="form-control" rows="2" placeholder="Detail Customers" name="detail_client"
                                style="min-height: 100px"><?php echo e($invoice->quote->pic->client->company); ?></textarea>
                        </div>
                    ...
                    <div class="mb-3" data-repeater-list="group-a">
                        <?php
                            $row = 0;
                        ?>
                        <?php $__currentLoopData = $detailQ; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $row++;
                            ?>
                                    ...
                                    <div class="row w-100 p-3">
                                        <div class="col-md-6 col-12 mb-md-0 mb-3">
                                            ...
                                            <div class="form-floating form-floating-outline mb-2">
                                                <select id="equivalent-dropdown"
                                                    ...
                                                    <option value="<?php echo e($detail->equivalent->id); ?>"
                                                        data-commodity="<?php echo e($detail->equivalent->id_product); ?>" selected>
                                                        <?php echo e($detail->equivalent->pn); ?> ||
                                                        <?php echo e($detail->equivalent->product->commodity); ?> -
                                                        <?php echo e($detail->equivalent->product->go == 'Genuine' ? 'G' : 'R'); ?>
                                            ...
                                            <input type="text" class="form-control invoice-item-equivalent"
                                                ...
                                                value="<?php echo e($detail->id_equivalent); ?>" hidden>
                                            <div class="form-floating form-floating-outline mb-2">
                                                <select id="replacement-dropdown-1"
                                                    class="select2 form-select invoice-item-replacement" data-id="<?php echo e($row); ?>"
                                                    data-allow-clear="true" name="replacement[]">
                                                    <option> ---- Choose Replacement Here ---- </option>
                                                    <?php $__currentLoopData = $dProduct; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($product->id_product == $detail->equivalent->product->id): ?>
                                                            <option value="<?php echo e($product->id); ?>">
                                                                <?php echo e($product->replacement); ?> </option>
                                                        <?php endif; ?>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                        ...
                                        <div class="col-md-1 col-12 mb-md-0 mb-3">
                                            ...
                                            <input type="number" class="form-control mb-3 invoice-item-qty"
                                                ...
                                                value="<?php echo e($detail->qty); ?>" disabled>
                                            <p class="info-max-label" id="info-max-<?php echo e($row); ?>"></p>
                                            <input type="number" class="form-control invoice-item-qty" name="qty[]"
                                                id="qty-<?php echo e($row); ?>" data-id="<?php echo e($row); ?>" value="<?php echo e($detail->qty); ?>" hidden>
                                        </div>
                                        <div class="col-md-1 col-12 mb-md-0 mb-3">
                                        ...
                                        <div class="col-md-2 col-12 mb-md-0 mb-3">
                                            ...
                                            <div class="input-group" data-price="1">
                                                ...
                                                <input type="text" class="form-control invoice-item-price-label"
                                                    ...
                                                    @blur="focused = false"
                                                    value="<?php echo e(number_format($detail->price, 2, ',', '.')); ?>" disabled>
                                                <input class="form-control invoice-item-price" type="number"
                                                    name="price[]" id="price-1" value="<?php echo e($detail->price); ?>" hidden>
                                            </div>
                                        </div>
                                        <div class="col-md-2 col-12 pe-0">
                                            <p class="mb-2 repeater-title">Amount</p>
                                            <p class="mb-0 amount-label" id="amount-label-1" data-id="1">
                                                Rp <?php echo e(number_format($detail->amount, 2, ',', '.')); ?></p>
                                            <input type="number" class="form-control invoice-item-amount"
                                                name="amount[]" id="amount-<?php echo e($row); ?>" data-id="1" min="12"
                                                value="<?php echo e($detail->amount); ?>" hidden>
                                        </div>
                                    </div>
                                    <div
                        ...
                        <div class="col-lg-4 col-12">
                            ...
                            <div class="input-group" data-shipping="1">
                                ...
                                <input type="text" class="form-control invoice-item-shipping-label"
                                    ...
                                    @blur="focused = false"
                                    value="<?php echo e(old('shipping', @$pOut->shipping ? number_format(@$pOut->shipping, 0, '', '.') : '0')); ?>">
                                <input class="form-control invoice-item-shipping" type="number" name="shipping"
                                    id="shipping" value="<?php echo e(old('shipping', @$pOut->shipping ?? '0')); ?>" hidden>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-4 col-12">
                            ...
                            <div class="input-group" data-total="1">
                                ...
                                <p class="form-control invoice-item-total-label h-px-25 mb-0" id="total-label">
                                    <?php echo e(number_format( $invoice->quote->subtotal, 0 , ',', '.')); ?> </p>
                                <input class="form-control invoice-item-total" type="number" name="total"
                                    id="total" value="<?php echo e($invoice->quote->subtotal); ?>" hidden>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="float-end">
                        <a href="<?php echo e(route('product-out.index')); ?>" type="button"
...
<?php $__env->startPush('after-script'); ?>
    ...
    <script src="<?php echo e(asset('assets')); ?>/includes/repeater/repeater-invoice-productOut.js"></script>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/warehouse/product-out/form-invoice.blade.php ENDPATH**/ ?>