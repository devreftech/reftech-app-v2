            ...
            <div class="card">
                <div class="card-body">
                    <a class="btn btn-primary btn-outline-secondary d-grid w-100 mb-3 waves-effect" target="_blank"
                        href="<?php echo e(route('opname.show_print', $opname->id)); ?>">
                        Download
                    </a>
                    <a href="#" class="btn btn-danger d-grid w-100 waves-effect delete"
                        data-id="<?php echo e($opname->id); ?>">Delete</a>
                </div>
            </div>
        </div>
        
    </div>
    <?php echo $__env->make('components.modal.warehouse.opname.form-product', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('components.modal.warehouse.opname.edit-opname', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startPush('page-script'); ?>
    ...
    <script src="<?php echo e(asset('assets')); ?>/includes/table-opname-stock.js"></script>
<?php $__env->stopPush(); ?>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/warehouse/opname/detail.blade.php ENDPATH**/ ?>