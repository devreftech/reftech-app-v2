...
<?php $__env->startSection('title', 'Form Change Warehous'); ?>
<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('change-warehouse.store')); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <?php if($errors->any()): ?>
                    ...
                    <div class="col-6 col-md-3">
                        <div class="form-floating form-floating-outline mb-2">
                            <input class="form-control" type="text" placeholder="Put Kurir Here ...." id="kurir-input"
                                name="kurir" value="<?php echo e(old('kurir')); ?>">
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/warehouse/changing/form.blade.php ENDPATH**/ ?>