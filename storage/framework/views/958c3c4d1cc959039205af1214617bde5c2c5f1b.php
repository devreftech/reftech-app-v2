...
<?php $__env->startSection('content'); ?>
    ...
    <form id="formAuthentication" class="mb-3 fv-plugins-bootstrap5 fv-plugins-framework"
        action="<?php echo e(route('template.store_template', $machine->id)); ?>"
                                        ...
                                        <div class="row w-100 p-3 pb-0">
                                            ...
                                            <div class="col-md-3 col-12 mb-md-0 mb-3">
                                                ...
                                                <div class="input-group mb-3" data-price="1">
                                                    ...
                                                    <input class="form-control invoice-item-price" type="number"
                                                        name="price[1][]" id="price-1-1" value="<?php echo e(old('price[1][]')); ?>"
                                                        hidden>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-1 col-12 mb-md-0 mb-3">
                                                ...
                                                <input type="number" class="form-control invoice-item-disc"
                                                    ...
                                                    data-id="1" min="0" value="<?php echo e(old('disc[1][]', '0')); ?>">
                                            </div>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/admin/template/form.blade.php ENDPATH**/ ?>