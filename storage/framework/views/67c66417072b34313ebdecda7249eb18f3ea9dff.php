...
<?php $__env->startSection('title', 'Buat SUO'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('suo.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <div class="card mb-4">
                    ...
                    <div class="col-md-3">
                        <div class="form-floating form-floating-outline">
                            <input type="text" class="form-control fw-bold bg-light" name="no_suo"
                                value="<?php echo e($noSuo); ?>" readonly>
                            <label>No. SUO</label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <select id="select-company" class="select2 form-select" name="company" required>
                            ...
                            <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($client->company); ?>"
                                    data-id="<?php echo e($client->id); ?>"
                                    data-address1="<?php echo e($client->address ?? ''); ?>"
                                    data-address2="<?php echo e($client->subAddress ?? ''); ?>"
                                    <?php echo e(old('company') == $client->company ? 'selected' : ''); ?>>
                    ...
                    <div class="col-12">
                        <div class="form-floating form-floating-outline">
                            <textarea class="form-control" name="notes" placeholder="Catatan tambahan"
                                style="height: 50px;"><?php echo e(old('notes')); ?></textarea>
        ...
        <div class="d-flex gap-2 justify-content-end mb-4">
            <a href="<?php echo e(route('suo.index')); ?>" class="btn btn-outline-secondary">Batal</a>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/suo/create.blade.php ENDPATH**/ ?>