...
<div class="invoice-print p-2">
    <div class="container-fluid flex-grow-1 container-p-y">
        ...
        <div class="mt-1 text-center">
            <span class=" fw-medium fs-6 badge bg-label-secondary text-black"><?php echo e($quote->title); ?></span>
        </div>
        <div class="mb-2">
                            ...
                            <tr style="font-size: 10px; border-bottom:none !important; border-top:none !important;">
                                ...
                                <td class="text-nowrap align-top py-1" style="border-bottom:none !important;">
                                    ...
                                    <?php if($product->detail != '-'): ?>
                                        <pre class="mb-0"
                                            style="font-size: 10px; font-family: Inter, sans-serif; max-width: 100%; overflow-x: auto; white-space: pre-wrap;"><?php echo e($product->detail); ?></pre>
                                    <?php endif; ?>
                                </td>
                                <td class="align-top py-1" style="border-bottom:none !important;">
                                ...
                                <td class="align-top py-1 text-end" style="border-bottom:none !important;">
                                    <p class="mb-0"><?php echo e($product->price == 0 ? 'SBO' : number_format($product->price, 0, '', '.')); ?></p>
                                </td>
                                <td class="align-top py-1" style="border-bottom:none !important;">
                                    <p class="mb-0"><?php echo e($product->disc); ?> %</p>
                                </td>
                                <td class="align-top py-1 text-end" style="border-bottom:none !important;">
                                    <p class="mb-0"><?php echo e($product->price == 0 ? 'SBO' : number_format($product->amount, 0, '', '.')); ?></p>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/sales/quotation/overhaul/detail-print.blade.php ENDPATH**/ ?>