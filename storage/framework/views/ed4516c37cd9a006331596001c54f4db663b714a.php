...
<body>
    ...
    <script>
        ...
        `;
                ...
                xhr.open('POST', "<?php echo e(route('watermark.upload')); ?>", true);
        ...
        document.getElementById('downloadBtn').addEventListener('click', function() {
            ...
            iframe.src = "<?php echo e(route('watermark.download')); ?>";
        ...
        document.getElementById('resetBtn').addEventListener('click', function() {
            ...
            fetch("<?php echo e(route('watermark.reset')); ?>", {
                    method: "POST",
                    headers: {
...
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/upload.blade.php ENDPATH**/ ?>