            ...
            <div class="col-12 col-md-4">
                <div class="card metric-card card-projection border-0" style="border-top: 4px solid #6366f1 !important;">
                    <div class="card-body p-4">
                        ...
                        <h3 class="metric-value mb-1" style="color: #6366f1;" id="summary-payment-receipt">Rp <?php echo e(number_format(@$receipt, 0, ',', '.')); ?></h3>
            ...
            <div class="col-12 col-md-4">
                <div class="card metric-card card-actual border-0" style="border-top: 4px solid #10b981 !important;">
                    <div class="card-body p-4">
                        ...
                        <h3 class="metric-value mb-1" style="color: #10b981;" id="summary-payment-confirm">Rp <?php echo e(number_format(@$confirm, 0, ',', '.')); ?></h3>
            ...
            <div class="col-12 col-md-4">
                <div class="card metric-card border-0" style="border-top: 4px solid #f59e0b !important;">
                    <div class="card-body p-4">
                        ...
                        <h3 class="metric-value mb-1" style="color: #f59e0b;" id="summary-payment-unconfirm">Rp <?php echo e(number_format(@$unconfirm, 0, ',', '.')); ?></h3>
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <select class="form-select form-select-sm" id="payment-sales-filter" style="min-width:180px;">
                                ...
                                <?php if(isset($salesUsers)): ?>
                                    <?php $__currentLoopData = $salesUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($sUser->id); ?>"><?php echo e($sUser->name); ?></option>
...
<?php $__env->startPush('page-script'); ?>
    ...
    <script src="<?php echo e(asset('assets')); ?>/includes/table-ar-payment-receipt.js"></script>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/accounting/payment/index-payment.blade.php ENDPATH**/ ?>