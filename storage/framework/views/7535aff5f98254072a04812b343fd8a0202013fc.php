...
<?php $__env->startSection('content'); ?>
    <form id="formAuthentication" class="mb-3 fv-plugins-bootstrap5 fv-plugins-framework" action="<?php echo e(route('payable.store')); ?>"
            ...
            <div class="card-body">
                <div class="form-invoice-repeater source-item">
                                    ...
                                    <div class="form-floating form-floating-outline mb-2">
                                        <select id="bank-dropdown" class="select2 form-select invoice-item-bank"
                                            ...
                                            <?php $__currentLoopData = $bank; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($item->id); ?>" data-saldo="<?php echo e($item->saldo); ?>">
                                                    <?php echo e($item->bank); ?> - <?php echo e($item->no_rek); ?>
                                    ...
                                    <div class="input-group input-group-merge mb-3" data-amount="1">
                                        ...
                                        <div class="form-floating form-floating-outline">
                                            <input type="text" class="form-control invoice-item-saldo-label"
                                                ...
                                                value="<?php echo e(old('saldo[]', 'Pilih Bank Dahulu')); ?>" disabled>
                    ...
                    <div class="row">
                        <div class="col-6 col-md-3">
                            <div class="form-floating form-floating-outline mb-2">
                                <input class="form-control" type="text" placeholder="Put No Voucher Here ...."
                                    id="no-voucher-input" name="no_voucher" value="<?php echo e(old('no_voucher')); ?>">
                                <label for="no-voucher-input">No Voucher</label>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="form-floating form-floating-outline mb-2">
                        ...
                        <div class="col-6 col-md-3">
                            <div class="form-floating form-floating-outline mb-2">
                                <input class="form-control" type="text" placeholder="Put Payee Here ...."
                                    id="payee-input" name="payee" value="<?php echo e(old('payee')); ?>">
                                    ...
                                    <div class="col-md-3 col-12 mb-md-0 mb-3">
                                        ...
                                        <div class="input-group input-group-merge mb-3" data-amount="1">
                                            ...
                                            <input class="form-control invoice-item-amount" type="number"
                                                name="amount[]" id="amount-1" value="<?php echo e(old('amount[]')); ?>" hidden>
                                        </div>
                                    </div>
                                </div>
                                <div
...
<?php $__env->startPush('page-script'); ?>
    <script src="<?php echo e(asset('assets')); ?>/includes/repeater/repeater-invoice-payable.js"></script>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/finance/payable/form.blade.php ENDPATH**/ ?>