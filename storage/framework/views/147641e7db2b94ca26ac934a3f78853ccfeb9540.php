<form action="<?php echo e(route('expense-account.store')); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
...
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/finance/form-account.blade.php ENDPATH**/ ?>