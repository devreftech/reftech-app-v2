<form action="<?php echo e(@$users ? route('employee.update', @$users->id) : route('employee.store')); ?>" method="post"
    ...
    <?php endif; ?>
    <div class="modal animate__animated animate__fadeIn" id="<?php echo e(@$users ? 'updateUsers-' . @$users->id : 'createUsers'); ?>"
        tabindex="-1" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel5">
                        <?php echo e(@$users ? 'Update Account ' . @$users->name : 'Create Account'); ?>
                ...
                <div class="modal-body">
                    <div class="d-flex align-items-start align-items-sm-center gap-4">
                        <?php if(@$users): ?>
                            <img src="<?php echo e(url('') . '/' . @$users->image); ?>" alt="user-avatar"
                                class="d-block w-px-120 h-px-120 rounded" id="uploadedAvatar">
                        <?php else: ?>
                            <img src="<?php echo e(asset('asset')); ?>/profile/profile.jpg" alt="user-avatar"
                                class="d-block w-px-120 h-px-120 rounded" id="uploadedAvatar">
                        <?php endif; ?>
                        ...
                        <div class="col-6 mt-2">
                            <div class="form-floating form-floating-outline">
                                <input class="form-control" type="number" id="nip" name="nip"
                                    value="<?php echo e(old('nip', @$users->nip ?? '')); ?>" placeholder="61256996" />
                        ...
                        <div class="col-6 mt-2">
                            <div class="form-floating form-floating-outline">
                                <input class="form-control" type="date" id="Date" name="birthday"
                                    value="<?php echo e(old('birthday', @$users->birthday ?? now()->format('Y-m-d'))); ?>">
                        ...
                        <div class="col-6">
                            <div class="form-floating form-floating-outline">
                                <input class="form-control" type="text" id="name" name="name"
                                    value="<?php echo e(old('name', @$users->name ?? '')); ?>" placeholder="john doe" />
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <div class="form-floating form-floating-outline">
                                        <input type="text" class="form-control" pattern="[0-9]*"
                                            ...
                                            value="<?php echo e(old('phone', @$users->phone ? substr($users->phone, 3) : '')); ?>">
                        ...
                        <div class="col-12">
                            <div class="form-floating form-floating-outline">
                                <textarea class="form-control h-px-100" rows="2" placeholder="Write your note here...." name="address"
                                    id="address"><?php echo e(@$users->address); ?></textarea>
                            ...
                            <div class="col-md-6 mt-2">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="form-control" id="area" name="area"
                                        placeholder="Put Area here..." value="<?php echo e(old('area')); ?>" />
                            ...
                            <div class="col-md-6 mt-2">
                                <div class="form-floating form-floating-outline">
                                    <input class="form-control" type="date" id="Date" name="date_in"
                                        value="<?php echo e(old('date_in', @$users->date_in ?? now()->format('Y-m-d'))); ?>"
                                        <?php echo e(@$users->date_in ? 'disabled' : ''); ?>>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="form-control" id="position" name="position"
                                        placeholder="example: Sales Off store" value="<?php echo e(old('position')); ?>" />
                        ...
                        <div class="col-md-6">
                            <div class="form-floating form-floating-outline">
                                <input class="form-control" type="text" id="code" name="code"
                                    value="<?php echo e(old('code', @$users->code ?? '')); ?>" placeholder="example: RZA" />
                            ...
                            <div class="input-group input-group-merge">
                                <div class="form-floating form-floating-outline">
                                    <select class="form-select" id="ddSales" aria-label="Default select example"
                                        name="active">
                                        <option value="1" <?php echo e(@$users->active == '1' ? 'selected' : ''); ?>>Active
                                        </option>
                                        <option value="0" <?php echo e(@$users->active == '0' ? 'selected' : ''); ?>>Non
                                            Active
                                        </option>
                                    </select>
                            ...
                            <div class="col-6 mt-2">
                                <div class="form-floating form-floating-outline">
                                    <input class="form-control" type="number" id="crm" name="crm"
                                        value="<?php echo e(old('crm', @$users->target[0]->crm ?? '')); ?>"
                                        placeholder="61256996" />
                            ...
                            <div class="col-6 mt-2">
                                <div class="form-floating form-floating-outline">
                                    <input class="form-control" type="number" id="leads" name="leads"
                                        value="<?php echo e(old('leads', @$users->target[0]->leads ?? '')); ?>"
                                        placeholder="61256996" />
...
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/user/form.blade.php ENDPATH**/ ?>