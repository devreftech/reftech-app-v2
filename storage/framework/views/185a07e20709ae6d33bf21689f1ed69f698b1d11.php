...
<?php $__env->startSection('title', 'Create Unit Quotation'); ?>
<?php $__env->startSection('content'); ?>
    
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center py-3 mb-3 gap-3">
        <div>
            <h4 class="fw-bold mb-1">
                <span class="text-muted fw-light">Sales / <a href="<?php echo e(route('unit-quotation.index')); ?>" class="text-muted">Unit Quotation</a> /</span> Create
            </h4>
        ...
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('unit-quotation.index')); ?>" class="btn btn-label-secondary">
    ...
    <form action="<?php echo e(route('unit-quotation.store')); ?>" method="POST" id="form-unit-quotation">
        <?php echo csrf_field(); ?>
                ...
                <div class="row align-items-center g-3">
                    <div class="col-md-8 col-12">
                        ...
                        <input type="text" class="form-control form-control-lg fw-bold bg-white text-primary border-primary-subtle shadow-sm"
                            name="no_quote" placeholder="Quotation Number" value="<?php echo e(old('no_quote', $defaultNoQuote)); ?>" style="font-size: 1.35rem;">
                    </div>
        ...
        <div class="card mb-4 border-0 shadow-sm">
            ...
            <div class="card-body pt-4">
                <div class="row g-3">
                        ...
                        <div class="form-floating form-floating-outline">
                            <select class="select2 form-select" name="id_client" id="client-select">
                                ...
                                <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($c->id); ?>" data-role="<?php echo e($c->role); ?>"><?php echo e($c->company); ?></option>
                    ...
                    <div class="col-md-2">
                        <div class="form-floating form-floating-outline">
                            <input type="date" class="form-control" id="input-date" name="date" value="<?php echo e(date('Y-m-d')); ?>">
                            <label>Date</label>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-floating form-floating-outline">
                            <input type="date" class="form-control bg-light-subtle" id="input-expired-date" name="expired_date"
                                value="<?php echo e(date('Y-m-d', strtotime('+1 month'))); ?>" readonly
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="mb-4 pb-3 border-bottom">
                            ...
                            <textarea class="form-control" name="note" id="note"
                                ...
                                style="overflow-y: hidden; resize: none;"><?php echo e(old('note')); ?></textarea>
                        ...
                        <div>
                            ...
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="validity" class="form-control form-control-sm" name="validity"
                                        value="<?php echo e(old('validity', '1(one) Month After this Quotation Created')); ?>">
                                </div>
                            </div>
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="pricing" class="form-control form-control-sm" name="pricing"
                                        value="<?php echo e(old('pricing', 'Franco Factory')); ?>">
                                </div>
                            </div>
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-select form-select-sm" id="payment-select">
                                        <?php if(isset($paymentTemplates) && count($paymentTemplates) > 0): ?>
                                            <optgroup label="Template Sales">
                                                <?php $__currentLoopData = $paymentTemplates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($pt->payment_term); ?>" <?php echo e($pt->is_default ? 'selected' : ''); ?>>
                                                        <?php echo e($pt->name); ?> <?php echo e($pt->client ? '('.$pt->client->company.')' : ''); ?>
                                    ...
                                    <input type="hidden" name="payment" id="input-payment-hidden" value="<?php echo e(old('payment', 'Cash Before Delivery')); ?>">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-sm-8">
                                    <textarea id="delivery" class="form-control form-control-sm" name="delivery_process" rows="1" style="resize: vertical;"><?php echo e(old('delivery_process', 'Ready stock')); ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-3 pb-3 border-bottom">
                                    ...
                                    <div style="width: 160px;">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control text-end fw-semibold rupiah-input" name="shipping" id="input-shipping" value="<?php echo e(old('shipping', '0')); ?>" placeholder="0" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="d-flex justify-content-end gap-2 mb-4">
            <a href="<?php echo e(route('unit-quotation.index')); ?>" class="btn btn-label-secondary">Cancel</a>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/unit-quotation/create.blade.php ENDPATH**/ ?>