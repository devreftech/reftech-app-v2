            ...
            <div class="row">
                <table class="table table-bordered m-0" style="width: 100%">
                    <thead class="table-light border-top">
                        <tr class="title">
                            <th colspan="6" class="text-center title" style="background-color: pink">ON PROCCESS INQUIRY</th>
                        </tr>
                        <tr class="subtitle">
                            <th>Date</th>
                            <th>Location Unit</th>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $quoteMon; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/monitoring/client/quote-print.blade.php ENDPATH**/ ?>