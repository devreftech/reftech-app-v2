...
<?php $__env->startSection('title', 'Unit Catalog'); ?>
        ...
        <div class="modal fade" id="modalAddCatalog" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form action="<?php echo e(route('catalog-unit.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                                ...
                                <select class="form-select w-100" name="id_unit" id="selectUnit" required>
                                    ...
                                    <?php $__currentLoopData = $availableUnits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($unit->id); ?>"
                                            data-sku="<?php echo e($unit->sku); ?>"
                                            data-brand="<?php echo e($unit->brand); ?>"
                                            data-model="<?php echo e($unit->model); ?>"
                                            data-category="<?php echo e($unit->unit); ?>">
                                            <?php echo e($unit->sku); ?>
...
<?php $__env->startPush('after-script'); ?>
    ...
    <script src="<?php echo e(asset('assets')); ?>/includes/table-catalog-unit.js"></script>
    <script>
        var unitData = {
            <?php $__currentLoopData = $availableUnits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php echo e($unit->id); ?>: {
                sku:      "<?php echo e(addslashes($unit->sku)); ?>",
                brand:    "<?php echo e(addslashes($unit->brand)); ?>",
                model:    "<?php echo e(addslashes($unit->model)); ?>",
                category: "<?php echo e(addslashes($unit->unit)); ?>"
            },
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        };
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/catalog-unit/index.blade.php ENDPATH**/ ?>