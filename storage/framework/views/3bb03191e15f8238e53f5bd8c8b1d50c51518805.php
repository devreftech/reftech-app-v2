<form action="<?php echo e(route('invoice.change_desc', $invoice->id)); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row g-2 mb-3">
                            ...
                            <div class="col-6">
                                <div class="form-check">
                                    <!-- Perbaiki name menjadi array dengan menggunakan checker[] -->
                                    <input class="form-check-input" type="checkbox" name="checker[]"
                                        value="<?php echo e($product->id); ?>" id="defaultCheck-<?php echo e($product->id); ?>" <?php echo e($product->view == '1' ? 'checked' : ''); ?>>
                                    <label class="form-check-label" for="defaultCheck-<?php echo e($product->id); ?>">
                                        Description jadikan Link
                                    </label>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/components/modal/invoice/desc.blade.php ENDPATH**/ ?>