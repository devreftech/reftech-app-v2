...
<?php $__env->startSection('content'); ?>
    ...
    <div class="d-flex justify-content-end mb-3">
        <a href="<?php echo e(route('fixed.create')); ?>" class="btn btn-primary btn-sm">
    ...
    <?php echo $__env->make('components.modal.finance.income', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startPush('page-script'); ?>
    ...
    <script src="<?php echo e(asset('assets')); ?>/includes/table-fixed-asset.js"></script>
<?php $__env->stopPush(); ?>
    ...
    <script>
        ...
        $(document).on('click', '.delete-expense', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        'url': '<?php echo e(url('expense-account')); ?>/' + id,
                        'type': 'POST',
                        'data': {
                            '_method': 'DELETE',
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/finance/fixed/index.blade.php ENDPATH**/ ?>