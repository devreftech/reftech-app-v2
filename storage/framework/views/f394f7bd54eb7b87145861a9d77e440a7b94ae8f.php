...
<?php $__env->startSection('content'); ?>
    <div class="card mb-3">
        <div class="card-datatable table-responsive pt-0">
            <table
                class="datatable-pending-po-done<?php echo e(auth::user()->role == 'Sales' ? '' : '-admin'); ?> table table-striped">
                <thead>
                    <tr>
                        <th></th>
                        <th></th>
...
<?php $__env->startPush('page-script'); ?>
    ...
    <script src="<?php echo e(asset('assets')); ?>/includes/table-pending-done.js"></script>
    <script src="<?php echo e(asset('assets')); ?>/includes/table-pending-done-admin.js"></script>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/pending/done.blade.php ENDPATH**/ ?>