<?php $__env->startSection('title', 'Sales Order & Project Monitoring'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center py-3 mb-4 gap-2">
            ...
            <div class="d-flex align-items-center">
                <form action="<?php echo e(route('pending-po.sales-order')); ?>" method="GET" class="d-flex align-items-center">
                    <input type="hidden" name="tab" id="active-tab-param" value="<?php echo e($activeTab); ?>">
                    ...
                    <select name="year" id="filter-year" class="form-select form-select-sm" onchange="this.form.submit()" style="min-width: 130px;">
                        <option value="all" <?php echo e($selectedYear == 'all' ? 'selected' : ''); ?>>Semua Tahun</option>
                ...
                <div class="nav-align-top">
                    <ul class="nav nav-pills flex-column flex-sm-row mb-0 gap-1" role="tablist">
                        <li class="nav-item flex-sm-grow-0" role="presentation">
                            <button class="nav-link <?php echo e($activeTab !== 'project-monitoring' ? 'active' : ''); ?>"
                                    data-bs-toggle="tab"
                                    data-bs-target="#tab-content-sorder"
                                    type="button"
                                    role="tab"
                                    aria-controls="tab-content-sorder"
                                    aria-selected="<?php echo e($activeTab !== 'project-monitoring' ? 'true' : 'false'); ?>">
        ...
        <div class="tab-content p-0 border-0 shadow-none bg-transparent">
            <!-- 1. SALES ORDER TAB -->
            <div class="tab-pane fade <?php echo e($activeTab !== 'project-monitoring' ? 'show active' : ''); ?>" id="tab-content-sorder" role="tabpanel">
                        ...
                        <div class="card card-border-shadow-primary h-100">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-2 pb-1">
                                    ...
                                    <h4 class="ms-1 mb-0 fw-bold text-primary"><?php echo e($totalOrdersCount); ?></h4>
                                </div>
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#tab-sorder-new" aria-selected="true">
                                        New
                                        <span class="badge rounded-pill bg-danger ms-1"><?php echo e($newOrders->count()); ?></span>
                                    </button>
                                </li>
                                <li class="nav-item">
                                    <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#tab-sorder-check">
                                        Check Parts
                                        <span class="badge rounded-pill bg-warning ms-1"><?php echo e($checkPartsOrders->count()); ?></span>
                                    </button>
                                </li>
                                <li class="nav-item">
                                    <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#tab-sorder-delivery">
                                        Delivery Process
                                        <span class="badge rounded-pill bg-info ms-1"><?php echo e($deliveryOrders->count()); ?></span>
                                    </button>
                                </li>
                                <li class="nav-item">
                                    <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#tab-sorder-completed">
                                        Selesai
                                        <span class="badge rounded-pill bg-success ms-1"><?php echo e($completedOrders->count()); ?></span>
                                    </button>
                                </li>
                                <li class="nav-item">
                                    <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#tab-sorder-delayed">
                                        Delayed
                                        <span class="badge rounded-pill bg-danger ms-1"><?php echo e($delayedOrders->count()); ?></span>
                                    </button>
                                </li>
                                <li class="nav-item">
                                    <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#tab-sorder-return">
                                        Return
                                        <span class="badge rounded-pill bg-warning ms-1"><?php echo e($returnOrders->count()); ?></span>
                                    </button>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="tab-content p-0 border-0 shadow-none">
                            <div class="tab-pane fade show active" id="tab-sorder-new" role="tabpanel">
                                <?php echo $__env->make('pages.sorder._table', ['orderList' => $newOrders, 'tableId' => 'table-sorder-new'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                            <div class="tab-pane fade" id="tab-sorder-check" role="tabpanel">
                                <?php echo $__env->make('pages.sorder._table', ['orderList' => $checkPartsOrders, 'tableId' => 'table-sorder-check'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                            <div class="tab-pane fade" id="tab-sorder-delivery" role="tabpanel">
                                <?php echo $__env->make('pages.sorder._table', ['orderList' => $deliveryOrders, 'tableId' => 'table-sorder-delivery'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                            <div class="tab-pane fade" id="tab-sorder-completed" role="tabpanel">
                                <?php echo $__env->make('pages.sorder._table', ['orderList' => $completedOrders, 'tableId' => 'table-sorder-completed'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                            <div class="tab-pane fade" id="tab-sorder-delayed" role="tabpanel">
                                <?php echo $__env->make('pages.sorder._table', ['orderList' => $delayedOrders, 'tableId' => 'table-sorder-delayed'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                            <div class="tab-pane fade" id="tab-sorder-return" role="tabpanel">
                                <?php echo $__env->make('pages.sorder._table', ['orderList' => $returnOrders, 'tableId' => 'table-sorder-return'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="tab-pane fade <?php echo e($activeTab === 'project-monitoring' ? 'show active' : ''); ?>" id="tab-content-project" role="tabpanel">
                        ...
                        <div class="card card-border-shadow-primary h-100">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-2 pb-1">
                                    ...
                                    <h4 class="ms-1 mb-0"><?php echo e($totalProjectsCount); ?></h4>
                                </div>
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#tab-project-new" aria-selected="true">
                                        New
                                        <span class="badge rounded-pill bg-danger ms-1"><?php echo e($newProjects->count()); ?></span>
                                    </button>
                                </li>
                                <li class="nav-item">
                                    <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#tab-project-check">
                                        Check Parts / Unit / Material
                                        <span class="badge rounded-pill bg-warning ms-1"><?php echo e($checkPartsProjects->count()); ?></span>
                                    </button>
                                </li>
                                <li class="nav-item">
                                    <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#tab-project-sched">
                                        Scheduling / Shipment
                                        <span class="badge rounded-pill bg-info ms-1"><?php echo e($schedulingProjects->count()); ?></span>
                                    </button>
                                </li>
                                <li class="nav-item">
                                    <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#tab-project-progress">
                                        In Progress / Execution
                                        <span class="badge rounded-pill bg-primary ms-1"><?php echo e($inProgressProjects->count()); ?></span>
                                    </button>
                                </li>
                                <li class="nav-item">
                                    <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#tab-project-completed">
                                        Selesai
                                        <span class="badge rounded-pill bg-success ms-1"><?php echo e($completedProjects->count()); ?></span>
                                    </button>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="tab-content p-0 border-0 shadow-none">
                            <div class="tab-pane fade show active" id="tab-project-new" role="tabpanel">
                                <?php echo $__env->make('pages.project-monitoring._table', ['projectList' => $newProjects, 'tableId' => 'table-project-new'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                            <div class="tab-pane fade" id="tab-project-check" role="tabpanel">
                                <?php echo $__env->make('pages.project-monitoring._table', ['projectList' => $checkPartsProjects, 'tableId' => 'table-project-check'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                            <div class="tab-pane fade" id="tab-project-sched" role="tabpanel">
                                <?php echo $__env->make('pages.project-monitoring._table', ['projectList' => $schedulingProjects, 'tableId' => 'table-project-sched'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                            <div class="tab-pane fade" id="tab-project-progress" role="tabpanel">
                                <?php echo $__env->make('pages.project-monitoring._table', ['projectList' => $inProgressProjects, 'tableId' => 'table-project-progress'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                            <div class="tab-pane fade" id="tab-project-completed" role="tabpanel">
                                <?php echo $__env->make('pages.project-monitoring._table', ['projectList' => $completedProjects, 'tableId' => 'table-project-completed'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php echo $__env->make('components.modal.pending.jadwal.schedule', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <?php $__currentLoopData = $schedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php echo $__env->make('components.modal.pending.jadwal.reschedule', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('components.modal.pending.jadwal.dokumentasi', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.sales.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877155683/domains/reftech.my.id/reftech.my.id/resources/views/pages/sorder/index.blade.php ENDPATH**/ ?>